...
namespace AXCODE 
{ 
    public partial class LVersion: CxControl
    { 

          private FVersion fversion = null;
        ...
        private LookupBox txt_version_name; 
        ...
        { 
            ...
            txt_version_name = new LookupBox(); 
            ...
            linner_panel.Controls.Add(txt_version_name); 
            linner_panel.Controls.Add(lbl_version_name); 
            ...
            btn_search.Location = new Point(txt_version_name.Right + 10 ,txt_version_name.Top);
