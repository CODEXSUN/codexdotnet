...
{ 
    ...
    { 
        ...
        private void Txt_databases_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FDatabases_NeedToRefresh;
        
        public void Form_NeedToRefresh()
        {
            if (FDatabases_NeedToRefresh != null)
            {
                FDatabases_NeedToRefresh(this, new EventArgs());
            }
        }
        ...
        { 
            return txt_databases_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_databases_name.Text = pName ; 
        } 
        public void SetFocus()
        {
            txt_databases_name.Focus();
        }
        #endregion[Set Focus]
