...
namespace AXCODE
{
    public partial class FMpath : UserControl
    {
        ...
        private void Initialize()
        {
            ...
            finner_panel.Controls.Add(txt_mtables_id);
            finner_panel.Controls.Add(lbl_mtables_id);
            ...
            lbl_mtables_id.Font = XFont.Font_10B;
            lbl_mtables_id.Name = "lbl_mtables_id";
            lbl_mtables_id.Text = "   Mtables id";
            lbl_mtables_id.Anchor = XAnchor.LT;
            lbl_mtables_id.TextAlign = ContentAlignment.MiddleLeft;
            lbl_mtables_id.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_mtables_id.Size = XSize.OneLabel;
            lbl_mtables_id.Location = XLayout.FirstLabel;
            ...
            txt_mtables_id.Name = "txt_mtables_id";
            txt_mtables_id.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_mtables_id.Size = XSize.OneText;
            txt_mtables_id.Anchor = XAnchor.LTR;
            txt_mtables_id.Location = XLayout.FirstText;
            txt_mtables_id.TabIndex = XTab.Txt_TabIndex;
            txt_mtables_id.Enter += new EventHandler(Txt_mtables_id_Enter);
            ...
            lbl_root_folder.Location = XLayout.R1_Label(lbl_mtables_id.Location);
            ...
            txt_root_folder.Location = XLayout.R1_Text(txt_mtables_id.Location);
            txt_root_folder.TabIndex = XTab.Index(txt_mtables_id.TabIndex);
