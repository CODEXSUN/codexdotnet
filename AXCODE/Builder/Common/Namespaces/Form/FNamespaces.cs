...
{ 
    ...
    { 
        ...
        private void Txt_namespaces_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FNamespaces_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FNamespaces_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        { 
            return txt_namespaces_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_namespaces_name.Text = pName ; 
        } 
