...
namespace AXCODE
{
    public partial class FSpath : UserControl
    {
        ...
        {
            vId = obj.Spath_id;
            txt_stables_id.Text = obj.Stables_id;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_stables_id.Enabled = !pReadOnly;
                ...
                switch (fAction)
                {
                    ...
                    case BtnEvent.New:
                        try
                        {
                            ...
                            CSpath.Insert(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Edit:
                        try
                        {
                            ...
                            dalsession = new SQLITE_DAL();
                            dalsession.BeginTransaction();
                            CSpath.Update(vData, dalsession);
                            dalsession.Commit();
