    ...
    { 
        ...
        public void SetAction(BtnEvent pAction, string pPkValue)
        {
            ...
            switch (fAction)
            {
                case BtnEvent.Open:
                    btn_save.Text = "CLOSE";
                    obj = CServers.PropertiesData(CServers_exten.PKId(pPkValue));
        ...
        {
            vId = obj.Servers_id;
            txt_servers_name.Text = obj.Servers_name;
            txt_servers_version.Text = obj.Servers_version;
            txt_servers_path.Text = obj.Servers_path;
            txt_servers_backup_path.Text = obj.Servers_backup_path;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_servers_name.Enabled = !pReadOnly;
            txt_servers_version.Enabled = !pReadOnly;
            txt_servers_path.Enabled = !pReadOnly;
            txt_servers_backup_path.Enabled = !pReadOnly;
                                        ...
                                        case BtnEvent.Open: 
                                         ...
                                         case BtnEvent.New: 
                                             ...
                                             { 
                                                 ...
                                                 CServers.Insert(vData, dalsession); 
                                                 dalsession.Commit(); 
                                         ...
                                         case BtnEvent.Edit: 
                                             ...
                                             { 
                                                 ...
                                                 dalsession = new DAL(); 
                                                 dalsession.BeginTransaction(); 
                                                 CServers.Update(vData, dalsession); 
                                                 dalsession.Commit(); 
                                         ...
                                         case BtnEvent.Delete: 
                                             ...
                                             { 
                                                 dalsession = new DAL(); 
                                                 dalsession.BeginTransaction(); 
                                                 CServers.Delete(vId, dalsession); 
                                                 dalsession.Commit(); 
        ...
        private Servers FetchData()
        {
            Servers fobj = new Servers()
           {
           Servers_id = vId,
            Servers_name = txt_servers_name.Text,
            Servers_version = txt_servers_version.Text,
            Servers_path = txt_servers_path.Text,
            Servers_backup_path = txt_servers_backup_path.Text,
