...
{ 
    public partial class LCash_in_hand:CxControl
    { 

          private FCash_in_hand fcash_in_hand = null;

         public LCash_in_hand()
         {
             InitializeComponent();
             Initialize();
             InitGrid();
        ...
        private LookupBox txt_cash_in_hand_id; 
        private XLabel lbl_cash_in_hand_name; 
        ...
        { 
            ...
            txt_cash_in_hand_id = new LookupBox(); 
            lbl_cash_in_hand_name = new XLabel(); 
            ...
            linner_panel.Controls.Add(txt_cash_in_hand_id); 
            linner_panel.Controls.Add(lbl_cash_in_hand_name); 
            ...
            txt_cash_in_hand_id.Font = XFont.TxtFont; 
            txt_cash_in_hand_id.ForeColor = XFontColor.TxtFontColor; 
            txt_cash_in_hand_id.BackColor = XTheme.TxtBackcolor; 
            txt_cash_in_hand_id.Name = "txt_cash_in_hand_name"; 
            txt_cash_in_hand_id.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor; 
            txt_cash_in_hand_id.Size = XSize.TwoText; 
            txt_cash_in_hand_id.Anchor = XAnchor.LTR; 
            txt_cash_in_hand_id.Location = XLayout.FirstText; 
            txt_cash_in_hand_id.TabIndex = 5; 

            lbl_cash_in_hand_name.Font = XFont.Font_10B; 
            lbl_cash_in_hand_name.Name = "lbl_cash_in_hand_name"; 
            lbl_cash_in_hand_name.Text = "Cash in hand tbl";
            lbl_cash_in_hand_name.TextAlign = ContentAlignment.MiddleCenter; 
            lbl_cash_in_hand_name.ForeColor = XFontColor.Lbl_ForeColor; 
            lbl_cash_in_hand_name.Size = XSize.OneLabel; 
            lbl_cash_in_hand_name.Location = XLayout.FirstLabel; 

            btn_search.Font = XFont.BtnFont;
            btn_search.Location = new Point(txt_cash_in_hand_id.Right + 10 ,txt_cash_in_hand_id.Top);
