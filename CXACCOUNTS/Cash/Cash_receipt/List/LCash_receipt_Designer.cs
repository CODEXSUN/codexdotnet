...
{ 
    public partial class LCash_receipt:CxControl
    { 

          private FCash_receipt fcash_receipt = null;

         public LCash_receipt()
         {
             InitializeComponent();
             Initialize();
             InitGrid();
        ...
        private LookupBox txt_receipt_date; 
        ...
        { 
            ...
            txt_receipt_date = new LookupBox(); 
            ...
            linner_panel.Controls.Add(txt_receipt_date); 
            linner_panel.Controls.Add(lbl_receipt_date); 
            ...
            btn_search.Location = new Point(txt_receipt_date.Right + 10 ,txt_receipt_date.Top);
