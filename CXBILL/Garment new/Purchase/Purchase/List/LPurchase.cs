...
namespace CXBILL
{
    public partial class LPurchase 
    {
        ...
        private void BuildForm()
        {
            ...
            finvoice.FPurchase_NeedToRefresh += VPurchase_NeedToRefresh;
        ...
        {
            string pkValue = GetSelectedPkValue();
            if (CPurchase_exten.LockStatus(pkValue) == false)
            {
                BuildForm();
                if (pkValue != null)
                {
        ...
        {
            txt_no.LookupColNames = new string[] { PURCHASE.PURCHASE_NO };
            txt_no.LookupUpdate += Txt_no_LookupUpdate;
        }
        void Txt_no_LookupUpdate(object sender, EventArgs e)
        {
            txt_no.LookupList = CPurchase_exten.LookupNo(new DAL());
        }
        ...
        //{
        //    txt_date.LookupColNames = new string[] { PURCHASE.PURCHASE_DATE };
        //    txt_date.LookupUpdate += Txt_date_LookupUpdate;
        //}
        //void Txt_date_LookupUpdate(object sender, EventArgs e)
        //{
        //    txt_date.LookupList = CPurchase_exten.LookupDate(new DAL());
        //}

        //public void DateTo_lookup()
        //{
        //    txt_dateTo.LookupColNames = new string[] { PURCHASE.PURCHASE_DATE };
        //    txt_dateTo.LookupUpdate += Txt_dateTo_LookupUpdate;
        //}
        //void Txt_dateTo_LookupUpdate(object sender, EventArgs e)
        //{
        //    txt_dateTo.LookupList = CPurchase_exten.LookupDate(new DAL());
        //}
        ...
        private string GetSelectedPkValue()
        {
            ...
            if (vSelRow != null)
            {
                selPkValue = vSelRow.Cells[PURCHASE.PURCHASE_ID].Value.ToString();
            }
            return selPkValue;
        }
        ...
        void VPurchase_NeedToRefresh(object sender, EventArgs e)
        {
            List_Option(ListOption.active);
        }
        //public event EventHandler LPurchase_NeedToRefresh;
        //public void RaiseEvent_NeedToRefresh()
        //{
        //    if (LPurchase_NeedToRefresh != null)
        //    {
        //        LPurchase_NeedToRefresh(this, new EventArgs());
        //    }
        //}
