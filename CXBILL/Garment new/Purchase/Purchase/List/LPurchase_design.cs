...
namespace CXBILL
{
    public partial class LPurchase : CxControl
    {

        private FPurchase finvoice = null;
        ...
        private void InitGrid()
        {
            ...
            col_Purchase_Id.Name = PURCHASE.PURCHASE_ID;
            ...
            listgrid.Columns.Add(col_Purchase_Id);

            DataGridViewTextBoxColumn col_Entry_no = new DataGridViewTextBoxColumn();
            col_Entry_no.Name = PURCHASE.ENTRY_NO;
            col_Entry_no.HeaderText = "E NO";
            //col_Purchase_no.Visible = false;
            col_Entry_no.Width = 80;
            col_Entry_no.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Entry_no.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Entry_no);

            DataGridViewTextBoxColumn col_Purchase_no = new DataGridViewTextBoxColumn();
            col_Purchase_no.Name = PURCHASE.PURCHASE_NO;
            col_Purchase_no.HeaderText = "NO";
            //col_Purchase_no.Visible = false;
            col_Purchase_no.Width = 100;
            col_Purchase_no.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Purchase_no.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Purchase_no);

            DataGridViewTextBoxColumn col_Purchase_date = new DataGridViewTextBoxColumn();
            col_Purchase_date.Name = PURCHASE.PURCHASE_DATE;
            col_Purchase_date.HeaderText = "DATE";
            //col_Purchase_date.Visible = false;
            col_Purchase_date.Width = 100;
            col_Purchase_date.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Purchase_date.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Purchase_date);

            DataGridViewTextBoxColumn col_Party_id = new DataGridViewTextBoxColumn();
            col_Party_id.Name = PURCHASE.PARTY_ID;
            ...
            col_Grandtotal.Name = PURCHASE.GRANDTOTAL;
            ...
            col_Gsttotal.Name = PURCHASE.GSTTOTAL;
            ...
            col_Total_qty.Name = PURCHASE.TOTAL_QTY;
            ...
            col_Total_taxable_amount.Name = PURCHASE.TOTAL_TAXABLE_AMOUNT;
            ...
            col_Ledger_id.Name = PURCHASE.LEDGER_ID;
            ...
            col_Additional.Name = PURCHASE.ADDITIONAL;
            ...
            col_User_Id.Name = PURCHASE.USER_ID;
