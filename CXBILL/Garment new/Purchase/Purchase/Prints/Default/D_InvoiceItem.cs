    ...
    public class D_PurchaseItem
    {
        ...
        public static void Build()
        {
            ...
            ReportUtil.AddFields(dataSet.Fields, new string[] {
                ...
                PPurchaseitems.PURCHASE_ITEM_ID
                ,PPurchaseitems.PURCHASE_ID
                ,PPurchaseitems.SL_NO
                ,PPurchaseitems.PO_ID
                ,PPurchaseitems.DC_ID
                ,PPurchaseitems.PRODUCT_ID
                 ,PPurchaseitems.HSN_CODE_ID
                ,PPurchaseitems.QTY
                ,PPurchaseitems.PRICE
                ,PPurchaseitems.SUB_TOTAL
                ,PPurchaseitems.TAXABLEVALUE
                ,PPurchaseitems.CGST_PERCENT
                ,PPurchaseitems.CGST_AMOUNT
                ,PPurchaseitems.SGST_PERCENT
                ,PPurchaseitems.SGST_AMOUNT
                        });
            ...
            ///== END OF REPORT  ===========================================================================///
            rptbuild.SaveAs(PRINT_FOLDER + @"\P_PurchaseItem.rdlc");
        }
        ...
        private static void BuildDetail(BodyType rectWarper)
        {
            ...
            {
                x = x + slno.Width.Value; y = 0; wd = 3.02; ht = ht + 0;
            }
            ...
            //
            x = x + hsn_code.Width.Value; y = 0; wd = 0.5; ht = ht + 0;
            ...
            x = x + sgst_per.Width.Value; y = 0.3; wd = 0.55; ht = ht + 0;
            ...
            x = x + cgst_per.Width.Value; y = 0.3; wd = 0.55; ht = ht + 0;
            ...
            x = x + cgst_amt.Width.Value; y = 0; wd = 0.70; ht = ht + 0.3;
            ...
            txt_sgst_per.Value = "=Fields!" + PPurchaseitems.SGST_PERCENT + ".Value";
            ...
            txt_sgst_amt.Value = "=Fields!" + PPurchaseitems.SGST_AMOUNT + ".Value";
            ...
            txt_cgst_per.Value = "=Fields!" + PPurchaseitems.CGST_PERCENT + ".Value";
            ...
            txt_cgst_amt.Value = "=Fields!" + PPurchaseitems.CGST_AMOUNT + ".Value";
            ...
            txt_amount.Value = "=Fields!" + PPurchaseitems.SUB_TOTAL + ".Value";
