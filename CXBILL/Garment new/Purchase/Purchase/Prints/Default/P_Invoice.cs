...
namespace CXGARMENT
{
        ...
        static void localReport_SubreportProcessing(object sender, SubreportProcessingEventArgs e)
        {
            switch (e.DataSourceNames[0])
            {
                case "MyDataSource_Items":
                    try
                    {
                        Print_invoiceItemsList data_AT = P_PurchaseItem.GetData(vPId);
    ...
    public class Print_PurchaseList : System.ComponentModel.BindingList<Print_PurchaseRow>
    {
    }
    public class Print_PurchaseRow
    {
    ...
    public class PPurchase
    {
        ...
        public static string PURCHASE_NO = "PURCHASE_NO";
