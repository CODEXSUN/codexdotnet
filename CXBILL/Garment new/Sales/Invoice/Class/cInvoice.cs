...
namespace CXBILL
{
    public class CInvoice
    {
        ...
        private static string AttachParams(string q, Invoice v)
        {
        ...
        public static void Insert(Invoice v, DAL dalsession)
        {
        ...
        public static void Update(Invoice v, DAL dalsession)
        {
