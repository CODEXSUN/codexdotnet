...
namespace CXBILL
{
    public class D_IgstInvoice
    {
        ...
        private static void BuildDetail(RectangleType rectWarper)
        {
            ...
            string term1 = "";
            string term2 = "RAJA ANNAMALAI TEX - VENDOR CODE : 222911";
            string BANK = "BANK NAME : CANARA BANK";
            string BANKADDRESS = "BRANCH      : ONDIPUDUR BRANCH - COIMBATORE";
            string ifsccode = "IFSC CODE  : CNRB0001238";
            string acno = "A/C NO     : 1238261000297";
            ...
            #region [Taxable , GSTTotal , Roundoff]

            var totalOuterRectangleWidth = 2.8;
            var totalLeftRectangleWidth = 1.8;
            var totalRightRectangleWidth = 0.9;

            var textboxHeight = 0.18;

            var textboxLeft = 1.85;

            double totalRectangleLeft= 4.8;

            double k = 0;

            x = totalRectangleLeft; y = k; wd = totalOuterRectangleWidth; ht = 0.1;
            ...
            x = 0; y = k; wd = totalOuterRectangleWidth; ht = 0.01;
            ...
            x = 0; y = 0.03; wd = totalLeftRectangleWidth; ht = textboxHeight;
            ...
            x = textboxLeft; y = lbl_taxablevalue.Top.Value; wd = totalRightRectangleWidth; ht = textboxHeight;
            ...
            x = textboxLeft; y = lbl_igst.Top.Value; wd = totalRightRectangleWidth; ht = textboxHeight;
            ...
            x = textboxLeft; y = lbl_GSTTotal.Top.Value; wd = totalRightRectangleWidth; ht = textboxHeight;
            ...
            x = textboxLeft; y = txt_ledger.Top.Value; wd = totalRightRectangleWidth; ht = textboxHeight;
            ...
            x = textboxLeft; y = lbl_round.Top.Value; wd = totalRightRectangleWidth; ht = textboxHeight;
            ...
            x = 4.9; y = 0.08; wd = totalOuterRectangleWidth -0.5; ht = 0.28;
            ...
            x = amtnwords.Width.Value; y = 0; wd = 2.8; ht = 0.95;
