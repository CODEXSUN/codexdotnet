...
namespace CXBILL
{
    public class D_IgstInvoiceItem
    {
        ...
        private static void BuildDetail(BodyType rectWarper)
        {
            ...
            x = x + slno.Width.Value; y = 0; wd = 2.62; ht = ht + 0;
            ...
            x = x + hsn_code.Width.Value ; y = 0; wd = 0.7; ht = ht + 0;
            ...
            x = x + qtys.Width.Value; y = 0; wd = 0.5; ht = ht + 0;
            ...
            x = x + price.Width.Value; y = 0; wd = 0.8; ht = ht + 0;
            ...
            x = x + igst_amt.Width.Value; y = 0; wd = 1; ht = ht + 0.3;
