...
namespace CXBILL
{
    ...
    public class Offset_labour
    {
        public string Offset_labour_id { get; set; }
        public string Uniqueno { get; set; }
        public string Company_id { get; set; }
        public string Acy_id { get; set; }
        public int Offset_labour_no { get; set; }
        public string Offset_labour_date { get; set; }
    ...
    public class OFFSET_LABOUR
    {
        public const string OFFSET_LABOUR_ID = "OFFSET_LABOUR_ID";
        public const string UNIQUENO = "UNIQUENO";
        public const string COMPANY_ID = "COMPANY_ID";
        public const string ACY_ID = "ACY_ID";
        public const string OFFSET_LABOUR_NO = "OFFSET_LABOUR_NO";
        public const string OFFSET_LABOUR_DATE = "OFFSET_LABOUR_DATE";
        ...
        public const string OFFSET_LABOUR_TBL = "OFFSET_LABOUR_TBL";
    }
