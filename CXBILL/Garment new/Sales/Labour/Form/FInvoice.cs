...
namespace CXBILL
{
    public partial class FOffset_labour : UserControl
    {
        ...
        private void SetTaxtype()
        {
            ...
            //{
            //    Core.TaxType = "1";
            //    editgrid.Columns[OFFSET_LABOURITEMS.SGST_PERCENT].Visible = true;
            //    editgrid.Columns[OFFSET_LABOURITEMS.CGST_PERCENT].Visible = true;
            //    editgrid.Columns[OFFSET_LABOURITEMS.IGST_PERCENT].Visible = false;
            //    RefreshRowtotal();
            //    this.Refresh();
            //}
            ...
            //{
            //    Core.TaxType = "2";
            //    editgrid.Columns[OFFSET_LABOURITEMS.SGST_PERCENT].Visible = false;
            //    editgrid.Columns[OFFSET_LABOURITEMS.CGST_PERCENT].Visible = false;
            //    editgrid.Columns[OFFSET_LABOURITEMS.IGST_PERCENT].Visible = true;
            //    RefreshRowtotal();
            //    this.Refresh();
            //}
        }
