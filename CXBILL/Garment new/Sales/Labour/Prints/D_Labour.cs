...
namespace CXBILL
{
    public class D_labour
    {
        ...
        private static void BuildDetail(RectangleType rectWarper)
        {
            ...
            string BANKADDRESS = "BRANCH      : TRIUPUR OVERSEAS BRANCH";
            string ifsccode = "IFSC CODE  : CNRB0002344";
            string acno = "A/C NO     : 2344201000987";
            ...
            bx_2.Style.BorderStyle.Default = BorderStyleEnum.None;
            ...
            bx_3.Style.BorderStyle.Default = BorderStyleEnum.None;
