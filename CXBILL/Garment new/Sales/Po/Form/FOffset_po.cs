...
namespace CXBILL
{
    public partial class FOffset_Po : UserControl
    {
        ...
        private void Txt_party_po_ref_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_party_po_ref.BackColor = Theme.lbl_EnterBackColor;
            lbl_party_po_ref.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_party_po_ref.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
            ...
            lbl_party_po_ref.BackColor = Theme.lbl_BackColor;
            lbl_party_po_ref.BorderColor = Theme.lbl_BorderColor;
            lbl_party_po_ref.ForeColor = Theme.lbl_ForeColor;
        ...
        private void Btn_edit_Click(object sender, EventArgs e)
        {
            if (vId != "")
            {
                if (COffset_po_exten.LockStatus(vId) == false)
                {
                    splitTimer.Enabled = true;
        ...
        {
            if (FPo_NeedToRefresh != null)
            {
                FPo_NeedToRefresh(this, new EventArgs());
            }
        }
