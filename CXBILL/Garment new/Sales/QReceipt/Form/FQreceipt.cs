...
{ 
    ...
    { 
        ...
        {
            Change_infocus();
            lbl_qreceipt_no.BackColor = Theme.lbl_EnterBackColor;
            lbl_qreceipt_no.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_qreceipt_no.ForeColor = Theme.lbl_EnterForeColor;
        }
        private void Txt_receipt_date_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_qreceipt_date.BackColor = Theme.lbl_EnterBackColor;
            lbl_qreceipt_date.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_qreceipt_date.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        {
            Change_infocus();
            lbl_qreceipt_amount.BackColor = Theme.lbl_EnterBackColor;
            lbl_qreceipt_amount.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_qreceipt_amount.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
            ...
            lbl_qreceipt_no.BackColor = Theme.lbl_BackColor;
            lbl_qreceipt_no.BorderColor = Theme.lbl_BorderColor;
            lbl_qreceipt_no.ForeColor = Theme.lbl_ForeColor;
            
            lbl_qreceipt_date.BackColor = Theme.lbl_BackColor;
            lbl_qreceipt_date.BorderColor = Theme.lbl_BorderColor;
            lbl_qreceipt_date.ForeColor = Theme.lbl_ForeColor;
            ...
            lbl_qreceipt_amount.BackColor = Theme.lbl_BackColor;
            lbl_qreceipt_amount.BorderColor = Theme.lbl_BorderColor;
            lbl_qreceipt_amount.ForeColor = Theme.lbl_ForeColor;
        ...
        public event EventHandler FReceipt_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            if (FReceipt_NeedToRefresh != null)
            {
                FReceipt_NeedToRefresh(this, new EventArgs());
            }
        }
