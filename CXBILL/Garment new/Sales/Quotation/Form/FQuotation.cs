...
namespace CXBILL
{
    public partial class FQuotation 
    {
        ...
        private void Txt_quotation_no_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_quotation_no.BackColor = Theme.lbl_EnterBackColor;
            lbl_quotation_no.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_quotation_no.ForeColor = Theme.lbl_EnterForeColor;
        }
        private void Txt_quotation_date_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_quotation_date.BackColor = Theme.lbl_EnterBackColor;
            lbl_quotation_date.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_quotation_date.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
            ...
            lbl_quotation_no.BackColor = Theme.lbl_BackColor;
            lbl_quotation_no.BorderColor = Theme.lbl_BorderColor;
            lbl_quotation_no.ForeColor = Theme.lbl_ForeColor;

            lbl_quotation_date.BackColor = Theme.lbl_BackColor;
            lbl_quotation_date.BorderColor = Theme.lbl_BorderColor;
            lbl_quotation_date.ForeColor = Theme.lbl_ForeColor;
        ...
        //    {
        //        Core.TaxType = "1";
        //        editgrid.Columns[QUOTATIONITEMS.SGST_PERCENT].Visible = true;
        //        editgrid.Columns[QUOTATIONITEMS.CGST_PERCENT].Visible = true;
        //        editgrid.Columns[QUOTATIONITEMS.IGST_PERCENT].Visible = false;
        //        RefreshRowtotal();
        //        this.Refresh();
        //    }
        ...
        //    {
        //        Core.TaxType = "2";
        //        editgrid.Columns[QUOTATIONITEMS.SGST_PERCENT].Visible = false;
        //        editgrid.Columns[QUOTATIONITEMS.CGST_PERCENT].Visible = false;
        //        editgrid.Columns[QUOTATIONITEMS.IGST_PERCENT].Visible = true;
        //        RefreshRowtotal();
        //        this.Refresh();
        //    }
        //}
        ...
        public event EventHandler FQuotation_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            if (FQuotation_NeedToRefresh != null)
            {
                FQuotation_NeedToRefresh(this, new EventArgs());
            }
        }
        ...
        {
            txt_ledger_id.LookupColNames = new string[] { INVOICE.INVOICE_NO };
        ...
        {
            txt_ledger_id.LookupList = CInvoice_exten.LookupNo(new DAL());
        }
        ...
        private void Print_copies()
        {
            ...
            P_Quotation.Print(frpt.reportViewer1, (vId));
            frpt.Show();
            this.Hide();
        }
