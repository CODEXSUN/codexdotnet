...
namespace CXBILL
{
    public partial class LQuotation : CxControl
    {

        private FQuotation fquotation = null;
        ...
        private void Txt_TodatePicker_TextChanged1(object sender, EventArgs e)
        {
        ...
        private void InitGrid()
        {
            ...
            col_Quotation_Id.Name = QUOTATION.QUOTATION_ID;
            ...
            listgrid.Columns.Add(col_Quotation_Id);

            DataGridViewTextBoxColumn col_Quotation_no = new DataGridViewTextBoxColumn();
            col_Quotation_no.Name = QUOTATION.QUOTATION_NO;
            col_Quotation_no.HeaderText = "NO";
            //col_Quotation_no.Visible = false;
            col_Quotation_no.Width = 100;
            col_Quotation_no.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Quotation_no.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Quotation_no);

            DataGridViewTextBoxColumn col_Quotation_date = new DataGridViewTextBoxColumn();
            col_Quotation_date.Name = QUOTATION.QUOTATION_DATE;
            col_Quotation_date.HeaderText = "DATE";
            //col_Quotation_date.Visible = false;
            col_Quotation_date.Width = 100;
            col_Quotation_date.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Quotation_date.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Quotation_date);

            DataGridViewTextBoxColumn col_Party_id = new DataGridViewTextBoxColumn();
            col_Party_id.Name = QUOTATION.PARTY_ID;
            ...
            col_Grandtotal.Name = QUOTATION.GRANDTOTAL;
            ...
            col_Total_qty.Name = QUOTATION.TOTAL_QTY;
            ...
            col_Total_taxable_amount.Name = QUOTATION.TOTAL_TAXABLE_AMOUNT;
            ...
            col_Ledger_id.Name = QUOTATION.LEDGER_ID;
            ...
            col_Additional.Name = QUOTATION.ADDITIONAL;
            ...
            col_User_Id.Name = QUOTATION.USER_ID;
