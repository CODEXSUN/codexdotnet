...
namespace CXBILL
{
    public partial class LReceipt
    {
        ...
        private void Initialize()
        {
            ...
            //rdo_unrefer.Text = "UN rdo_unrefer";
        ...
        private void InitGrid()
        {
            ...
            col_Receipt_Id.Name = RECEIPT.RECEIPT_ID;
            ...
            col_Receipt_no.Name = RECEIPT.RECEIPT_NO;
            col_Receipt_no.HeaderText = "NO";
            //col_Receipt_no.Visible = false;
            col_Receipt_no.Width = 80;
            ...
            col_Receipt_date.Name = RECEIPT.RECEIPT_DATE;
            col_Receipt_date.HeaderText = "DATE";
            //col_Receipt_date.Visible = false;
            col_Receipt_date.Width = 120;
            ...
            col_Party_id.Name = RECEIPT.PARTY_ID;
            ...
            col_Receipttype_id.Name = RECEIPT.RECEIPTTYPE_ID;
            col_Receipttype_id.HeaderText = "RECEIPTTYPE";
            ...
            col_Receipt_amount.Name = RECEIPT.RECEIPT_AMOUNT;
            ...
            col_Cheq_date.Name = RECEIPT.CHEQ_DATE;
            ...
            col_Bank_id.Name = RECEIPT.BANK_ID;
            col_Bank_id.HeaderText = "BANK";
            //col_Bank_id.Visible = false;
            col_Bank_id.Width = 140;
            ...
            col_Total_amount.Name = RECEIPT.TOTAL_AMOUNT;
            ...
            col_User_Id.Name = RECEIPT.USER_ID;
