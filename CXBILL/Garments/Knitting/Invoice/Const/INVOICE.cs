...
namespace CXKNITTING
{
    ...
    public class Knitting_Invoice
    {
        public string Knitting_Invoice_id { get; set; }
        public string Uniqueno { get; set; }
        public string Company_id { get; set; }
        public string Acy_id { get; set; }
        public int Knitting_Invoice_no { get; set; }
        public string Knitting_Invoice_date { get; set; }
        public string Taxtype_id { get; set; }
        public string Salestype_id { get; set; }
        public string Party_id { get; set; }
        public string Jobno { get; set; }
        public decimal Total_rolls { get; set; }
    ...
    public class KNITTING_INVOICE
    {
        public const string KNITTING_INVOICE_ID = "KNITTING_INVOICE_ID";
        public const string UNIQUENO = "UNIQUENO";
        public const string COMPANY_ID = "COMPANY_ID";
        public const string ACY_ID = "ACY_ID";
        public const string KNITTING_INVOICE_NO = "KNITTING_INVOICE_NO";
        public const string KNITTING_INVOICE_DATE = "KNITTING_INVOICE_DATE";
        ...
        public const string TOTAL_ROLLS = "TOTAL_ROLLS";
        ...
        public const string KNITTING_INVOICE_TBL = "KNITTING_INVOICE_TBL";
    }
