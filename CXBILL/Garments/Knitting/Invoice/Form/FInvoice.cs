...
namespace CXKNITTING
{
    public partial class FInvoice : UserControl
    {
        ...
        {
            Change_infocus();
            lbl_Jobno.BackColor = Theme.lbl_EnterBackColor;
            lbl_Jobno.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_Jobno.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
           ...
           lbl_Jobno.BackColor = Theme.lbl_BackColor;
            lbl_Jobno.BorderColor = Theme.lbl_BorderColor;
            lbl_Jobno.ForeColor = Theme.lbl_ForeColor;
        ...
        private void SetTaxtype()
        {
            ...
            {
                Core.TaxType = "1";
                editgrid.Columns[KNITTING_INVOICEITEMS.SGST_PERCENT].Visible = true;
                editgrid.Columns[KNITTING_INVOICEITEMS.CGST_PERCENT].Visible = true;
                editgrid.Columns[KNITTING_INVOICEITEMS.IGST_PERCENT].Visible = false;
                RefreshRowtotal();
                this.Refresh();
            }
            ...
            {
                Core.TaxType = "2";
                editgrid.Columns[KNITTING_INVOICEITEMS.SGST_PERCENT].Visible = false;
                editgrid.Columns[KNITTING_INVOICEITEMS.CGST_PERCENT].Visible = false;
                editgrid.Columns[KNITTING_INVOICEITEMS.IGST_PERCENT].Visible = true;
                RefreshRowtotal();
                this.Refresh();
            }
        }
