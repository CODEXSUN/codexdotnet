...
namespace CXKNITTING
{
    public partial class FInvoice : UserControl
    {
        ...
        private XLabel lbl_Jobno;
        private XTextBox txt_Jobno;
        ...
        private void Initialize()
        {
            ...
            lbl_Jobno = new XLabel();
            txt_Jobno = new XTextBox();
            ...
            finner_panel.Controls.Add(lbl_Jobno);
            finner_panel.Controls.Add(txt_Jobno);
            ...
            txt_invoice_no.Size = XSize.TwoText;
            ...
            lbl_salestype_id.Location = XLayout.R1_2Label_2(lbl_invoice_no.Location);
            ...
            txt_salestype_id.Size = new Size(XSize.TwoTxtColumn, XSize.TwoTxtHeight);
            txt_salestype_id.Anchor = XAnchor.LT;
            txt_salestype_id.Location = XLayout.R1_2Text_2(txt_invoice_no.Location);
            ...
            lbl_taxtype_id.Text = " GST Tax Type";
            ...
            lbl_taxtype_id.Location = XLayout.R2_2Label_2(lbl_salestype_id.Location);
            ...
            txt_taxtype_id.Size = new Size(XSize.TwoTxtColumn, XSize.TwoTxtHeight);
            txt_taxtype_id.Anchor = XAnchor.LT;
            txt_taxtype_id.Location = XLayout.R2_2Text_2(txt_salestype_id.Location);
            ...
            lbl_Jobno.Font = XFont.Font_10B;
            lbl_Jobno.Name = "lbl_Jobno";
            lbl_Jobno.Text = "  Job NO";
            lbl_Jobno.Anchor = XAnchor.LT;
            lbl_Jobno.TextAlign = ContentAlignment.MiddleLeft;
            lbl_Jobno.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_Jobno.Size = XSize.TwoLabel;
            lbl_Jobno.Location = XLayout.R2_2Label_2(lbl_taxtype_id.Location);

            txt_Jobno.Font = XFont.TxtFont;
            txt_Jobno.ForeColor = XFontColor.TxtFontColor;
            txt_Jobno.BackColor = XTheme.TxtBackcolor;
            txt_Jobno.Name = "txt_bundel";
            txt_Jobno.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_Jobno.TextAlign = HorizontalAlignment.Left;
            txt_Jobno.Size = txt_taxtype_id.Size;
            txt_Jobno.Anchor = XAnchor.LT;
            txt_Jobno.Location = XLayout.R2_2Text_2(txt_taxtype_id.Location);
            txt_Jobno.TabIndex = XTab.Index(txt_salestype_id.TabIndex);
            txt_Jobno.Enter += new EventHandler(Txt_bundel_Enter);

            editgrid.Location = new Point(XLayout.H_left, txt_Jobno.Bottom + 10);
            editgrid.Name = "editgrid";
            editgrid.Size = new Size(finner_panel.Width - 50, 200);
            editgrid.TabIndex = XTab.Index(txt_Jobno.TabIndex);
        ...
        private void InitGrid()
        {
            ...
            col_Invoiceitems_Id.Name = KNITTING_INVOICEITEMS.KNITTING_INVOICEITEMS_ID;
            ...
            col_Invoice_Id.Name = KNITTING_INVOICEITEMS.KNITTING_INVOICE_ID;
            ...
            col_Product_id.Name = KNITTING_INVOICEITEMS.PRODUCT_ID;
            ...
            DataGridViewTextBoxColumn col_Noofrolls = new DataGridViewTextBoxColumn();
            col_Noofrolls.Name = KNITTING_INVOICEITEMS.NOOFROLLS;
            col_Noofrolls.HeaderText = "NO OF ROLLS";
            //col_Sizes_id.Visible = false; 
            col_Noofrolls.Width = 135;
            col_Noofrolls.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            col_Noofrolls.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            editgrid.Columns.Add(col_Noofrolls);

            DataGridViewTextBoxColumn col_Qty = new DataGridViewTextBoxColumn();
            col_Qty.Name = KNITTING_INVOICEITEMS.QTY;
            col_Qty.HeaderText = "KGS";
            ...
            col_Price.Name = KNITTING_INVOICEITEMS.PRICE;
            ...
            col_Sgst_percent.Name = KNITTING_INVOICEITEMS.SGST_PERCENT;
            ...
            col_Cgst_percent.Name = KNITTING_INVOICEITEMS.CGST_PERCENT;
            ...
            col_Igst_percent.Name = KNITTING_INVOICEITEMS.IGST_PERCENT;
            ...
            col_TAXABLEAMOUNT.Name = KNITTING_INVOICEITEMS.TAXABLEAMOUNT;
            ...
            col_SGST_AMOUNT.Name = KNITTING_INVOICEITEMS.SGST_AMOUNT;
            ...
            col_CGST_AMOUNT.Name = KNITTING_INVOICEITEMS.CGST_AMOUNT;
            ...
            col_IGST_AMOUNT.Name = KNITTING_INVOICEITEMS.IGST_AMOUNT;
