...
namespace CXKNITTING
{
    public class D_Invoice
    {
        ...
        public static void Build()
        {
            ...
            ImageType myImage = ReportUtil.AddImage("Image", myEmbeddedImage, Reportlist.ReportItems, 1.3, 0.4, 0.9, 0.9);
        ...
        private static void BuildDetail(RectangleType rectWarper)
        {
            ...
            txt_compname.Style.Font(Customise.PrintInvoiceHeaderCmpTxt_font, 25, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            txt_state.Value = "=Fields!" + PInvoice.STATE + ".Value";
            ...
            x = x + 0; y = y + 0.30; wd = wd + 0; ht = 0.20;
            ...
            x = x + 0; y = y + 0.30; wd = wd + 0; ht = 0.20;
            TextboxType lbl_jobno = ReportUtil.AddTextbox("lbl_jobno" + sufx, nodt_rect.ReportItems, x, y, wd, ht);
            lbl_jobno.Value = "Job NO";
            lbl_jobno.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            x = 3.19; y = 0; wd = 0.35; ht = 0.2;
            RectangleType total_rolls = ReportUtil.AddRectangle("total_rolls" + sufx, subtotal_rect.ReportItems, x, y, wd, ht);
            total_rolls.Style.BorderStyle.Default = BorderStyleEnum.None;
            total_rolls.Style.BorderStyle.Left = BorderStyleEnum.Outset;
            total_rolls.Style.BorderStyle.Right = BorderStyleEnum.Outset;
            //total_rolls.Style.BackgroundColor.Color = Color.PowderBlue;

            x = 0; y = 0.03; wd = wd+0; ht = 0.16;
            TextboxType txt_rolls = ReportUtil.AddTextbox("txt_rolls" + sufx, total_rolls.ReportItems, x, y, wd, ht);
            txt_rolls.Value = "=Fields!" + PInvoice.TOTAL_ROLLS + ".Value";
            txt_rolls.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Normal, FontStyleEnum.Normal);
            txt_rolls.Style.TextAlign = TextAlignRptEnum.Center;
            ...
            //total_qty.Style.BackgroundColor.Color = Color.Red;
            ...
            RectangleType total_rec = ReportUtil.AddRectangle("total_rec" + sufx, subtotal_rect.ReportItems, x, y, wd, ht);
            total_rec.Style.BorderStyle.Default = BorderStyleEnum.None;
            total_rec.Style.BorderStyle.Left = BorderStyleEnum.Outset;
            total_rec.Style.BorderStyle.Right = BorderStyleEnum.Outset;
            //total_amt.Style.BackgroundColor.Color = Color.OrangeRed;

            x = 0; y = 0.03; wd = 0.77; ht = 0.16;
            TextboxType txt_total = ReportUtil.AddTextbox("txt_total" + sufx, total_rec.ReportItems, x, y, wd, ht);
            ...
            string BANK = "BANK NAME : HDFC BANK";
            string BANKADDRESS = "BRANCH      : TRIUPUR BRANCH";
            string ifsccode = "IFSC CODE  : HDFC0002408";
            string acno = "A/C NO     : 50200032553463";
