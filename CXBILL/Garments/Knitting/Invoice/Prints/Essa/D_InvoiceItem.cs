...
namespace CXKNITTING
{
    public class D_InvoiceItem
    {
        ...
        private static void BuildDetail(BodyType rectWarper)
        {
            ...
            //
            x = x + slno.Width.Value; y = 0; wd = 2.36; ht = ht + 0;
            ...
            //
            x = x + hsn_code.Width.Value; y = 0; wd = 0.35; ht = ht + 0;
            RectangleType noofrolls = ReportUtil.AddRectangle("noofrolls" + sufx, subrect.ReportItems, x, y, wd, ht);
            noofrolls.Style.BorderStyle.Default = BorderStyleEnum.Outset;
            //sizes.Style.BackgroundColor.Color = Color.SaddleBrown;
            //
            x = x + noofrolls.Width.Value; y = 0; wd = 0.5; ht = ht + 0;
            ...
            //
            x = x + price.Width.Value; y = 0; wd = 0.78; ht = ht + 0;
            ...
            x = x + sgst_per.Width.Value; y = 0.3; wd = 0.60; ht = ht + 0;
            ...
            x = x + cgst_per.Width.Value; y = 0.3; wd = 0.60; ht = ht + 0;
            ...
            x = x + cgst_amt.Width.Value; y = 0; wd = 0.78; ht = ht + 0.3;
            ...
            x = noofrolls.Left.Value + 0.01; y = 0.04; wd = noofrolls.Width.Value - 0.03; ht = 0.16;
            TextboxType lbl_noofrolls = ReportUtil.AddTextbox("lbl_noofrolls" + sufx, subrect.ReportItems, x, y, wd, ht);
            lbl_noofrolls.Value = "No of Rolls";
            lbl_noofrolls.CanGrow = true;
            lbl_noofrolls.Style.Font("Calibri", 8, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_noofrolls.Style.TextAlign = TextAlignRptEnum.Center;
            ...
            x = noofrolls.Left.Value + 0.01; y = 0; wd = noofrolls.Width.Value - 0.01; ht = ht + 0;
            TextboxType txt_noofrolls = ReportUtil.AddTextbox("txt_noofrolls" + sufx, listdetails_rect.ReportItems, x, y, wd, ht);
            txt_noofrolls.Value = "=Fields!" + PInvoiceitems.NOOFROLLS + ".Value";
            txt_noofrolls.Style.TextAlign = TextAlignRptEnum.Center;
            txt_noofrolls.Style.Font("Tahoma", 8, FontWeightEnum.Normal, FontStyleEnum.Normal);
