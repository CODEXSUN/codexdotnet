...
namespace CXKNITTING
{
    public class P_Invoice
    {
        ...
        {
            Knitting_Invoice invoice = CInvoice_exten.PKId(p_id, new DAL());
            ...
            for (int i = 0; i < printcopies.Count; i++)
            {
                ...
                row.COMPANY_NAME = obj.Display_name;
                row.ADDRESS1 = obj.Street1 + " , " + obj.Street2;
                row.ADDRESS2 = obj.City_id + " - " + obj.Pincode_id + " , " + obj.State_id + ". STATE Code -33,";
                row.COMPANY_TIN = "PAN : " + obj.Pan + "  GSTIN : " + obj.Gst + ", Cell : " + obj.Cell1 + "," + obj.Cell2 + ",";

                row.INVOICE_ID = p_id;
                row.INVOICE_NO = ": " + invoice.Knitting_Invoice_no.ToString();
                row.INVOICE_DATE = ": " + ConvertTO.Date2S(invoice.Knitting_Invoice_date);
                ...
                row.JOBNO = ": " + invoice.Jobno.ToString();
                row.TOTAL_ROLLS = invoice.Total_rolls.ToString();
                ...
                List<Knitting_Invoiceitems> klist = CInvoiceitems_exten.FKId(p_id, new DAL());
    ...
    public class Print_InvoiceRow
    {
        ...
        public string TOTAL_ROLLS { get; set; }
    ...
    public class PInvoice
    {
        ...
        public static string TOTAL_ROLLS = "TOTAL_ROLLS";
