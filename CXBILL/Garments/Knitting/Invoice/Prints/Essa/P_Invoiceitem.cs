...
namespace CXKNITTING
{
    public class P_InvoiceItem
    {
        ...
        public static Print_invoiceItemsList GetData(string p_id)
        {
            ...
            //
            List<Knitting_Invoiceitems> inv_item_list = new List<Knitting_Invoiceitems>();

                inv_item_list = CInvoiceitems_exten.FKId(p_id, new DAL());

            for (int r = 0; r <= inv_item_list.Count - 1; r++)
            {
                Print_invoiceitemsRow row = new Print_invoiceitemsRow();
                //
                row.INVOICE_ITEM_ID = inv_item_list[r].Knitting_Invoiceitems_id;
                row.INVOICE_ID = inv_item_list[r].Knitting_Invoice_id;
                ...
                row.NOOFROLLS = inv_item_list[r].Noofrolls;
    ...
    public class Print_invoiceitemsRow
    {
        ...
        public string NOOFROLLS { get; set; }
    ...
    public class PInvoiceitems
    {
        ...
        public static string NOOFROLLS = "NOOFROLLS";
