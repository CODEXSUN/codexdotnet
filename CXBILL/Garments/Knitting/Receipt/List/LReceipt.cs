...
namespace CXKNITTING
{
    public partial class LReceipt 
    {
        ...
        {
            txt_no.LookupColNames = new string[] { KNITTING_RECEIPT.KNITTING_RECEIPT_NO };
            txt_no.LookupUpdate += Txt_no_LookupUpdate;
        }
        void Txt_no_LookupUpdate(object sender, EventArgs e)
        {
            txt_no.LookupList = CReceipt_exten.LookupNo(new DAL());
        }
        ...
        {
            txt_date.LookupColNames = new string[] { KNITTING_RECEIPT.KNITTING_RECEIPT_DATE };
            txt_date.LookupUpdate += Txt_date_LookupUpdate;
        }
        void Txt_date_LookupUpdate(object sender, EventArgs e)
        {
            txt_date.LookupList = CReceipt_exten.LookupDate(new DAL());
        }
        ...
        {
            txt_party.LookupList = CReceipt_exten.LookupParty(new DAL());
        }
        ...
        private string GetSelectedPkValue()
        {
            ...
            if (vSelRow != null)
            {
                selPkValue = vSelRow.Cells[KNITTING_RECEIPT.KNITTING_RECEIPT_ID].Value.ToString();
            }
            return selPkValue;
        }
