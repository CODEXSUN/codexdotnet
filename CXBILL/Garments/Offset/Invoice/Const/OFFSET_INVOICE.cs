...
namespace CXBILL
{
    ...
    public class Offset_invoice
    {
        public string Offset_invoice_id { get; set; }
        public string Uniqueno { get; set; }
        public string Company_id { get; set; }
        public string Acy_id { get; set; }
        public int Offset_invoice_no { get; set; }
        public string Offset_invoice_date { get; set; }
    ...
    public class OFFSET_INVOICE
    {
        public const string OFFSET_INVOICE_ID = "OFFSET_INVOICE_ID";
        public const string UNIQUENO = "UNIQUENO";
        public const string COMPANY_ID = "COMPANY_ID";
        public const string ACY_ID = "ACY_ID";
        public const string OFFSET_INVOICE_NO = "OFFSET_INVOICE_NO";
        public const string OFFSET_INVOICE_DATE = "OFFSET_INVOICE_DATE";
        ...
        public const string OFFSET_INVOICE_TBL = "OFFSET_INVOICE_TBL";
    }
