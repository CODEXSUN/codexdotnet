...
namespace CXBILL
{
    public partial class FOffset_Invoice : UserControl
    {
        ...
        private void SetTaxtype()
        {
            ...
            {
                Core.TaxType = "1";
                editgrid.Columns[OFFSET_INVOICEITEMS.SGST_PERCENT].Visible = true;
                editgrid.Columns[OFFSET_INVOICEITEMS.CGST_PERCENT].Visible = true;
                editgrid.Columns[OFFSET_INVOICEITEMS.IGST_PERCENT].Visible = false;
                RefreshRowtotal();
                this.Refresh();
            }
            ...
            {
                Core.TaxType = "2";
                editgrid.Columns[OFFSET_INVOICEITEMS.SGST_PERCENT].Visible = false;
                editgrid.Columns[OFFSET_INVOICEITEMS.CGST_PERCENT].Visible = false;
                editgrid.Columns[OFFSET_INVOICEITEMS.IGST_PERCENT].Visible = true;
                RefreshRowtotal();
                this.Refresh();
            }
        }
