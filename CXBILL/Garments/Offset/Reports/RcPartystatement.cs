...
namespace CXBILL
{
    public class RcPartystatement
    {
        ...
        private static string StatementQuery(string party_id, string fromDt, string toDt, string vouchertype)
        {
            ...
            q += " 'Invoice' AS STYPE, \r\n";
            q += " " + OFFSET_INVOICE.OFFSET_INVOICE_NO + " AS SNO, \r\n";
            q += " " + OFFSET_INVOICE.OFFSET_INVOICE_DATE + " AS SDATE, \r\n";
            q += " " + PARTY.PARTY_TBL + "." + PARTY.PARTY_NAME + " AS PARTY, \r\n";
            q += " '' AS CHEQUE, \r\n";
            q += " " + OFFSET_INVOICE.GRANDTOTAL + " AS SALES_AMOUNT, \r\n";
            q += " '' AS RECEIPT_AMOUNT, \r\n";
            q += " " + PARTY.PARTY_TBL + "." + PARTY.OPENING_BALANCE + " AS OPENING_BALANCE \r\n";
            q += " FROM " + OFFSET_INVOICE.OFFSET_INVOICE_TBL + " \r\n";
            q += " INNER JOIN " + PARTY.PARTY_TBL + " ON(" + OFFSET_INVOICE.OFFSET_INVOICE_TBL + "." + OFFSET_INVOICE.PARTY_ID + " = " + PARTY.PARTY_TBL + "." + PARTY.PARTY_ID + ") \r\n";
            q += " UNION ALL \r\n";

            q += " SELECT \r\n";
            q += " " + OFFSET_RECEIPT.COMPANY_ID + ", \r\n";
            q += "'Receipt' AS STYPE, \r\n";
            q += " " + OFFSET_RECEIPT.OFFSET_RECEIPT_NO + " AS SNO, \r\n";
            q += " " + OFFSET_RECEIPT.OFFSET_RECEIPT_DATE + " AS SDATE, \r\n";
            q += " " + PARTY.PARTY_TBL + "." + PARTY.PARTY_NAME + " AS PARTY, \r\n";
            q += " CHEQ_NO AS CHEQUE, \r\n";
            q += " '' AS SALES_AMOUNT, \r\n";
            ...
            q += " INNER JOIN " + PARTY.PARTY_TBL + " ON(" + OFFSET_RECEIPT.OFFSET_RECEIPT_TBL + "." + OFFSET_RECEIPT.PARTY_ID + " = " + PARTY.PARTY_TBL + "." + PARTY.PARTY_ID + ") \r\n";
