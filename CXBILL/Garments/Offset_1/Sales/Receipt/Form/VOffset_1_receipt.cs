...
namespace CXBILL
{
    public partial class FReceipt : UserControl
    {
        ...
        private Offset_1_receipt obj;
        private List<Offset_1_receiptitems> list;
        private string vId;
        ...
        public void SetAction(BtnEvent pAction, string pPkValue)
        {
            ...
            switch (fAction)
            {
                case BtnEvent.Open:
                    btn_save.Text = "&CLOSE";
                    obj = COffset_1_receipt_exten.PKId(pPkValue, new DAL());
                    list = COffset_1_receiptitems_exten.FKId(pPkValue, new DAL());
                    this.EnableControls(false);
                    break;
                case BtnEvent.New:
                    btn_save.Text = "&SAVE";
                    obj = COffset_1_receipt.GetNew;
                    list = COffset_1_receiptitems.GetNew;
        ...
        private void LoadData(Offset_1_receipt obj)
        {
            vId = obj.Offset_1_receipt_id;
            txt_receipt_no.Text = obj.Offset_1_receipt_no;
            txt_receipt_date.Text = obj.Offset_1_receipt_date;
        ...
        public void Loaditems(List<Offset_1_receiptitems> list)
        {
            editgrid.RowCount = 0;
            if (list != null)
            {
                ...
                for (int r = 0; r < list.Count; r++)
                {
                    ...
                    row.Cells[OFFSET_1_RECEIPTITEMS.OFFSET_1_RECEIPT_ID].Value = (list[r].Offset_1_receipt_id) + "";
                    row.Cells[OFFSET_1_RECEIPTITEMS.RECEIPT_BY].Value = (list[r].Receipt_by) + "";
                    row.Cells[OFFSET_1_RECEIPTITEMS.OFFSET_1_INVOICED_NO].Value = (list[r].Garment_invoiced_no) + "";
                    row.Cells[OFFSET_1_RECEIPTITEMS.OFFSET_1_INVOICED_AMOUNT].Value = (list[r].Garment_invoiced_amount) + "";
                    row.Cells[OFFSET_1_RECEIPTITEMS.OFFSET_1_RECEIPT_AMOUNT].Value = (list[r].Offset_1_receipt_amount) + "";
                }
            }
        }
                ...
                switch (fAction)
                {
                    ...
                    case BtnEvent.New:
                        try
                        {
                            ...
                            COffset_1_receipt.Insert(vData, dalsession);
                            vId = DAL.GetIdentity(dalsession);
                            var itemsList = Collectitems(vId);
                            COffset_1_receiptitems.Insert(itemsList, dalsession);
                    ...
                    case BtnEvent.Edit:
                        try
                        {
                            ...
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            COffset_1_receiptitems.Delete(vId, dalsession);
                            COffset_1_receipt.Update(vData, dalsession);
                            var itemsList = Collectitems(vId);
                            COffset_1_receiptitems.Insert(itemsList, dalsession);
                            CReceipt_refered.Refered(itemsList, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Delete:
                        try
                        {
                            ...
                            dalsession.BeginTransaction();
                            COffset_1_receiptitems.Delete(vId, dalsession);
                            COffset_1_receipt.Delete(vId, dalsession);
        ...
        private Offset_1_receipt CollectData()
        {
            Offset_1_receipt fobj = new Offset_1_receipt()
            {
                Offset_1_receipt_id = vId,
                Uniqueno = Current.Acy_id + "~" + Current.Company_id + "~" + txt_receipt_no.Text,
                Company_id = Current.Company_id,
                Acy_id = Current.Acy_id,
                Offset_1_receipt_no = txt_receipt_no.Text,
                Offset_1_receipt_date = txt_receipt_date.Text,
        ...
        private List<Offset_1_receiptitems> Collectitems(string vId)
        {
            ...
            for (int r = 0; r < editgrid.RowCount; r++)
            {
                ...
                if (
                (editgrid[OFFSET_1_RECEIPTITEMS.OFFSET_1_RECEIPT_AMOUNT, r].Value + "") == ""
                )
                {
                ...
                {
                    obj.Offset_1_receiptitems_id = "";
                    obj.Offset_1_receipt_id = vId;
                    obj.Receipt_by = (editgrid[OFFSET_1_RECEIPTITEMS.RECEIPT_BY, r].Value + "");
                    obj.Garment_invoiced_no = (editgrid[OFFSET_1_RECEIPTITEMS.OFFSET_1_INVOICED_NO, r].Value + "");
                    obj.Garment_invoiced_amount = ConvertTO.Decimal(editgrid[OFFSET_1_RECEIPTITEMS.OFFSET_1_INVOICED_AMOUNT, r].Value + "");
                    obj.Offset_1_receipt_amount = ConvertTO.Decimal(editgrid[OFFSET_1_RECEIPTITEMS.OFFSET_1_RECEIPT_AMOUNT, r].Value + "");
