...
namespace CXBILL
{
    public partial class LOffset_1_receipt 
    {
        ...
        {
            txt_no.LookupColNames = new string[] { OFFSET_1_RECEIPT.OFFSET_1_RECEIPT_NO };
            txt_no.LookupUpdate += Txt_no_LookupUpdate;
        }
        void Txt_no_LookupUpdate(object sender, EventArgs e)
        {
            txt_no.LookupList = COffset_1_receipt_exten.LookupNo(new DAL());
        }
        ...
        {
            txt_date.LookupColNames = new string[] { OFFSET_1_RECEIPT.OFFSET_1_RECEIPT_DATE };
            txt_date.LookupUpdate += Txt_date_LookupUpdate;
        }
        void Txt_date_LookupUpdate(object sender, EventArgs e)
        {
            txt_date.LookupList = COffset_1_receipt_exten.LookupDate(new DAL());
        }
        ...
        {
            txt_party.LookupList = COffset_1_receipt_exten.LookupParty(new DAL());
        }
        ...
        private string GetSelectedPkValue()
        {
            ...
            if (vSelRow != null)
            {
                selPkValue = vSelRow.Cells[OFFSET_1_RECEIPT.OFFSET_1_RECEIPT_ID].Value.ToString();
            }
            return selPkValue;
        }
        ...
        //public event EventHandler LReceipt_NeedToRefresh;
        //public void RaiseEvent_NeedToRefresh()
        //{
        //    if (LReceipt_NeedToRefresh != null)
        //    {
        //        LReceipt_NeedToRefresh(this, new EventArgs());
        //    }
        //}
