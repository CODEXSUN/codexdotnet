...
namespace CXBILL
{
    public class CReceipt_refered
    {
        ...
        public static void Refered(List<Offset_1_receiptitems> item, DAL dal)
        {
        ...
        {
            string q = "SELECT SUM(" + OFFSET_1_RECEIPTITEMS.OFFSET_1_RECEIPT_AMOUNT + ") FROM " + OFFSET_1_RECEIPTITEMS.OFFSET_1_RECEIPTITEMS_TBL + " WHERE " + OFFSET_1_RECEIPTITEMS.OFFSET_1_INVOICED_NO + " =" + invoiced_no + " ; ";
        ...
        private static void InvoiceUnlocked(decimal v, string invoiced_no, DAL dal)
        {
            ...
            q += " " + OFFSET_1_INVOICE.LOCKED + " = '" + Core.Unlocked + "' \r\n ";
            q += "  WHERE " + OFFSET_1_INVOICE.OFFSET_1_INVOICE_NO + " = '" + invoiced_no + "' \r\n ";
            q += "  AND " + OFFSET_1_INVOICE.COMPANY_ID + " = '" + Current.Company_id + "' ; \r\n ";
            dal.Execute(q);
        }
        ...
        {
            string q = "UPDATE " + OFFSET_1_INVOICE.OFFSET_1_INVOICE_TBL + " SET \r\n ";
            q += " " + OFFSET_1_INVOICE.LOCKED + " = '" + Core.Partial + "' \r\n ";
            q += "  WHERE " + OFFSET_1_INVOICE.OFFSET_1_INVOICE_NO + " = '" + invoiced_no + "' \r\n ";
            q += "  AND " + OFFSET_1_INVOICE.COMPANY_ID + " = '" + Current.Company_id + "' ; \r\n ";
            dal.Execute(q);
        }
        ...
        {
            string q = "UPDATE " + OFFSET_1_INVOICE.OFFSET_1_INVOICE_TBL + " SET \r\n ";
            q += " " + OFFSET_1_INVOICE.LOCKED + " = '" + Core.Excess + "' \r\n ";
            q += "  WHERE " + OFFSET_1_INVOICE.OFFSET_1_INVOICE_NO + " = '" + invoiced_no + "' \r\n ";
            q += "  AND " + OFFSET_1_INVOICE.COMPANY_ID + " = '" + Current.Company_id + "' ; \r\n ";
            dal.Execute(q);
        }
        ...
        {
            string q = "UPDATE " + OFFSET_1_INVOICE.OFFSET_1_INVOICE_TBL + " SET \r\n ";
            q += " " + OFFSET_1_INVOICE.LOCKED + " = '" + Core.Locked + "' \r\n ";
            q += "  WHERE " + OFFSET_1_INVOICE.OFFSET_1_INVOICE_NO + " = '" + invoiced_no + "' \r\n ";
            q += "  AND " + OFFSET_1_INVOICE.COMPANY_ID + " = '" + Current.Company_id + "' ; \r\n ";
            dal.Execute(q);
        }
