...
{ 
    ...
    { 
        ...
        private XLabel lbl_garment_order_id;
        private LookupBox txt_garment_order_id;
        ...
        private XTextBox txt_garment_invoice_no;
        private XLabel lbl_garment_invoice_no;
        private xDatepicker txt_garment_invoice_date;
        private XLabel lbl_garment_invoice_date;
        ...
        { 
            ...
            lbl_garment_order_id = new XLabel();
            txt_garment_order_id = new LookupBox();
            lbl_salestype_id = new XLabel();
            txt_salestype_id = new LookupBox();
            lbl_taxtype_id = new XLabel();
            txt_taxtype_id = new LookupBox();
            txt_garment_invoice_no = new XTextBox();
            lbl_garment_invoice_no = new XLabel();
            txt_garment_invoice_date = new xDatepicker();
            lbl_garment_invoice_date = new XLabel();
            ...
            finner_panel.Controls.Add(lbl_garment_order_id);
            finner_panel.Controls.Add(txt_garment_order_id);
            ...
            finner_panel.Controls.Add(txt_garment_invoice_no);
            finner_panel.Controls.Add(lbl_garment_invoice_no);
            finner_panel.Controls.Add(txt_garment_invoice_date);
            finner_panel.Controls.Add(lbl_garment_invoice_date);
            ...
            lbl_garment_order_id.Font = XFont.Font_10B;
            lbl_garment_order_id.Name = "lbl_garment_order_id";
            lbl_garment_order_id.Text = "  Order Ref";
            lbl_garment_order_id.Anchor = XAnchor.LT;
            lbl_garment_order_id.TextAlign = ContentAlignment.MiddleLeft;
            lbl_garment_order_id.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_garment_order_id.Size = XSize.OneLabel;
            lbl_garment_order_id.Location = XLayout.FirstLabel;

            txt_garment_order_id.Font = XFont.TxtFont;
            txt_garment_order_id.ForeColor = XFontColor.TxtFontColor;
            txt_garment_order_id.BackColor = XTheme.TxtBackcolor;
            txt_garment_order_id.Name = "txt_garment_order_id";
            txt_garment_order_id.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_garment_order_id.TextAlign = HorizontalAlignment.Left;
            txt_garment_order_id.Size = XSize.ThreeText;
            txt_garment_order_id.Anchor = XAnchor.LT;
            txt_garment_order_id.Location = XLayout.FirstText;
            txt_garment_order_id.TabIndex = XTab.Txt_TabIndex;
            txt_garment_order_id.Enter += new EventHandler(Txt_garment_order_id_Enter);
            ...
            lbl_salestype_id.Location = XLayout.R1_3Label_3(lbl_garment_order_id.Location);
            ...
            txt_salestype_id.Location = XLayout.R1_3Text_3(txt_garment_order_id.Location);
            txt_salestype_id.TabIndex = XTab.Index(btn_save.TabIndex);
            txt_salestype_id.Enter += new EventHandler(Txt_salestype_id_Enter);

            lbl_garment_invoice_no.Font = XFont.Font_10B;
            lbl_garment_invoice_no.Name = "lbl_invoice_no";
            lbl_garment_invoice_no.Text = " Invoice no";
            lbl_garment_invoice_no.Anchor = XAnchor.LT;
            lbl_garment_invoice_no.TextAlign = ContentAlignment.MiddleLeft;
            lbl_garment_invoice_no.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_garment_invoice_no.Size = XSize.OneLabel;
            lbl_garment_invoice_no.Location = XLayout.R2_3Label_1(lbl_garment_order_id.Location);

            txt_garment_invoice_no.Font = XFont.TxtFont;
            txt_garment_invoice_no.ForeColor = XFontColor.TxtFontColor;
            txt_garment_invoice_no.BackColor = XTheme.TxtBackcolor;
            txt_garment_invoice_no.Name = "txt_invoice_no";
            txt_garment_invoice_no.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_garment_invoice_no.TextAlign = HorizontalAlignment.Left;
            txt_garment_invoice_no.Size = XSize.ThreeText;
            txt_garment_invoice_no.Anchor = XAnchor.LT;
            txt_garment_invoice_no.Location = XLayout.R2_3Text_1(txt_garment_order_id.Location);
            txt_garment_invoice_no.TabIndex = XTab.Index(txt_garment_order_id.TabIndex);
            txt_garment_invoice_no.Enter += new EventHandler(Txt_garment_invoice_no_Enter);

            lbl_garment_invoice_date.Font = XFont.Font_10B;
            lbl_garment_invoice_date.Name = "lbl_invoice_date";
            lbl_garment_invoice_date.Text = "   Date";
            lbl_garment_invoice_date.Anchor = XAnchor.LT;
            lbl_garment_invoice_date.TextAlign = ContentAlignment.MiddleLeft;
            lbl_garment_invoice_date.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_garment_invoice_date.Size = XSize.ThreeLabel;
            lbl_garment_invoice_date.Location = XLayout.R1_3Label_2(lbl_garment_invoice_no.Location);

            txt_garment_invoice_date.Font = XFont.TxtFont;
            txt_garment_invoice_date.ForeColor = XFontColor.TxtFontColor;
            txt_garment_invoice_date.BackColor = XTheme.TxtBackcolor;
            txt_garment_invoice_date.Name = "txt_invoice_date";
            txt_garment_invoice_date.CustomFormat = "  dd-MM-yyyy";
            txt_garment_invoice_date.Format = DateTimePickerFormat.Custom;
            txt_garment_invoice_date.Size = XSize.ThreeText;
            txt_garment_invoice_date.Anchor = XAnchor.LT;
            txt_garment_invoice_date.Location = XLayout.R1_3Text_2(txt_garment_invoice_no.Location);
            txt_garment_invoice_date.TabIndex = XTab.Index(txt_garment_invoice_no.TabIndex);
            txt_garment_invoice_date.Enter += new EventHandler(Txt_garment_invoice_date_Enter);
            ...
            lbl_taxtype_id.Location = XLayout.R1_3Label_3(lbl_garment_invoice_date.Location);
            ...
            txt_taxtype_id.Location = XLayout.R1_3Text_3(txt_garment_invoice_date.Location);
            txt_taxtype_id.TabIndex = XTab.Index(txt_salestype_id.TabIndex);
            ...
            lbl_party_id.Location =XLayout.R1_Label(lbl_garment_invoice_date.Location);
            ...
            txt_party_id.Location =XLayout.R1_Text(txt_garment_invoice_date.Location);
            txt_party_id.TabIndex = XTab.Index(txt_garment_invoice_date.TabIndex);
         ...
         private void InitGrid()
         {
            ...
            DataGridViewTextBoxColumn col_Invoiceitems_Id = new DataGridViewTextBoxColumn();
            col_Invoiceitems_Id.Name = GARMENT_INVOICEITEMS.GARMENT_INVOICEITEMS_ID;
            col_Invoiceitems_Id.HeaderText = "INVOICEITEMS_ID ";
            col_Invoiceitems_Id.Visible = false; 
            col_Invoiceitems_Id.Width = 100;
            col_Invoiceitems_Id.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Invoiceitems_Id.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            editgrid.Columns.Add(col_Invoiceitems_Id );

            DataGridViewTextBoxColumn col_Invoice_Id = new DataGridViewTextBoxColumn();
            col_Invoice_Id.Name = GARMENT_INVOICEITEMS.GARMENT_INVOICE_ID;
            ...
            editgrid.Columns.Add(col_Invoice_Id);

            DataGridViewTextBoxColumn col_Invoice_No = new DataGridViewTextBoxColumn();
            col_Invoice_No.Name = GARMENT_INVOICEITEMS.GARMENT_INVOICE_NO;
            col_Invoice_No.HeaderText = "INVOICE_NO ";
            ...
            editgrid.Columns.Add(col_Invoice_No);
            ...
            col_Product_id.Name = GARMENT_INVOICEITEMS.PRODUCT_ID;
            ...
            col_Qty.Name = GARMENT_INVOICEITEMS.QTY;
            ...
            col_Price.Name = GARMENT_INVOICEITEMS.PRICE;
            ...
            col_Sgst_percent.Name = GARMENT_INVOICEITEMS.SGST_PERCENT;
            ...
            col_Cgst_percent.Name = GARMENT_INVOICEITEMS.CGST_PERCENT;
            ...
            col_Igst_percent.Name = GARMENT_INVOICEITEMS.IGST_PERCENT;
            ...
            col_TAXABLEAMOUNT.Name = GARMENT_INVOICEITEMS.TAXABLEAMOUNT;
            ...
            col_SGST_AMOUNT.Name = GARMENT_INVOICEITEMS.SGST_AMOUNT;
            ...
            col_CGST_AMOUNT.Name = GARMENT_INVOICEITEMS.CGST_AMOUNT;
            ...
            col_IGST_AMOUNT.Name = GARMENT_INVOICEITEMS.IGST_AMOUNT;
