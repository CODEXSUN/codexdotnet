...
namespace CXBILL
{
    public partial class FReceipt : UserControl
    {
        ...
        void Editgrid_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            switch (vColName)
            {
                case GARMENT_RECEIPTITEMS.GARMENT_RECEIPT_AMOUNT:
                    CalcTotals();
                    break;
            }
        ...
        void Editgrid_CurrentCellChanged(object sender, EventArgs e)
        {
            ...
            if (editgrid.CurrentCell != null)
            {
                ...
                {
                    case GARMENT_RECEIPTITEMS.RECEIPT_BY:
                        ShowLookupForm();
                        break;
                }
            }
        ...
        private void CalcTotals()
        {
            ...
            {
                decimal vInvoice_amount = Global.ToDecimal(editgrid[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_AMOUNT, r].Value);
                vTotal_Invoice_amount += vInvoice_amount;
                decimal vReceipt_amount = Global.ToDecimal(editgrid[GARMENT_RECEIPTITEMS.GARMENT_RECEIPT_AMOUNT, r].Value);
        ...
        public void ShowLookupForm()
        {
            ...
            switch (lookupColName)
            {
                ...
                case GARMENT_RECEIPTITEMS.RECEIPT_BY:
                    {
                        frmLookup.LookupColNames = new string[] { GARMENT_RECEIPTITEMS.RECEIPT_BY, GARMENT_RECEIPTITEMS.GARMENT_INVOICED_NO, GARMENT_RECEIPTITEMS.GARMENT_INVOICED_AMOUNT, GARMENT_RECEIPTITEMS.GARMENT_RECEIPT_AMOUNT };
                        frmLookup.SelectedPkValue = editgrid[GARMENT_RECEIPTITEMS.RECEIPT_BY, lookupRow].Value;
        ...
        void FrmLookup_LookupSelected(object sender, EventArgs e)
        {
            ...
            switch (lookupColName)
            {
                case GARMENT_RECEIPTITEMS.RECEIPT_BY:
                    ...
                    if (vEntity == null)
                    {
                        editgrid[GARMENT_RECEIPTITEMS.RECEIPT_BY, lookupRow].Value = "";
                        editgrid[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_NO, lookupRow].Value = "";
                        editgrid[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_AMOUNT, lookupRow].Value = "";
                    }
                    else
                    {
                        editgrid[GARMENT_RECEIPTITEMS.RECEIPT_BY, lookupRow].Value = vEntity[GARMENT_RECEIPTITEMS.RECEIPT_BY];

                        if (vEntity[GARMENT_RECEIPTITEMS.RECEIPT_BY].ToString() == Core.Advance)
                        {
                            editgrid[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_NO, lookupRow].Value = "";
                            editgrid[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_AMOUNT, lookupRow].Value = "";
                            editgrid[GARMENT_RECEIPTITEMS.GARMENT_RECEIPT_AMOUNT, lookupRow].Value = "";
                            editgrid.CurrentCell = editgrid[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_AMOUNT, lookupRow];
                        }
                        else
                        {
                            editgrid[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_NO, lookupRow].Value = vEntity[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_NO];
                            editgrid[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_AMOUNT, lookupRow].Value = vEntity[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_AMOUNT];
                            editgrid[GARMENT_RECEIPTITEMS.GARMENT_RECEIPT_AMOUNT, lookupRow].Value = vEntity[GARMENT_RECEIPTITEMS.GARMENT_RECEIPT_AMOUNT];
                            editgrid.CurrentCell = editgrid[GARMENT_RECEIPTITEMS.GARMENT_INVOICED_AMOUNT, lookupRow];
                        }
                    }
                    break;
