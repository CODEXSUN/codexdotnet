...
namespace CXBILL
{
    public class PURCHASE_GST
    {
        public const string COMPANY_NAME = "COMPANY_NAME";
        public const string ACY_NAME = "ACY_NAME";
        public const string PURCHASE_MONTH = "PURCHASE_MONTH";
        ...
        public const string PURCHASE_GST_TBL = "PURCHASE_GST_TBL ";
    ...
    public class Purchase_Gst
    {
        ...
        public string Purchase_Month { get; set; }
