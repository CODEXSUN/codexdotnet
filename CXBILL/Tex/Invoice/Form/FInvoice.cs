    ...
    public partial class FTex_Invoice 
    {
        ...
        private void SetTaxtype()
        {
            if (txt_taxtype_id.Text == Core.SGST)
            {
                ...
                editgrid.Columns[TEX_INVOICEITEMS.SGST_PERCENT].Visible = true;
                editgrid.Columns[TEX_INVOICEITEMS.CGST_PERCENT].Visible = true;
                editgrid.Columns[TEX_INVOICEITEMS.IGST_PERCENT].Visible = false;
                RefreshRowtotal();
                this.Refresh();
            }
            else if (txt_taxtype_id.Text == Core.IGST)
            {
                ...
                editgrid.Columns[TEX_INVOICEITEMS.SGST_PERCENT].Visible = false;
                editgrid.Columns[TEX_INVOICEITEMS.CGST_PERCENT].Visible = false;
                editgrid.Columns[TEX_INVOICEITEMS.IGST_PERCENT].Visible = true;
                RefreshRowtotal();
                this.Refresh();
            }
        }
