...
namespace CXBILL
{
    public class D_IgstInvoice
    {
        ...
        private static void BuildDetail(RectangleType rectWarper)
        {
            ...
            lbl_Igst.Value = "=Fields!" + PTex_Invoice.LBL_IGST + ".Value";
            lbl_Igst.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_Igst.Style.TextAlign = TextAlignRptEnum.Left;
            //lbl_Igst.Style.BackgroundColor.Color = Color.DeepSkyBlue;

            x = 1.85; y = lbl_Igst.Top.Value; wd = totaltext_width; ht = 0.12;
            TextboxType txt_Igst = ReportUtil.AddTextbox("txt_Igst" + sufx, bx_2.ReportItems, x, y, wd, ht);
            txt_Igst.Value = "=Fields!" + PTex_Invoice.TOTAL_IGST + ".Value";
            txt_Igst.Style.Font(Customise.PrintInvoiceBodyTxt_font, 7, FontWeightEnum.Bolder, FontStyleEnum.Normal);
