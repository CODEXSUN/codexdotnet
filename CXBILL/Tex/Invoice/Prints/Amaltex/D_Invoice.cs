    ...
    public class D_Invoice
    {
        ...
        public static void Build()
        {
            ...
            ReportUtil.AddFields(dataSet.Fields, new string[] {
                ...
                PTex_Invoice.COPIES
                ,PTex_Invoice.SALESTYPE

                ,PTex_Invoice.COMPANY_NAME
                ,PTex_Invoice.ADDRESS1
                ,PTex_Invoice.ADDRESS2
                ,PTex_Invoice.COMPANY_TIN

                ,PTex_Invoice.INVOICE_ID
                ,PTex_Invoice.INVOICE_NO
                ,PTex_Invoice.INVOICE_DATE

                ,PTex_Invoice.TRANSPORT
                ,PTex_Invoice.DELIVERYTO
                ,PTex_Invoice.BUNDEL

                ,PTex_Invoice.PARTY_NAME
                ,PTex_Invoice.STREET1
                ,PTex_Invoice.STREET2
                ,PTex_Invoice.CITY
                ,PTex_Invoice.STATE
                ,PTex_Invoice.COUNTRY
                ,PTex_Invoice.PINCODE
                ,PTex_Invoice.GSTIN
                ,PTex_Invoice.TOTAL_QTY

                ,PTex_Invoice.TAXABLE_VALUE

                ,PTex_Invoice.LBL_CGST
                ,PTex_Invoice.LBL_SGST

                ,PTex_Invoice.TOTAL_CGST
                ,PTex_Invoice.TOTAL_SGST
                ,PTex_Invoice.TOTAL_IGST
                ,PTex_Invoice.TOTAL_CESS
                ,PTex_Invoice.TOTAL_SUB
                ,PTex_Invoice.LEDGER
                ,PTex_Invoice.ADDITIONAL
                ,PTex_Invoice.ROUNDS

                ,PTex_Invoice.GSTTOTAL

                ,PTex_Invoice.GRANDTOTAL
                ,PTex_Invoice.AMOUNT_IN_WORDS
                ,PTex_Invoice.NOTES
                ,PTex_Invoice.ENTRY_BY
                });

            x = 0; y = 0; wd = RPT_WIDTH; ht = RPT_HEIGHT;
            ListType Reportlist = ReportUtil.AddList("Reportlist", vBody.ReportItems, x, y, wd, ht);

            Reportlist.Grouping = new GroupingType("group_" + PTex_Invoice.INVOICE_ID + "");
            Reportlist.Grouping.GroupExpressions.Add("=Fields!" + PTex_Invoice.INVOICE_ID + ".Value");
            Reportlist.Grouping.GroupExpressions.Add("=Fields!" + PTex_Invoice.COPIES + ".Value");
            Reportlist.Grouping.PageBreakAtEnd = true;

            EmbeddedImageType myEmbeddedImage = ReportUtil.EmbedImage("Image", Global.GetAbsolutePath("PRINTS\\" + Customise.Logo + ""), vReport);
            ImageType myImage = ReportUtil.AddImage("Image", myEmbeddedImage, Reportlist.ReportItems, 1.3, 0.5, 0.9, 0.9);
            myImage.Sizing = SizingEnum.FitProportional; //.AutoSize //.Fit //.Clip
        ...
        private static void BuildDetail(RectangleType rectWarper)
        {
            ...
            x = 0; y = 0.01; wd = Title_rect.Width.Value; ht = 0.22;
            TextboxType txt_title = ReportUtil.AddTextbox("txtTitle" + sufx, Title_rect.ReportItems, x, y, wd, ht);
            txt_title.Value = "=Fields!" + PTex_Invoice.SALESTYPE + ".Value";
            txt_title.Style.TextAlign = TextAlignRptEnum.Center;
            txt_title.Style.Color.Color = Color.White;
            txt_title.Style.Font(Customise.PrintInvoiceTitleTxt_font, 16, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            txt_copy.Value = "=Fields!" + PTex_Invoice.COPIES + ".Value";
            txt_copy.Style.TextAlign = TextAlignRptEnum.Right;
            txt_copy.Style.Font(Customise.PrintInvoiceCopyTxt_font, 12, FontWeightEnum.Bolder, FontStyleEnum.Italic);
            ...
            x = 0; y = 0.05; wd = Company_txt.Width.Value - 0.02; ht = 0.46;
            TextboxType txt_compname = ReportUtil.AddTextbox("txt_compname" + sufx, Company_txt.ReportItems, x, y, wd, ht);
            txt_compname.Value = "=Fields!" + PTex_Invoice.COMPANY_NAME + ".Value";
            txt_compname.Style.Font(Customise.PrintInvoiceHeaderCmpTxt_font, 30, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            txt_address1.Value = "=Fields!" + PTex_Invoice.ADDRESS1 + ".Value";
            txt_address1.Style.Font(Customise.PrintInvoiceAddressCmpTxt_font, 8, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            txt_address2.Value = "=Fields!" + PTex_Invoice.ADDRESS2 + ".Value";
            txt_address2.Style.Font(Customise.PrintInvoiceAddressCmpTxt_font, 8, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            txt_company_tin.Value = "=Fields!" + PTex_Invoice.COMPANY_TIN + ".Value";
            txt_company_tin.Style.Font(Customise.PrintInvoiceAddressCmpTxt_font, 8, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            lbl_partyname.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            txt_partyname.Value = "=Fields!" + PTex_Invoice.PARTY_NAME + ".Value";
            txt_partyname.CanGrow = true;
            txt_partyname.Style.Font(Customise.PrintInvoicePartyTxt_font, 12, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            txt_street1.Value = "=Fields!" + PTex_Invoice.STREET1 + ".Value";
            txt_street1.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            txt_city.Value = "=Fields!" + PTex_Invoice.CITY + ".Value";
            txt_city.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            txt_state.Value = "=Fields!" + PTex_Invoice.STATE + ".Value";
            txt_state.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            txt_tin.Value = "=Fields!" + PTex_Invoice.GSTIN + ".Value";
            txt_tin.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            lbl_no.Value = "No";
            lbl_no.Style.Font(Customise.PrintInvoicePartyTxt_font, 14, FontWeightEnum.Bolder, FontStyleEnum.Normal);

            x = x + 0; y = y + 0.25; wd = wd + 0; ht = 0.20;
            TextboxType lbl_date = ReportUtil.AddTextbox("lbl_date" + sufx, nodt_rect.ReportItems, x, y, wd, ht);
            lbl_date.Value = "Date";
            lbl_date.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            lbl_transport.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            lbl_deliveryto.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            lbl_bundel.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);

            // fields value

            x = 1.30; y = lbl_no.Top.Value - 0.001; wd = nodt_rect.Width.Value - (x + 0.01); ht = 0.25;
            TextboxType txt_no = ReportUtil.AddTextbox("txt_no" + sufx, nodt_rect.ReportItems, x, y, wd, ht);
            txt_no.Value = "=Fields!" + PTex_Invoice.INVOICE_NO + ".Value";
            txt_no.Style.Font(Customise.PrintInvoicePartyTxt_font, 16, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            txt_date.Value = "=Fields!" + PTex_Invoice.INVOICE_DATE + ".Value";
            txt_date.Style.Format = "dd-MM-yyyy";
            txt_date.Style.Font(Customise.PrintInvoicePartyTxt_font, 11, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            txt_transport.Value = "=Fields!" + PTex_Invoice.TRANSPORT + ".Value";
            txt_transport.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            txt_deliveryto.Value = "=Fields!" + PTex_Invoice.DELIVERYTO + ".Value";
            txt_deliveryto.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            txt_bundel.Value = "=Fields!" + PTex_Invoice.BUNDEL + ".Value";
            txt_bundel.Style.Font(Customise.PrintInvoicePartyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            //total_qty.Style.BackgroundColor.Color = Color.Gainsboro;

            x = 0; y = 0.03; wd = 0.5; ht = 0.16;
            TextboxType txt_qtys = ReportUtil.AddTextbox("txt_qtys" + sufx, total_qty.ReportItems, x, y, wd, ht);
            txt_qtys.Value = "=Fields!" + PTex_Invoice.TOTAL_QTY + ".Value";
            txt_qtys.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Normal, FontStyleEnum.Normal);
            txt_qtys.Style.TextAlign = TextAlignRptEnum.Center;

            x = 4.49; y = 0; wd = 0.78; ht = 0.2;
            ...
            x = 0; y = 0.03; wd = 0.77; ht = 0.16;
            TextboxType txt_total = ReportUtil.AddTextbox("txt_total" + sufx, total_amt.ReportItems, x, y, wd, ht);
            txt_total.Value = "=Fields!" + PTex_Invoice.TAXABLE_VALUE + ".Value";
            txt_total.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Normal, FontStyleEnum.Normal);
            txt_total.Style.TextAlign = TextAlignRptEnum.Right;

            x = 5.47; y = 0; wd = 0.6; ht = 0.2;
            ...
            total_sgst.Value = "=Fields!" + PTex_Invoice.TOTAL_SGST + ".Value";
            total_sgst.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Normal, FontStyleEnum.Normal);
            total_sgst.Style.TextAlign = TextAlignRptEnum.Right;

            x = 6.27; y = 0; wd = 0.6; ht = 0.2;
            ...
            total_cgst.Value = "=Fields!" + PTex_Invoice.TOTAL_CGST + ".Value";
            total_cgst.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Normal, FontStyleEnum.Normal);
            total_cgst.Style.TextAlign = TextAlignRptEnum.Right;

            x = 6.91; y = 0; wd = 0.71; ht = 0.2;
            ...
            x = 0; y = 0.03; wd = 0.71; ht = 0.16;
            TextboxType total_sub = ReportUtil.AddTextbox("total_sub" + sufx, total_sub_rec.ReportItems, x, y, wd, ht);
            total_sub.Value = "=Fields!" + PTex_Invoice.TOTAL_SUB + ".Value";
            total_sub.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            string term1 = "* Goods once sold cannot be return back or exchanged";
            string term2 = "* Seller cannot be responsible for any damage/mistakes.";
            string BANK = "BANK NAME : ICICI BANK";
            string BANKADDRESS = "BRANCH      : P.N.ROAD , TRIUPUR BRANCH";
            string ifsccode = "IFSC CODE  : ICIC0002538";
            string acno = "A/C NO     : 253805500216";
            ...
            double totaltbl_width = 2.68;
            double totalLbl_width = 1.78;
            double totaltext_width = 0.79;

            x = 4.92; y = 0; wd = totaltbl_width; ht = 0.1;
            ...
            x = 0; y = 0; wd = totaltbl_width; ht = 0.01;
            ...
            x = 0; y = 0.03; wd = totalLbl_width; ht = 0.20;
            ...
            lbl_taxablevalue.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_taxablevalue.Style.TextAlign = TextAlignRptEnum.Left;
            //lbl_taxablevalue.Style.BackgroundColor.Color = Color.DeepSkyBlue;

            x = 1.85; y = lbl_taxablevalue.Top.Value; wd = totaltext_width; ht = 0.12;
            TextboxType txt_taxable_amt = ReportUtil.AddTextbox("txt_taxable_amt" + sufx, bx_1.ReportItems, x, y, wd, ht);
            txt_taxable_amt.Value = "=Fields!" + PTex_Invoice.TAXABLE_VALUE + ".Value";
            txt_taxable_amt.Style.Font(Customise.PrintInvoiceBodyTxt_font, 7, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            txt_taxable_amt.Style.TextAlign = TextAlignRptEnum.Right;
            //txt_taxable_amt.Style.BackgroundColor.Color = Color.White;


            x = 0; y = 0.01; wd = totaltbl_width; ht = 0.01;
            ...
            lbl_Sgst.Value = "=Fields!" + PTex_Invoice.LBL_SGST + ".Value";
            lbl_Sgst.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_Sgst.Style.TextAlign = TextAlignRptEnum.Left;
            //lbl_Sgst.Style.BackgroundColor.Color = Color.DeepSkyBlue;

            x = 1.85; y = lbl_Sgst.Top.Value; wd = totaltext_width; ht = 0.12;
            TextboxType txt_Sgst = ReportUtil.AddTextbox("txt_Sgst" + sufx, bx_2.ReportItems, x, y, wd, ht);
            txt_Sgst.Value = "=Fields!" + PTex_Invoice.TOTAL_SGST + ".Value";
            txt_Sgst.Style.Font(Customise.PrintInvoiceBodyTxt_font, 7, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            txt_Sgst.Style.TextAlign = TextAlignRptEnum.Right;
            //txt_Sgst.Style.BackgroundColor.Color = Color.White;


            x = 0; y = 0.02; wd = totaltbl_width; ht = 0.01;
            ...
            lbl_cgst.Value = "=Fields!" + PTex_Invoice.LBL_CGST + ".Value";
            lbl_cgst.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_cgst.Style.TextAlign = TextAlignRptEnum.Left;
            //lbl_cgst.Style.BackgroundColor.Color = Color.DeepSkyBlue;

            x = 1.85; y = lbl_cgst.Top.Value; wd = totaltext_width; ht = 0.12;
            TextboxType txt_cgst = ReportUtil.AddTextbox("txt_cgst" + sufx, bx_3.ReportItems, x, y, wd, ht);
            txt_cgst.Value = "=Fields!" + PTex_Invoice.TOTAL_CGST + ".Value";
            txt_cgst.Style.Font(Customise.PrintInvoiceBodyTxt_font, 7, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            txt_cgst.Style.TextAlign = TextAlignRptEnum.Right;
            //txt_cgst.Style.BackgroundColor.Color = Color.White;

            x = 0; y = 0.03; wd = totaltbl_width; ht = 0.01;
            ...
            lbl_GSTTotal.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_GSTTotal.Style.TextAlign = TextAlignRptEnum.Left;
            //lbl_GSTTotal.Style.BackgroundColor.Color = Color.DeepSkyBlue;

            x = 1.85; y = lbl_GSTTotal.Top.Value; wd = totaltext_width; ht = 0.12;
            TextboxType txt_GSTTotal = ReportUtil.AddTextbox("txt_GSTTotal" + sufx, bx_4.ReportItems, x, y, wd, ht);
            txt_GSTTotal.Value = "=Fields!" + PTex_Invoice.GSTTOTAL + ".Value";
            txt_GSTTotal.Style.Font(Customise.PrintInvoiceBodyTxt_font, 7, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            txt_GSTTotal.Style.TextAlign = TextAlignRptEnum.Right;
            //txt_GSTTotal.Style.BackgroundColor.Color = Color.White;


            x = 0; y = 0.04; wd = totaltbl_width; ht = 0.01;
            ...
            txt_ledger.Value = "=Fields!" + PTex_Invoice.LEDGER + ".Value";
            txt_ledger.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            txt_ledger.Style.TextAlign = TextAlignRptEnum.Left;
            //txt_ledger.Style.BackgroundColor.Color = Color.DeepSkyBlue;

            x = 1.85; y = txt_ledger.Top.Value; wd = totaltext_width; ht = 0.12;
            TextboxType txt_additional = ReportUtil.AddTextbox("txt_additional" + sufx, bx_5.ReportItems, x, y, wd, ht);
            txt_additional.Value = "=Fields!" + PTex_Invoice.ADDITIONAL + ".Value";
            txt_additional.Style.Font(Customise.PrintInvoiceBodyTxt_font, 7, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            txt_additional.Style.TextAlign = TextAlignRptEnum.Right;
            //txt_additional.Style.BackgroundColor.Color = Color.Tan;


            x = 0; y = 0.05; wd = totaltbl_width; ht = 0.01;
            ...
            lbl_round.Style.Font(Customise.PrintInvoiceBodyTxt_font, 8, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_round.Style.TextAlign = TextAlignRptEnum.Left;
            //lbl_round.Style.BackgroundColor.Color = Color.DeepSkyBlue;

            x = 1.85; y = lbl_round.Top.Value; wd = totaltext_width; ht = 0.12;
            TextboxType txt_round = ReportUtil.AddTextbox("txt_round" + sufx, bx_6.ReportItems, x, y, wd, ht);
            txt_round.Value = "=Fields!" + PTex_Invoice.ROUNDS + ".Value";
            txt_round.Style.Font(Customise.PrintInvoiceBodyTxt_font, 7, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            txt_amtnwords.Value = "=Fields!" + PTex_Invoice.AMOUNT_IN_WORDS + ".Value";
            txt_amtnwords.CanGrow = true;
            txt_amtnwords.Style.Font(Customise.PrintInvoiceBodyTxt_font, 10, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            txt_amtnwords.Style.TextAlign = TextAlignRptEnum.Left;
            //txt_amtnwords.Style.BackgroundColor.Color = Color.DeepSkyBlue;

            x = 4.95; y = 0.08; wd = 1.3; ht = 0.28;
            ...
            lbl_grandtotal.Style.Font(Customise.PrintInvoiceBodyTxt_font, 10, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            x = 6.2; y = 0.08; wd = 1.43; ht = 0.28;
            TextboxType txt_grandtotal = ReportUtil.AddTextbox("txt_grandtotal" + sufx, grandtotal_rect.ReportItems, x, y, wd, ht);
            txt_grandtotal.Value = "=Fields!" + PTex_Invoice.GRANDTOTAL + ".Value";
            txt_grandtotal.Style.Font(Customise.PrintInvoiceBodyTxt_font, 12, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            txt_receiversign.Style.Font(Customise.PrintInvoiceBodyTxt_font, 10, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            x = amtnwords.Width.Value; y = 0; wd = 2.67; ht = 0.95;
            ...
            x = 0.05; y = 0.06; wd = 2.5; ht = 0.16;
            TextboxType lbl_for = ReportUtil.AddTextbox("lbl_for" + sufx, forspace.ReportItems, x, y, wd, ht);
            lbl_for.Value = "For";
            lbl_for.Style.Font(Customise.PrintInvoiceFORTxt_font, 9, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_for.Style.TextAlign = TextAlignRptEnum.Left;

            x = x + 0.3; y = 0.04; wd = 2.5 - x; ht = 0.20;
            ...
            lbl_forcompany.Style.Font(Customise.PrintInvoiceFORTxt_font, 10, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_forcompany.Style.TextAlign = TextAlignRptEnum.Left;

            x = lbl_for.Left.Value + 0.2; y = 0.70; wd = 2.5 - x; ht = 0.15;
            ...
            lbl_sign.Style.Font(Customise.PrintInvoiceBodyTxt_font, 9, FontWeightEnum.Normal, FontStyleEnum.Normal);
            ...
            if (Customise.PrintJuridication == true)
            {
                ...
                lbl_stj.Style.Font(Customise.PrintInvoiceBodyTxt_font, 7, FontWeightEnum.Bolder, FontStyleEnum.Normal);
