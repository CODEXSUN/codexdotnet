...
namespace CXBILL
{
    public static class D_InvoiceItem
    {
        ...
        private static void BuildDetail(BodyType rectWarper)
        {
            ...
            //
            x = x + hsn_code.Width.Value; y = 0; wd = 2.36; ht = ht + 0;
            ...
            //
            x = x + sizes.Width.Value; y = 0; wd = 0.5; ht = ht + 0;
            ...
            txt_sizes.Value = "=Fields!" + PInvoiceitems.SIZES_ID + ".Value";
