...
namespace CXBILL
{
    public class P_Invoice
    {
        ...
        {
            vPId = pP_id;
            Print_Tex_InvoiceList data = GetData(pP_id, printdata);
        ...
        private static Print_Tex_InvoiceList GetData(string p_id, List<PrintCopies> printcopies)
        {
            Tex_Invoice invoice = CTex_Invoice_exten.PKId(p_id);

            Print_Tex_InvoiceList list = new Print_Tex_InvoiceList();

            for (int i = 0; i < printcopies.Count; i++)
            {
                Print_Tex_InvoiceRow row = new Print_Tex_InvoiceRow();

                row.COPIES = printcopies[i].Copies;
                row.SALESTYPE = invoice.Salestype_id;

                Company obj = CCompany_exten.PKId(Current.Company_id);
                row.COMPANY_NAME = "Amal Tex";
                row.ADDRESS1 = obj.Street1 + " , " + obj.Street2;
                row.ADDRESS2 = obj.City_id + " - " + obj.Pincode_id + " , " + obj.State_id + ". STATE Code -33,";
                row.COMPANY_TIN = "PAN : " + obj.Pan + "  GSTIN : " + obj.Gst + ", Cell :  098659 62999 , 090033 55404";// ,    Cell :    " + obj.Cell1 + " ";
                ...
                List<Tex_invoiceitems> klist = CTex_Invoiceitems_exten.FKId(p_id, new DAL());
    ...
    public class Print_Tex_InvoiceList : System.ComponentModel.BindingList<Print_Tex_InvoiceRow>
    {
    }
    public class Print_Tex_InvoiceRow
    {
    ...
    public class PTex_Invoice
    {
        ...
        public static string LBL_IGST = "LBL_IGST";
