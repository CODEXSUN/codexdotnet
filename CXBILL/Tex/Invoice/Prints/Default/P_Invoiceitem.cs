...
namespace CXTEX
{
    public class P_InvoiceItem
    {
        ...
        public static Print_invoiceItemsList GetData(string p_id)
        {
            ...
            //
            List<Invoiceitems> inv_item_list = new List<Invoiceitems>();
            ...
            {
                inv_item_list = CInvoiceitems_exten.FKNo(p_id, new DAL());
            }
            ...
            for (int r = 0; r <= inv_item_list.Count - 1; r++)
            {
                ...
                //
                row.INVOICE_ITEM_ID = inv_item_list[r].Invoiceitems_id;
