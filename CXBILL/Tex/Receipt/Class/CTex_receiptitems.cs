...
namespace CXBILL
{
    public class CTex_receiptitems 
    {
        ...
        {
            q = q.Replace("@" + TEX_RECEIPTITEMS.TEX_RECEIPT_ID + "@", "" + ConvertTO.SqlString(v.Garment_receipt_id) + "");
            q = q.Replace("@" + TEX_RECEIPTITEMS.RECEIPT_BY + "@", "" + ConvertTO.SqlString(v.Receipt_by) + "");
            q = q.Replace("@" + TEX_RECEIPTITEMS.TEX_INVOICED_NO + "@", "" + ConvertTO.SqlString(v.Garment_invoiced_no) + "");
            q = q.Replace("@" + TEX_RECEIPTITEMS.TEX_INVOICED_AMOUNT + "@", "" + ConvertTO.SqlString(v.Garment_invoiced_amount + ""));
            q = q.Replace("@" + TEX_RECEIPTITEMS.TEX_RECEIPT_AMOUNT + "@", "" + ConvertTO.SqlString(v.Garment_receipt_amount + ""));
            return q;
        }
        ...
        {
                string q = " INSERT INTO " + TEX_RECEIPTITEMS.TEX_RECEIPTITEMS_TBL + " ( ";
                q += " " + TEX_RECEIPTITEMS.TEX_RECEIPT_ID + " \r\n ";
                q += "," + TEX_RECEIPTITEMS.RECEIPT_BY + " \r\n ";
                q += "," + TEX_RECEIPTITEMS.TEX_INVOICED_NO + " \r\n ";
                q += "," + TEX_RECEIPTITEMS.TEX_INVOICED_AMOUNT + " \r\n ";
                q += "," + TEX_RECEIPTITEMS.TEX_RECEIPT_AMOUNT + " \r\n ";
                q += " ) VALUES ( ";
                q += "  @"+ TEX_RECEIPTITEMS.TEX_RECEIPT_ID + "@ \r\n ";
                q += ", @"+ TEX_RECEIPTITEMS.RECEIPT_BY + "@ \r\n ";
                q += ", @"+ TEX_RECEIPTITEMS.TEX_INVOICED_NO + "@ \r\n ";
        ...
        {
                dalsession.Execute("DELETE FROM  " + TEX_RECEIPTITEMS.TEX_RECEIPTITEMS_TBL+ " WHERE " + TEX_RECEIPTITEMS.TEX_RECEIPT_ID + " =  " + fkid +";");
        }
        #endregion[Delete]
