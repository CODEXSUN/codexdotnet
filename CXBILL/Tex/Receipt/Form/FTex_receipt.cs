...
{ 
    ...
    { 
        ...
        {
            Change_infocus();
            lbl_receipt_no.BackColor = Theme.lbl_EnterBackColor;
            lbl_receipt_no.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_receipt_no.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
            ...
            lbl_receipt_no.BackColor = Theme.lbl_BackColor;
            lbl_receipt_no.BorderColor = Theme.lbl_BorderColor;
            lbl_receipt_no.ForeColor = Theme.lbl_ForeColor;
