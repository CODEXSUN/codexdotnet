...
namespace CXBILL
{
    public partial class LTex_receipt 
    {
        ...
        {
            txt_no.LookupColNames = new string[] { TEX_RECEIPT.TEX_RECEIPT_NO };
            txt_no.LookupUpdate += Txt_no_LookupUpdate;
        }
        void Txt_no_LookupUpdate(object sender, EventArgs e)
        {
            txt_no.LookupList = CTex_receipt_exten.LookupNo(new DAL());
        }
        ...
        {
            txt_date.LookupColNames = new string[] { TEX_RECEIPT.TEX_RECEIPT_DATE };
            txt_date.LookupUpdate += Txt_date_LookupUpdate;
        }
        void Txt_date_LookupUpdate(object sender, EventArgs e)
        {
            txt_date.LookupList = CTex_receipt_exten.LookupDate(new DAL());
        }
        ...
        {
            txt_party.LookupList = CTex_receipt_exten.LookupParty(new DAL());
        }
        ...
        private string GetSelectedPkValue()
        {
            ...
            if (vSelRow != null)
            {
                selPkValue = vSelRow.Cells[TEX_RECEIPT.TEX_RECEIPT_ID].Value.ToString();
            }
            return selPkValue;
        }
