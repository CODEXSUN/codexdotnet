...
namespace CXBILL
{
    public class CReceipt_refered
    {
        ...
        {
            string q = "SELECT SUM(" + TEX_RECEIPTITEMS.TEX_RECEIPT_AMOUNT + ") FROM " + TEX_RECEIPTITEMS.TEX_RECEIPTITEMS_TBL + " WHERE " + TEX_RECEIPTITEMS.TEX_INVOICED_NO + " =" + invoiced_no + " ; ";
        ...
        private static void InvoiceUnlocked(decimal v, string invoiced_no, DAL dal)
        {
            ...
            q += " " + TEX_INVOICE.LOCKED + " = '" + Core.Unlocked + "' \r\n ";
            q += "  WHERE " + TEX_INVOICE.INVOICE_NO + " = '" + invoiced_no + "' \r\n ";
            q += "  AND " + TEX_INVOICE.COMPANY_ID + " = '" + Current.Company_id + "' ; \r\n ";
            dal.Execute(q);
        }
        ...
        {
            string q = "UPDATE " + TEX_INVOICE.TEX_INVOICE_TBL + " SET \r\n ";
            q += " " + TEX_INVOICE.LOCKED + " = '" + Core.Partial + "' \r\n ";
            q += "  WHERE " + TEX_INVOICE.INVOICE_NO + " = '" + invoiced_no + "' \r\n ";
            q += "  AND " + TEX_INVOICE.COMPANY_ID + " = '" + Current.Company_id + "' ; \r\n ";
            dal.Execute(q);
        }
        ...
        {
            string q = "UPDATE " + TEX_INVOICE.TEX_INVOICE_TBL + " SET \r\n ";
            q += " " + TEX_INVOICE.LOCKED + " = '" + Core.Excess + "' \r\n ";
            q += "  WHERE " + TEX_INVOICE.INVOICE_NO + " = '" + invoiced_no + "' \r\n ";
            q += "  AND " + TEX_INVOICE.COMPANY_ID + " = '" + Current.Company_id + "' ; \r\n ";
            dal.Execute(q);
        }
        ...
        {
            string q = "UPDATE " + TEX_INVOICE.TEX_INVOICE_TBL + " SET \r\n ";
            q += " " + TEX_INVOICE.LOCKED + " = '" + Core.Locked + "' \r\n ";
            q += "  WHERE " + TEX_INVOICE.INVOICE_NO + " = '" + invoiced_no + "' \r\n ";
            q += "  AND " + TEX_INVOICE.COMPANY_ID + " = '" + Current.Company_id + "' ; \r\n ";
            dal.Execute(q);
        }
