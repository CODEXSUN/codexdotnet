...
namespace CXBILL
{
    ...
    public class Upvc_invoice
    {
        public string Upvc_invoice_id { get; set; }
        ...
        public decimal Total_areasq { get; set; }
        ...
        public decimal Refered_no { get; set; }
    ...
    public class UPVC_INVOICE
    {
        public const string UPVC_INVOICE_ID = "UPVC_INVOICE_ID";
        ...
        public const string DELIVEREDTO_ID = "DELIVEREDTO_ID";
        ...
        // 
        public const string UPVC_INVOICE_TBL = "UPVC_INVOICE_TBL";
    }
