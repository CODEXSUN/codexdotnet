    ...
    public partial class FUpvc_invoice : UserControl
    {
        ...
        private void SetTaxtype()
        {
            if (Core.TaxType == Core.SGST)
            {
                ...
                editgrid.Columns[UPVC_INVOICEITEMS.SGST_PERCENT].Visible = true;
                editgrid.Columns[UPVC_INVOICEITEMS.CGST_PERCENT].Visible = true;
                editgrid.Columns[UPVC_INVOICEITEMS.IGST_PERCENT].Visible = false;
                //RefreshRowtotal();
                this.Refresh();
            }
            else if (Core.TaxType == Core.IGST)
            {
                ...
                editgrid.Columns[UPVC_INVOICEITEMS.SGST_PERCENT].Visible = false;
                editgrid.Columns[UPVC_INVOICEITEMS.CGST_PERCENT].Visible = false;
                editgrid.Columns[UPVC_INVOICEITEMS.IGST_PERCENT].Visible = true;
                //RefreshRowtotal();
                this.Refresh();
            }
        }
