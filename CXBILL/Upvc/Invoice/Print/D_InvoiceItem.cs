    ...
    public class D_InvoiceItem
    {
        ...
        public static void build()
        {
            ...
            ReportUtil.AddFields(dataSet.Fields, new string[] {
                ...
                ,PInvoiceitems.QTY
                ,PInvoiceitems.WIDTHS
                ,PInvoiceitems.HEIGTHS
                ,PInvoiceitems.AREASQ
                ,PInvoiceitems.PRICE
        ...
        private static void BuildDetail(BodyType rectWarper)
        {
            ...
            txt_widths.Value = "=Fields!" + PInvoiceitems.WIDTHS + ".Value";
            ...
            txt_heights.Value = "=Fields!" + PInvoiceitems.HEIGTHS + ".Value";
            ...
            txt_areasq.Value = "=Fields!" + PInvoiceitems.AREASQ + ".Value";
