...
namespace CXBILL
{
    public partial class LUpvc_Quotation : CxControl
    {
         ...
         private void BuildForm()
         {
             ...
             fupvc_quotation.FUpvc_invoice_NeedToRefresh += VUpvc_invoice_NeedToRefresh;
       ...
       private void Rdo_notactive_CheckedChanged(object sender, EventArgs e)
       {
        ...
        private void Btn_generate_Click(object sender, EventArgs e)
        {
         ...
         {
             txt_no.LookupColNames = new string[] { UPVC_QUOTATION.QUOTATION_NO };
         ...
         {
             txt_date.LookupColNames = new string[] { UPVC_QUOTATION.QUOTATION_DATE };
