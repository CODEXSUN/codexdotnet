...
namespace CXBILL
{
    public partial class LUpvc_Quotation : CxControl
    {
        ...
        private void InitGrid()
        {
            ...
            col_Upvc_invoice_Id.Name = UPVC_QUOTATION.UPVC_QUOTATION_ID;
            ...
            listgrid.Columns.Add(col_Upvc_invoice_Id);

            DataGridViewTextBoxColumn col_Upvc_salesmode_id = new DataGridViewTextBoxColumn();
            col_Upvc_salesmode_id.Name = UPVC_QUOTATION.TAXTYPE_ID;
            ...
            DataGridViewTextBoxColumn col_Upvc_invoice_no = new DataGridViewTextBoxColumn();
            col_Upvc_invoice_no.Name = UPVC_QUOTATION.QUOTATION_NO;
            col_Upvc_invoice_no.HeaderText = "INVOICE NO";
            //col_Upvc_invoice_no.Visible = false;
            col_Upvc_invoice_no.Width = 162;
            col_Upvc_invoice_no.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Upvc_invoice_no.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Upvc_invoice_no);

            DataGridViewTextBoxColumn col_Upvc_invoice_date = new DataGridViewTextBoxColumn();
            col_Upvc_invoice_date.Name = UPVC_QUOTATION.QUOTATION_DATE;
            col_Upvc_invoice_date.HeaderText = "INVOICE DATE";
            //col_Upvc_invoice_date.Visible = false;
            col_Upvc_invoice_date.Width = 188;
            col_Upvc_invoice_date.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Upvc_invoice_date.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Upvc_invoice_date);
            ...
            col_Upvc_salestype.Name = UPVC_QUOTATION.SALESTYPE_ID;
