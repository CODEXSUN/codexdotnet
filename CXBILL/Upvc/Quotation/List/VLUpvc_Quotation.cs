    ...
    public partial class LUpvc_Quotation : CxControl
    {
        ...
        public void LoadData(List<Upvc_Quotation> list)
        {
            ...
            for (int r = 0; r < list.Count; r++)
            {
                ...
                row.Cells[UPVC_QUOTATION.SALESTYPE_ID].Value = list[r].Taxtype_id;
                row.Cells[UPVC_QUOTATION.TAXTYPE_ID].Value = list[r].Salestype_id;
                row.Cells[UPVC_QUOTATION.QUOTATION_NO].Value = list[r].Quotation_no;
                row.Cells[UPVC_QUOTATION.QUOTATION_DATE].Value = ConvertTO.Date2S(list[r].Quotation_date);
                row.Cells[UPVC_QUOTATION.PARTY_ID].Value = list[r].Party_id;
                row.Cells[UPVC_QUOTATION.TRANSPORT_ID].Value = list[r].Transport_id;
