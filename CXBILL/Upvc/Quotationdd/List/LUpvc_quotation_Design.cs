...
namespace CXUPVC
{
    public partial class LUpvc_quotation : UserControl
    {
        ...
        private FUpvc_quotation fupvc_quotation = null;
        private bool constructed_flag = false;

        public LUpvc_quotation()
        {
            InitializeComponent();
            Initialize();
            InitGrid();
        ...
        private void InitGrid()
        {
            ...
            col_Upvc_quotation_Id.Name = UPVC_QUOTATION.UPVC_QUOTATION_ID;
            ...
            listgrid.Columns.Add(col_Upvc_quotation_Id);

            DataGridViewTextBoxColumn col_Upvc_salesmode_id = new DataGridViewTextBoxColumn();
            col_Upvc_salesmode_id.Name = UPVC_QUOTATION.UPVC_SALESMODE_ID;
            col_Upvc_salesmode_id.HeaderText = "SALES MODE";
            col_Upvc_salesmode_id.Visible = false;
            col_Upvc_salesmode_id.Width = 160;
            col_Upvc_salesmode_id.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Upvc_salesmode_id.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Upvc_salesmode_id);

            DataGridViewTextBoxColumn col_Upvc_quotation_no = new DataGridViewTextBoxColumn();
            col_Upvc_quotation_no.Name = UPVC_QUOTATION.UPVC_QUOTATION_NO;
            col_Upvc_quotation_no.HeaderText = "QUOTE NO";
            //col_Upvc_quotation_no.Visible = false;
            col_Upvc_quotation_no.Width = 162;
            col_Upvc_quotation_no.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Upvc_quotation_no.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Upvc_quotation_no);

            DataGridViewTextBoxColumn col_Upvc_quotation_date = new DataGridViewTextBoxColumn();
            col_Upvc_quotation_date.Name = UPVC_QUOTATION.UPVC_QUOTATION_DATE;
            col_Upvc_quotation_date.HeaderText = " DATE";
            //col_Upvc_quotation_date.Visible = false;
            col_Upvc_quotation_date.Width = 188;
            col_Upvc_quotation_date.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Upvc_quotation_date.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Upvc_quotation_date);

            DataGridViewTextBoxColumn col_Party_id = new DataGridViewTextBoxColumn();
            col_Party_id.Name = UPVC_QUOTATION.PARTY_ID;
            ...
            col_Total_qty.Name = UPVC_QUOTATION.TOTAL_QTY;
            ...
            col_Gsttotal.Name = UPVC_QUOTATION.GSTTOTAL;
            col_Gsttotal.HeaderText = "GSTTOTAL";
            //col_Gsttotal.Visible = false;
            col_Gsttotal.Width = 100;
            ...
            col_Grandtotal.Name = UPVC_QUOTATION.GRANDTOTAL;
            col_Grandtotal.HeaderText = "GRANDTOTAL";
            //col_Grandtotal.Visible = false;
            col_Grandtotal.Width = 162;
            ...
            DataGridViewTextBoxColumn col_Upvc_salestype = new DataGridViewTextBoxColumn();
            col_Upvc_salestype.Name = UPVC_QUOTATION.SALESTYPE;
            col_Upvc_salestype.HeaderText = "SALES TYPE";
            //col_Upvc_salestype.Visible = false;
            col_Upvc_salestype.Width = 162;
            col_Upvc_salestype.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Upvc_salestype.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Upvc_salestype);

            //DataGridViewTextBoxColumn col_Transport_mode_id = new DataGridViewTextBoxColumn();
            //col_Transport_mode_id.Name = UPVC_QUOTATION.TRANSPORT_ID;
            //col_Transport_mode_id.HeaderText = "TRANSPORT MODE";
            //col_Transport_mode_id.Visible = false;
            //col_Transport_mode_id.Width = 212;
            //col_Transport_mode_id.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            //col_Transport_mode_id.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            //listgrid.Columns.Add(col_Transport_mode_id);

            //DataGridViewTextBoxColumn col_Vehicle_no = new DataGridViewTextBoxColumn();
            //col_Vehicle_no.Name = UPVC_QUOTATION.VEHICLE_NO;
            //col_Vehicle_no.HeaderText = "VEHICLE NO";
            //col_Vehicle_no.Visible = false;
            //col_Vehicle_no.Width = 162;
            //col_Vehicle_no.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            //col_Vehicle_no.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            //listgrid.Columns.Add(col_Vehicle_no);

            DataGridViewTextBoxColumn col_Ledger_id = new DataGridViewTextBoxColumn();
            col_Ledger_id.Name = UPVC_QUOTATION.LEDGER_ID;
            ...
            col_Additional.Name = UPVC_QUOTATION.ADDITIONAL;
            ...
            col_User_Id.Name = UPVC_QUOTATION.USER_ID;
