...
namespace CXUPVC
{
    public class D_Quotation
    {
        ...
        private static void BuildDetail(RectangleType rectWarper)
        {
            ...
            x = 0; y = y + party_rect.Height.Value + 0.04; wd = wd + 0; ht = 4;
            ...
            x = 0; y = y + subtotal_rect.Height.Value; wd = wd = wd + 0; ht = 0.1;
            ...
            ////lbl_modeoftransport.Value = "=Fields!" + PQuotation.TRANSPORT_MODE + ".Value";
            ...
            //////lbl_vehicle.Value = "=Fields!" + PQuotation.VEHICLE_NO + ".Value";
            ...
            x = 0.1; y = 0.06; wd = party_area.Width.Value - (x + 0.2); ht = 0.20;
            ...
            x = 0.08; y =  0.2 ; wd = shipping_rect.Width.Value - (x + 0.2); ht = 0.16;
            TextboxType lbl_no = ReportUtil.AddTextbox("lbl_no" + sufx, shipping_rect.ReportItems, x, y, wd, ht);
            lbl_no.Value = "=Fields!" + PQuotation.QUOTATION_NO + ".Value";
            lbl_no.Style.Font("Calibri", 10, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_no.Style.TextAlign = TextAlignRptEnum.Left;
            //lbl_no.Style.BackgroundColor.Color = Color.Salmon;

            x = x + 0; y = y + 0.25; wd = shipping_rect.Width.Value - (x + 0.2); ht = 0.20;
            TextboxType lbl_date = ReportUtil.AddTextbox("lbl_date" + sufx, shipping_rect.ReportItems, x, y, wd, ht);
            lbl_date.Value = "=Fields!" + PQuotation.QUOTATION_DATE + ".Value";
            lbl_date.Style.Font("Calibri", 10, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_date.Style.TextAlign = TextAlignRptEnum.Left;
            lbl_date.Style.Format = "dd-MM-yyyy";
           ...
           //total_sub_rec.Style.BackgroundColor.Color = Color.OrangeRed;
            ...
            //total_sub.Value = "=Fields!" + PQuotation.TOTAL_SUB + ".Value";
            ...
            txt_notes.Style.Font("Calibri", 6, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            ...
            x = 0; y = 0.06; wd = 2.9; ht = 0.01;
            RectangleType bx_7 = ReportUtil.AddRectangle("bx_7" + sufx, rect_totallbl.ReportItems, x, y, wd, ht);
            bx_1.Style.BorderStyle.Default = BorderStyleEnum.Solid;
            //bx_1.Style.BackgroundColor.Color = Color.Tan;

            x = 0; y = 0.03; wd = 1.8; ht = 0.18;
            TextboxType lbl_grandtotal = ReportUtil.AddTextbox("lbl_grandtotal" + sufx, bx_7.ReportItems, x, y, wd, ht);
            lbl_grandtotal.Value = "  GRAND TOTAL";
            lbl_grandtotal.Style.Font("Tahoma", 8, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_grandtotal.Style.TextAlign = TextAlignRptEnum.Left;
            //lbl_grandtotal.Style.BackgroundColor.Color = Color.DeepSkyBlue;

            x = 1.85; y = lbl_grandtotal.Top.Value; wd = 0.96; ht = 0.20;
            TextboxType txt_grandtotal = ReportUtil.AddTextbox("txt_grandtotal" + sufx, bx_7.ReportItems, x, y, wd, ht);
            txt_grandtotal.Value = "=Fields!" + PQuotation.GRANDTOTAL + ".Value";
            txt_grandtotal.Style.Font("Tahoma", 10, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            txt_grandtotal.Style.TextAlign = TextAlignRptEnum.Right;
            //txt_grandtotal.Style.BackgroundColor.Color = Color.Green;


            x = 0; y = 0.07; wd = 2.9; ht = 0.01;
            RectangleType bx_8 = ReportUtil.AddRectangle("bx_8" + sufx, rect_totallbl.ReportItems, x, y, wd, ht);
            bx_1.Style.BorderStyle.Default = BorderStyleEnum.None;
            //bx_1.Style.BackgroundColor.Color = Color.Tan;

            x = 0.01; y = 0.03; wd = 2.85; ht = 0.20;
            TextboxType lbl_terms = ReportUtil.AddTextbox("lbl_terms" + sufx, bx_8.ReportItems, x, y, wd, ht);
            lbl_terms.Value = "=Fields!" + PQuotation.TERMS + ".Value";
            lbl_terms.CanGrow = true;
            lbl_terms.Style.Font("Calibri", 7, FontWeightEnum.Bolder, FontStyleEnum.Normal);
            lbl_terms.Style.TextAlign = TextAlignRptEnum.Left;
            //lbl_terms.Style.BackgroundColor.Color = Color.Green;
            ...
            //receiver_rect.Style.BackgroundColor.Color = Color.Red;
