...
namespace CXBILL_EXTEN.Invoice.Class
{
    public static class CInvoice_exten
    {
        ...
        private static Const.Invoice EntityData(string q)
        {
        ...
        public static List<Const.Invoice> Unrefer()
        {
        ...
        public static List<Const.Invoice> Refer()
        {
            string q = " SELECT " + INVOICE.INVOICE_TBL + ".* \r\n";
            q += ", " + ORDER.ORDER_TBL + "." + ORDER.ORDER_NO + " \r\n";
            q += ", " + PARTY.PARTY_TBL + "." + PARTY.PARTY_NAME + " \r\n";
        ...
        public static List<Const.Invoice> Showall()
        {
            string q = " SELECT " + INVOICE.INVOICE_TBL + ".* \r\n";
            q += ", " + ORDER.ORDER_TBL + "." + ORDER.ORDER_NO + " \r\n";
            q += ", " + PARTY.PARTY_TBL + "." + PARTY.PARTY_NAME + " \r\n";
        ...
        public static List<Const.Invoice> Notactive()
        {
            string q = " SELECT " + INVOICE.INVOICE_TBL + ".* \r\n";
            q += ", " + ORDER.ORDER_TBL + "." + ORDER.ORDER_NO + " \r\n";
            q += ", " + PARTY.PARTY_TBL + "." + PARTY.PARTY_NAME + " \r\n";
        ...
        public static Const.Invoice PKId(string id)
        {
            string q = " SELECT " + INVOICE.INVOICE_TBL + ".* \r\n";
            q += ", " + ORDER.ORDER_TBL + "." + ORDER.ORDER_NO + " \r\n";
            q += ", " + PARTY.PARTY_TBL + "." + PARTY.PARTY_NAME + " \r\n";
        ...
        public static List<Const.Invoice> Searchby(string no, string date, string dateTo, string party)
        {
            string q = " SELECT " + INVOICE.INVOICE_TBL + ".* \r\n";
            q += ", " + ORDER.ORDER_TBL + "." + ORDER.ORDER_NO + " \r\n";
            q += ", " + PARTY.PARTY_TBL + "." + PARTY.PARTY_NAME + " \r\n";
        ...
        {
            List<Const.Invoice> list = Searchby(No, "", "", "");
