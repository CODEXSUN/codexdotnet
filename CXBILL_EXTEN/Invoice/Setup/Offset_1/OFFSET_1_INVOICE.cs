...
namespace CXBILL_EXTEN
{
    ...
    public class Offset_1_invoice
    {
        public string Offset_1_invoice_id { get; set; }
        public string Uniqueno { get; set; }
        public string Company_id { get; set; }
        public string Acy_id { get; set; }
        public int Offset_1_invoice_no { get; set; }
        public string Offset_1_invoice_date { get; set; }
    ...
    public class OFFSET_1_INVOICE
    {
        ...
        public const string OFFSET_1_INVOICE_DATE = "OFFSET_1_INVOICE_DATE";
        ...
        public const string OFFSET_1_INVOICE_TBL = "OFFSET_1_INVOICE_TBL";
    }
