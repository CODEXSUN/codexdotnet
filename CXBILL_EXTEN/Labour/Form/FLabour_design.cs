...
{
    public partial class FLabour : CxControl
    {
        public FLabour()
        {
            InitializeComponent();
        ...
        private XLabel lbl_deliveryto_id;
        private LookupBox txt_deliveredto_id;

        private XLabel lbl_bundel;
        private XTextBox txt_bundel;
        ...
        private void Initialize()
        {
            ...
            lbl_deliveryto_id = new XLabel();
            txt_deliveredto_id = new LookupBox();

            lbl_bundel = new XLabel();
            txt_bundel = new XTextBox();
            ...
            finner_panel.Controls.Add(lbl_deliveryto_id);
            finner_panel.Controls.Add(txt_deliveredto_id);
            finner_panel.Controls.Add(lbl_bundel);
            finner_panel.Controls.Add(txt_bundel);
            ...
            lbl_invoice_no.Location = XLayout.R1_Label(txt_order_id.Location);
            ...
            txt_invoice_no.Size = new Size(XSize.TwoTxtColumn - 20, XSize.TwoTxtHeight);
            txt_invoice_no.Anchor = XAnchor.LT;
            txt_invoice_no.Location = XLayout.R1_Text(txt_order_id.Location);
            ...
            lbl_invoice_date.Name = "lbl_invoice_date";
            lbl_invoice_date.Text = "   Labour date";
            ...
            lbl_invoice_date.Location = XLayout.R1_Label(lbl_invoice_no.Location);
            ...
            txt_invoice_date.Name = "txt_invoice_date";
            txt_invoice_date.CustomFormat = "  dd-MM-yyyy";
            txt_invoice_date.Format = DateTimePickerFormat.Custom;
            txt_invoice_date.Size = XSize.TwoText;
            txt_invoice_date.Anchor = XAnchor.LTR;
            txt_invoice_date.Location = XLayout.R1_Text(txt_invoice_no.Location);
            ...
            lbl_party_id.Location = XLayout.R1_Label(lbl_invoice_date.Location);
            ...
            txt_party_id.Location = XLayout.R1_Text(txt_invoice_date.Location);
            ...
            lbl_deliveryto_id.Font = XFont.Font_10B;
            lbl_deliveryto_id.Name = "lbl_deliveryto_id";
            lbl_deliveryto_id.Text = "   Deliver to";
            lbl_deliveryto_id.Anchor = XAnchor.LT;
            lbl_deliveryto_id.TextAlign = ContentAlignment.MiddleLeft;
            lbl_deliveryto_id.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_deliveryto_id.Size = XSize.TwoLabel;
            lbl_deliveryto_id.Location = XLayout.R2_2Label_2(lbl_transport_id.Location);

            txt_deliveredto_id.Font = XFont.TxtFont;
            txt_deliveredto_id.ForeColor = XFontColor.TxtFontColor;
            txt_deliveredto_id.BackColor = XTheme.TxtBackcolor;
            txt_deliveredto_id.Name = "txt_deliveryto_id";
            txt_deliveredto_id.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_deliveredto_id.TextAlign = HorizontalAlignment.Left;
            txt_deliveredto_id.Size = txt_taxtype_id.Size;
            txt_deliveredto_id.Anchor = XAnchor.LT;
            txt_deliveredto_id.Location = XLayout.R2_2Text_2(txt_transport_id.Location);
            txt_deliveredto_id.TabIndex = XTab.Index(txt_transport_id.TabIndex);
            txt_deliveredto_id.Enter += new EventHandler(Txt_deliverto_id_Enter);

            lbl_bundel.Font = XFont.Font_10B;
            lbl_bundel.Name = "lbl_bundel";
            lbl_bundel.Text = "   No Of bundels";
            lbl_bundel.Anchor = XAnchor.LT;
            lbl_bundel.TextAlign = ContentAlignment.MiddleLeft;
            lbl_bundel.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_bundel.Size = XSize.TwoLabel;
            lbl_bundel.Location = XLayout.R2_2Label_2(lbl_deliveryto_id.Location);

            txt_bundel.Font = XFont.TxtFont;
            txt_bundel.ForeColor = XFontColor.TxtFontColor;
            txt_bundel.BackColor = XTheme.TxtBackcolor;
            txt_bundel.Name = "txt_bundel";
            txt_bundel.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_bundel.TextAlign = HorizontalAlignment.Left;
            txt_bundel.Size = txt_taxtype_id.Size;
            txt_bundel.Anchor = XAnchor.LT;
            txt_bundel.Location = XLayout.R2_2Text_2(txt_deliveredto_id.Location);
            txt_bundel.TabIndex = XTab.Index(txt_deliveredto_id.TabIndex);
            txt_bundel.Enter += new EventHandler(Txt_bundel_Enter);

            editgrid.Location = new Point(XLayout.H_left, txt_bundel.Bottom + 10);
            editgrid.Name = "editgrid";
            editgrid.Size = new Size(finner_panel.Width - 50, 200);
            editgrid.TabIndex = XTab.Index(txt_bundel.TabIndex);
        ...
        private void InitGrid()
        {
            ...
            DataGridViewTextBoxColumn col_Labouritems_Id = new DataGridViewTextBoxColumn();
            col_Labouritems_Id.Name = LABOURITEMS.LABOURITEMS_ID;
            col_Labouritems_Id.HeaderText = "LABOURITEMS_ID ";
            col_Labouritems_Id.Visible = false;
            col_Labouritems_Id.Width = 100;
            col_Labouritems_Id.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Labouritems_Id.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            editgrid.Columns.Add(col_Labouritems_Id);

            DataGridViewTextBoxColumn col_Labour_Id = new DataGridViewTextBoxColumn();
            col_Labour_Id.Name = LABOURITEMS.LABOUR_ID;
            col_Labour_Id.HeaderText = "LABOUR_ID ";
            col_Labour_Id.Visible = false;
            col_Labour_Id.Width = 100;
            col_Labour_Id.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Labour_Id.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            editgrid.Columns.Add(col_Labour_Id);
            ...
            col_Po_id.Name = LABOURITEMS.PO_NO;
            col_Po_id.HeaderText = "PO";

            if (Customise.InvoiceWithPo == true)
            {
                col_Po_id.Visible = true;
            }
            else
            {
            ...
            col_Dc_id.Name = LABOURITEMS.DC_NO;
            col_Dc_id.HeaderText = "DC";

            if (Customise.InvoiceWithDc == true)
            {
                col_Dc_id.Visible = true;
            }
            else
            {
            ...
            col_Product_id.Name = LABOURITEMS.PRODUCT_ID;
            ...
            col_Sizes_id.Name = LABOURITEMS.SIZES_ID;
            col_Sizes_id.HeaderText = "SIZE";

            if (Customise.InvoiceWithSizes == true)
            {
                col_Sizes_id.Visible = true;
            }
            else
            {
            ...
            col_Price.Name = LABOURITEMS.PRICE;
            ...
            col_Sgst_percent.Name = LABOURITEMS.SGST_PERCENT;
            ...
            col_Cgst_percent.Name = LABOURITEMS.CGST_PERCENT;
            ...
            col_Igst_percent.Name = LABOURITEMS.IGST_PERCENT;
            ...
            col_TAXABLEAMOUNT.Name = LABOURITEMS.TAXABLEAMOUNT;
            ...
            col_SGST_AMOUNT.Name = LABOURITEMS.SGST_AMOUNT;
            ...
            col_CGST_AMOUNT.Name = LABOURITEMS.CGST_AMOUNT;
            ...
            col_IGST_AMOUNT.Name = LABOURITEMS.IGST_AMOUNT;
