...
namespace CXBILL_EXTEN.Labour.List
{
    public partial class LLabour 
    {
        ...
        private void BuildForm()
        {
            ...
            finvoice.FLabour_NeedToRefresh += VLabour_NeedToRefresh;
        ...
        {
            txt_no.LookupColNames = new string[] { LABOUR.LABOUR_NO };
        ...
        private string GetSelectedPkValue()
        {
            ...
            if (vSelRow != null)
            {
                selPkValue = vSelRow.Cells[LABOUR.LABOUR_ID].Value.ToString();
            }
            return selPkValue;
        }
        ...
        void VLabour_NeedToRefresh(object sender, EventArgs e)
        {
            List_Option(ListOption.active);
        }
        //public event EventHandler LLabour_NeedToRefresh;
        //public void RaiseEvent_NeedToRefresh()
        //{
        //    LLabour_NeedToRefresh?.Invoke(this, new EventArgs());
        //}
