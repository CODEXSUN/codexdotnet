...
using CXBILL_EXTEN.Labour.Form;
using CXLIB;

namespace CXBILL_EXTEN.Labour.List
{
    public partial class LLabour : CxControl
    {

        private FLabour finvoice = null;
        ...
        private void InitGrid()
        {
            ...
            col_Labour_Id.Name = LABOUR.LABOUR_ID;
            ...
            listgrid.Columns.Add(col_Labour_Id);

            DataGridViewTextBoxColumn col_Labour_no = new DataGridViewTextBoxColumn();
            col_Labour_no.Name = LABOUR.LABOUR_NO;
            col_Labour_no.HeaderText = "NO";
            //col_Labour_no.Visible = false;
            col_Labour_no.Width = 100;
            col_Labour_no.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Labour_no.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Labour_no);

            DataGridViewTextBoxColumn col_Labour_date = new DataGridViewTextBoxColumn();
            col_Labour_date.Name = LABOUR.LABOUR_DATE;
            col_Labour_date.HeaderText = "DATE";
            //col_Labour_date.Visible = false;
            col_Labour_date.Width = 100;
            col_Labour_date.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Labour_date.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Labour_date);

            DataGridViewTextBoxColumn col_Party_id = new DataGridViewTextBoxColumn();
            col_Party_id.Name = LABOUR.PARTY_ID;
            ...
            col_Grandtotal.Name = LABOUR.GRANDTOTAL;
            ...
            col_Gsttotal.Name = LABOUR.GSTTOTAL;
            ...
            col_Total_qty.Name = LABOUR.TOTAL_QTY;
            ...
            col_Total_taxable_amount.Name = LABOUR.TOTAL_TAXABLE_AMOUNT;
            ...
            col_Ledger_id.Name = LABOUR.LEDGER_ID;
            ...
            col_Additional.Name = LABOUR.ADDITIONAL;
            ...
            col_User_Id.Name = LABOUR.USER_ID;
