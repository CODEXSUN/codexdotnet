    ...
    public class D_Labour
    {
        ...
        public static void Build()
        {
            ...
            ReportUtil.AddFields(dataSet.Fields, new string[] {
                 ...
                 PRINT_LABOUR.COPY_NAME
                ,PRINT_LABOUR.SALES_TYPE

                ,PRINT_LABOUR.COMPANY_NAME
                ,PRINT_LABOUR.COMPANY_ADDRESS_1
                ,PRINT_LABOUR.COMPANY_ADDRESS_2
                ,PRINT_LABOUR.COMPANY_PHONE
                ,PRINT_LABOUR.COMPANY_CELL1
                ,PRINT_LABOUR.COMPANY_CELL2
                ,PRINT_LABOUR.COMPANY_EMAIL
                ,PRINT_LABOUR.COMPANY_WEBSITE
                ,PRINT_LABOUR.COMPANY_GSTIN

                ,PRINT_LABOUR.LABOUR_ID
                ,PRINT_LABOUR.LABOUR_NO
                ,PRINT_LABOUR.LABOUR_DATE

                ,PRINT_LABOUR.TRANSPORT
                ,PRINT_LABOUR.DELIVERYTO
                ,PRINT_LABOUR.BUNDEL
                ,PRINT_LABOUR.PARTY_NAME
                ,PRINT_LABOUR.PARTY_STREET_1
                ,PRINT_LABOUR.PARTY_STREET_2
                ,PRINT_LABOUR.PARTY_CITY
                ,PRINT_LABOUR.PARTY_STATE
                ,PRINT_LABOUR.PARTY_STATE_CODE
                ,PRINT_LABOUR.PARTY_COUNTRY
                ,PRINT_LABOUR.PARTY_PINCODE
                ,PRINT_LABOUR.PARTY_GSTIN

                ,PRINT_LABOUR.TOTAL_QTY
                ,PRINT_LABOUR.TAXABLE_VALUE

                ,PRINT_LABOUR.CGST_PERCENT
                ,PRINT_LABOUR.SGST_PERCENT
                ,PRINT_LABOUR.IGST_PERCENT

                ,PRINT_LABOUR.TOTAL_CGST
                ,PRINT_LABOUR.TOTAL_SGST
                ,PRINT_LABOUR.TOTAL_IGST
                ,PRINT_LABOUR.TOTAL_CESS
                ,PRINT_LABOUR.TOTAL_SUB
                ,PRINT_LABOUR.LEDGER
                ,PRINT_LABOUR.ADDITIONAL
                ,PRINT_LABOUR.ROUNDS
                ,PRINT_LABOUR.GSTTOTAL

                ,PRINT_LABOUR.GRANDTOTAL
                ,PRINT_LABOUR.AMOUNT_IN_WORDS
                ,PRINT_LABOUR.NOTES
                ,PRINT_LABOUR.ENTRY_BY

                ,PRINT_LABOUR.FORSIGN

                ,PRINT_LABOUR.ACCOUNT_NO
                ,PRINT_LABOUR.IFSC_CODE
                ,PRINT_LABOUR.BANK_NAME
                ,PRINT_LABOUR.BANK_BRANCH

                ,PRINT_LABOUR.TERMS_1
                ,PRINT_LABOUR.TERMS_2
                ,PRINT_LABOUR.TERMS_3
                ,PRINT_LABOUR.TERMS_4
            ...
            Reportlist.Grouping = new GroupingType("group_" + PRINT_LABOUR.LABOUR_ID + "");
            Reportlist.Grouping.GroupExpressions.Add("=Fields!" + PRINT_LABOUR.LABOUR_ID + ".Value");
            Reportlist.Grouping.GroupExpressions.Add("=Fields!" + PRINT_LABOUR.COPY_NAME + ".Value");
            ...
            rptbuild.SaveAs(PRINT_FOLDER + @"\P_Labour.rdlc");
        ...
        private static void BuildDetail(RectangleType rectWarper)
        {
            ...
            if (PrintConfig.Title1 == true)
            {
                ...
                txt_title.Value = "=Fields!" + PRINT_LABOUR.SALES_TYPE + ".Value";
                ...
                txt_copy.Value = "=Fields!" + PRINT_LABOUR.COPY_NAME + ".Value";
            ...
            if (PrintConfig.PrintHeader == true)
            {
                ...
                txt_compname.Value = "=Fields!" + PRINT_LABOUR.COMPANY_NAME + ".Value";
                ...
                txt_address1.Value = "=Fields!" + PRINT_LABOUR.COMPANY_ADDRESS_1 + ".Value";
                ...
                txt_address2.Value = "=Fields!" + PRINT_LABOUR.COMPANY_ADDRESS_2 + ".Value";
                ...
                txt_company_tin.Value = "=Fields!" + PRINT_LABOUR.COMPANY_GSTIN + ".Value";
            ...
            txt_partyname.Value = "=Fields!" + PRINT_LABOUR.PARTY_NAME + ".Value";
            ...
            txt_street1.Value = "=Fields!" + PRINT_LABOUR.PARTY_STREET_1 + ".Value";
            ...
            txt_street_2.Value = "=Fields!" + PRINT_LABOUR.PARTY_STREET_2 + ".Value";
            ...
            txt_city.Value = "=Fields!" + PRINT_LABOUR.PARTY_CITY + ".Value";
            ...
            txt_State.Value = "=Fields!" + PRINT_LABOUR.PARTY_STATE + ".Value";
            ...
            txt_tin.Value = "=Fields!" + PRINT_LABOUR.PARTY_GSTIN + ".Value";
            ...
            txt_no.Value = "=Fields!" + PRINT_LABOUR.LABOUR_NO + ".Value";
            ...
            txt_date.Value = "=Fields!" + PRINT_LABOUR.LABOUR_DATE + ".Value";
            ...
            txt_transport.Value = "=Fields!" + PRINT_LABOUR.TRANSPORT + ".Value";
            ...
            txt_deliveryto.Value = "=Fields!" + PRINT_LABOUR.DELIVERYTO + ".Value";
            ...
            txt_bundel.Value = "=Fields!" + PRINT_LABOUR.BUNDEL + ".Value";
            ...
            ReportUtil.AddSubreport("subreport_Print_invoiceItems", "P_LabourItem", items_rect.ReportItems, x, y, wd, ht);
            ...
            if (PrintConfig.TaxType == Core.SGST)
            {
                ...
                txt_qtys.Value = "=Fields!" + PRINT_LABOUR.TOTAL_QTY + ".Value";
                ...
                txt_total.Value = "=Fields!" + PRINT_LABOUR.TAXABLE_VALUE + ".Value";
                ...
                total_sgst.Value = "=Fields!" + PRINT_LABOUR.TOTAL_SGST + ".Value";
                ...
                total_cgst.Value = "=Fields!" + PRINT_LABOUR.TOTAL_CGST + ".Value";
                ...
                total_sub.Value = "=Fields!" + PRINT_LABOUR.TOTAL_SUB + ".Value";
            ...
            else if (PrintConfig.TaxType == Core.IGST)
            {
                ...
                total_igst.Value = "=Fields!" + PRINT_LABOUR.TOTAL_SGST + ".Value";
            ...
            txt_terms_1.Value = "=Fields!" + PRINT_LABOUR.TERMS_1 + ".Value";
            ...
            txt_terms_2.Value = "=Fields!" + PRINT_LABOUR.TERMS_2 + ".Value";
            ...
            txt_terms_3.Value = "=Fields!" + PRINT_LABOUR.TERMS_3 + ".Value";
            ...
            txt_terms_4.Value = "=Fields!" + PRINT_LABOUR.TERMS_4 + ".Value";
            ...
            txt_account_no.Value = "=Fields!" + PRINT_LABOUR.ACCOUNT_NO + ".Value";
            ...
            txt_ifsc_code.Value = "=Fields!" + PRINT_LABOUR.IFSC_CODE + ".Value";
            ...
            txt_bank_name.Value = "=Fields!" + PRINT_LABOUR.BANK_NAME + ".Value";
            ...
            txt_bank_branch.Value = "=Fields!" + PRINT_LABOUR.BANK_BRANCH + ".Value";
            ...
            //txt_notes.Value = "=Fields!" + PRINT_LABOUR.NOTES + ".Value";
            ...
            txt_taxable_amt.Value = "=Fields!" + PRINT_LABOUR.TAXABLE_VALUE + ".Value";
            ...
            lbl_Sgst.Value = "=Fields!" + PRINT_LABOUR.SGST_PERCENT + ".Value";
            ...
            txt_Sgst.Value = "=Fields!" + PRINT_LABOUR.TOTAL_SGST + ".Value";
            ...
            lbl_cgst.Value = "=Fields!" + PRINT_LABOUR.CGST_PERCENT + ".Value";
            ...
            txt_cgst.Value = "=Fields!" + PRINT_LABOUR.TOTAL_CGST + ".Value";
            ...
            txt_GSTTotal.Value = "=Fields!" + PRINT_LABOUR.GSTTOTAL + ".Value";
            ...
            txt_ledger.Value = "=Fields!" + PRINT_LABOUR.LEDGER + ".Value";
            ...
            txt_additional.Value = "=Fields!" + PRINT_LABOUR.ADDITIONAL + ".Value";
            ...
            txt_round.Value = "=Fields!" + PRINT_LABOUR.ROUNDS + ".Value";
            ...
            txt_amtnwords.Value = "=Fields!" + PRINT_LABOUR.AMOUNT_IN_WORDS + ".Value";
            ...
            txt_grandtotal.Value = "=Fields!" + PRINT_LABOUR.GRANDTOTAL + ".Value";
            ...
            lbl_forcompany.Value = "=Fields!" + PRINT_LABOUR.COMPANY_NAME + ".Value";
