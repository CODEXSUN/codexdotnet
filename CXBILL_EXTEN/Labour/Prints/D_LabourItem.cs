    ...
    public class D_LabourItem
    {
        ...
        public static void Build()
        {
            ...
            ReportUtil.AddFields(dataSet.Fields, new string[] {
                ...
                PLabouritems.LABOUR_ITEM_ID
                ,PLabouritems.LABOUR_ID
                ,PLabouritems.SL_NO
                ,PLabouritems.PO_NO
                ,PLabouritems.DC_NO
                ,PLabouritems.PRODUCT_ID
                 ,PLabouritems.HSN_CODE_ID
                 ,PLabouritems.SIZES
                ,PLabouritems.QTY
                ,PLabouritems.PRICE
                ,PLabouritems.SUB_TOTAL
                ,PLabouritems.TAXABLEVALUE
                ,PLabouritems.CGST_PERCENT
                ,PLabouritems.CGST_AMOUNT
                ,PLabouritems.SGST_PERCENT
                ,PLabouritems.SGST_AMOUNT
                ,PLabouritems.IGST_PERCENT
                ,PLabouritems.IGST_AMOUNT
                        });
            ...
            ///== END OF REPORT  ===========================================================================///
            rptbuild.SaveAs(PRINT_FOLDER + @"\P_LabourItem.rdlc");
        }
        ...
        private static void BuildDetail(BodyType rectWarper)
        {
            ...
            #region [Lines AREA]
            //
            x = 0; y = 0; wd = 0.23; ht = PrintConfig.SubReportHeight;
            ...
            if (PrintConfig.With_PO_Dc == true)
            {
            ...
            if (PrintConfig.With_sizes == true)
            {
            ...
            if ((Customise.InvoiceWithPo == true) && (Customise.InvoiceWithDc == true))
            {
