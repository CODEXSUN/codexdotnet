...
// Auto Generated
// last update : 25-12-2017 07:23:12 PM
...
{ 
    ...
    { 
        ...
        private XTextBox txt_voucher_no;
        private XLabel lbl_voucher_no;
        private xDatepicker txt_voucher_date;
        private XLabel lbl_voucher_date;
        private LookupBox txt_vouchertype_id;
        private XLabel lbl_vouchertype_id;
        ...
        private XLabel lbl_credit;
        private XTextBox txt_debit;
        private XLabel lbl_debit;
        ...
        { 
            ...
            txt_voucher_no = new XTextBox();
            lbl_voucher_no = new XLabel();
            txt_voucher_date = new xDatepicker();
            lbl_voucher_date = new XLabel();
            txt_vouchertype_id = new LookupBox();
            lbl_vouchertype_id = new XLabel();
            ...
            lbl_credit = new XLabel();
            txt_debit = new XTextBox();
            lbl_debit = new XLabel();
            ...
            finner_panel.Controls.Add(txt_voucher_no);
            finner_panel.Controls.Add(lbl_voucher_no);
            finner_panel.Controls.Add(txt_voucher_date);
            finner_panel.Controls.Add(lbl_voucher_date);
            finner_panel.Controls.Add(txt_vouchertype_id);
            finner_panel.Controls.Add(lbl_vouchertype_id);
            ...
            finner_panel.Controls.Add(txt_credit);
            finner_panel.Controls.Add(lbl_credit);
            finner_panel.Controls.Add(txt_debit);
            finner_panel.Controls.Add(lbl_debit);
            ...
            lbl_voucher_no.Font = XFont.Font_10B;
            lbl_voucher_no.Name = "lbl_voucher_no";
            lbl_voucher_no.Text = "   Voucher no";
            lbl_voucher_no.Anchor = XAnchor.LT;
            lbl_voucher_no.TextAlign = ContentAlignment.MiddleLeft;
            lbl_voucher_no.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_voucher_no.Size =  XSize.OneLabel;
            lbl_voucher_no.Location =XLayout.FirstLabel;
            ...
            txt_voucher_no.Size =  XSize.TwoText;
            txt_voucher_no.Anchor = XAnchor.LT;
            txt_voucher_no.Location =XLayout.FirstText;
            txt_voucher_no.TabIndex = XTab.Txt_TabIndex;
            txt_voucher_no.Enter += new EventHandler(Txt_voucher_no_Enter);


            lbl_voucher_date.Font = XFont.Font_10B;
            lbl_voucher_date.Name = "lbl_voucher_date";
            lbl_voucher_date.Text = "   Voucher date";
            lbl_voucher_date.Anchor = XAnchor.LT;
            lbl_voucher_date.TextAlign = ContentAlignment.MiddleLeft;
            lbl_voucher_date.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_voucher_date.Size =  XSize.TwoLabel;
            lbl_voucher_date.Location =XLayout.R1_2Label_2(lbl_voucher_no.Location);
            ...
            txt_voucher_date.CustomFormat = "dd-MM-yyyy";
            txt_voucher_date.Format = DateTimePickerFormat.Custom;
            txt_voucher_date.Size =  XSize.TwoText;
            txt_voucher_date.Anchor = XAnchor.LTR;
            txt_voucher_date.Location =XLayout.R1_2Text_2(txt_voucher_no.Location);
            txt_voucher_date.TabIndex = XTab.Index(txt_voucher_no.TabIndex);
            txt_voucher_date.Enter += new EventHandler(Txt_voucher_date_Enter);


            lbl_vouchertype_id.Font = XFont.Font_10B;
            lbl_vouchertype_id.Name = "lbl_vouchertype_id";
            lbl_vouchertype_id.Text = "   Voucher type";
            lbl_vouchertype_id.Anchor = XAnchor.LT;
            lbl_vouchertype_id.TextAlign = ContentAlignment.MiddleLeft;
            lbl_vouchertype_id.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_vouchertype_id.Size =  XSize.OneLabel;
            lbl_vouchertype_id.Location =XLayout.R2_2Label_1(lbl_voucher_date.Location);

            txt_vouchertype_id.Font = XFont.TxtFont;
            txt_vouchertype_id.ForeColor = XFontColor.TxtFontColor;
            txt_vouchertype_id.BackColor = XTheme.TxtBackcolor;
            txt_vouchertype_id.Name = "txt_vouchertype_id";
            txt_vouchertype_id.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_vouchertype_id.Size =  XSize.TwoText;
            txt_vouchertype_id.Anchor = XAnchor.LT;
            txt_vouchertype_id.Location =XLayout.R2_2Text_1(txt_voucher_date.Location);
            txt_vouchertype_id.TabIndex = XTab.Index(txt_voucher_date.TabIndex);
            txt_vouchertype_id.Enter += new EventHandler(Txt_vouchertype_id_Enter);
            txt_vouchertype_id.TextChanged += Txt_vouchertype_id_TextChanged;
            ...
            lbl_order_id.Location =XLayout.R1_Label(lbl_vouchertype_id.Location);
            ...
            txt_order_id.Location =XLayout.R1_Text(txt_vouchertype_id.Location);
            txt_order_id.TabIndex = XTab.Index(txt_vouchertype_id.TabIndex);
            ...
            lbl_ledger_id.Location =XLayout.R1_Label(lbl_order_id.Location);
            ...
            txt_ledger_id.Location =XLayout.R1_Text(txt_order_id.Location);
            txt_ledger_id.TabIndex = XTab.Index(txt_order_id.TabIndex);
            ...
            lbl_party_id.Location =XLayout.R1_Label(lbl_ledger_id.Location);
            ...
            txt_party_id.Location =XLayout.R1_Text(txt_ledger_id.Location);
            txt_party_id.TabIndex = XTab.Index(txt_ledger_id.TabIndex);
            ...
            lbl_debit.Font = XFont.Font_10B;
            lbl_debit.Name = "lbl_debit";
            lbl_debit.Text = "   Debit";
            lbl_debit.Anchor = XAnchor.LT;
            lbl_debit.TextAlign = ContentAlignment.MiddleLeft;
            lbl_debit.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_debit.Size = new Size(140, 48);
            lbl_debit.Location =XLayout.R2_2Label_1(lbl_purpose.Location);

            txt_debit.Font = XFont.Font_20B;
            ...
            txt_debit.Size =  XSize.TwoText;
            txt_debit.Anchor = XAnchor.LT;
            txt_debit.Location =XLayout.R2_2Text_1(txt_purpose.Location);
            txt_debit.TabIndex = XTab.Index(txt_credit.TabIndex);
            txt_debit.Enter += new EventHandler(Txt_debit_Enter);
            txt_debit.TextAlign = HorizontalAlignment.Right;

            lbl_credit.Font = XFont.Font_10B;
            lbl_credit.Name = "lbl_credit";
            lbl_credit.Text = "   Credit";
            lbl_credit.Anchor = XAnchor.LT;
            lbl_credit.TextAlign = ContentAlignment.MiddleLeft;
            lbl_credit.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_credit.Size = new Size(140, 48);
            lbl_credit.Location = XLayout.R1_2Label_2(lbl_debit.Location);

            txt_credit.Font = XFont.Font_20B;
            ...
            txt_credit.Size = XSize.TwoText;
            txt_credit.Anchor = XAnchor.LT;
            txt_credit.Location = XLayout.R1_2Text_2(txt_debit.Location);
            txt_credit.TabIndex = XTab.Index(txt_purpose.TabIndex);
            txt_credit.Enter += new EventHandler(Txt_credit_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_debit.TabIndex);
