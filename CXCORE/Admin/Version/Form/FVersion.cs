...
{ 
    ...
    { 
        ...
        private void Txt_version_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        private void Txt_created_on_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_created_on.BackColor = Theme.lbl_EnterBackColor;
            lbl_created_on.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_created_on.ForeColor = Theme.lbl_EnterForeColor;
        }
        private void Txt_changes_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_changes.BackColor = Theme.lbl_EnterBackColor;
            lbl_changes.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_changes.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
            ...
            lbl_created_on.BackColor = Theme.lbl_BackColor;
            lbl_created_on.BorderColor = Theme.lbl_BorderColor;
            lbl_created_on.ForeColor = Theme.lbl_ForeColor;
            
            lbl_changes.BackColor = Theme.lbl_BackColor;
            lbl_changes.BorderColor = Theme.lbl_BorderColor;
            lbl_changes.ForeColor = Theme.lbl_ForeColor;
        ...
        public event EventHandler FVersion_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FVersion_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        { 
            return txt_version_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_version_name.Text = pName ; 
        } 
