...
{ 
    ...
    { 
        ...
        private void Txt_acy_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        {
            Change_infocus();
            lbl_from_date.BackColor = Theme.lbl_EnterBackColor;
            lbl_from_date.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_from_date.ForeColor = Theme.lbl_EnterForeColor;
        }
        private void Txt_to_date_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_to_date.BackColor = Theme.lbl_EnterBackColor;
            lbl_to_date.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_to_date.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
            ...
            lbl_from_date.BackColor = Theme.lbl_BackColor;
            lbl_from_date.BorderColor = Theme.lbl_BorderColor;
            lbl_from_date.ForeColor = Theme.lbl_ForeColor;
            
            lbl_to_date.BackColor = Theme.lbl_BackColor;
            lbl_to_date.BorderColor = Theme.lbl_BorderColor;
            lbl_to_date.ForeColor = Theme.lbl_ForeColor;
        ...
        public event EventHandler FAcy_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FAcy_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        { 
            return txt_acy_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_acy_name.Text = pName ; 
        } 
