...
namespace CXCORE 
{ 
    public partial class LAcy
    { 

          private FAcy facy = null;
        ...
        private LookupBox txt_acy_name; 
        ...
        { 
            ...
            linner_panel.Controls.Add(txt_acy_name); 
            linner_panel.Controls.Add(lbl_acy_name); 
            ...
            btn_search.Location = new Point(txt_acy_name.Right + 10 ,txt_acy_name.Top);
