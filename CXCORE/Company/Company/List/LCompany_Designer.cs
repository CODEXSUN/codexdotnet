...
namespace CXCORE 
{ 
    public partial class LCompany: CxControl
    { 

          private FCompany fcompany = null;
        ...
        private LookupBox txt_company_name; 
        ...
        { 
            ...
            txt_company_name = new LookupBox(); 
            ...
            linner_panel.Controls.Add(txt_company_name); 
            linner_panel.Controls.Add(lbl_company_name); 
            ...
            btn_search.Location = new Point(txt_company_name.Right + 10 ,txt_company_name.Top);
