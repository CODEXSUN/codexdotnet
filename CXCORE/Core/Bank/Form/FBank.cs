...
namespace CXCORE
{
    public partial class FBank : UserControl
    {
        ...
        private void Txt_bank_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        private void Txt_account_number_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_account_number.BackColor = Theme.lbl_EnterBackColor;
            lbl_account_number.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_account_number.ForeColor = Theme.lbl_EnterForeColor;
        }
        private void Txt_ifsc_code_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_ifsc_code.BackColor = Theme.lbl_EnterBackColor;
            lbl_ifsc_code.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_ifsc_code.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
            ...
            lbl_account_number.BackColor = Theme.lbl_BackColor;
            lbl_account_number.BorderColor = Theme.lbl_BorderColor;
            lbl_account_number.ForeColor = Theme.lbl_ForeColor;

            lbl_ifsc_code.BackColor = Theme.lbl_BackColor;
            lbl_ifsc_code.BorderColor = Theme.lbl_BorderColor;
            lbl_ifsc_code.ForeColor = Theme.lbl_ForeColor;
        ...
        public event EventHandler FBank_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FBank_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_bank_name.Text;
        }
        public void setname(string pName)
        {
            txt_bank_name.Text = pName;
        }
