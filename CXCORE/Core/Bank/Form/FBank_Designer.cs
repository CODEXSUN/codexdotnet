...
namespace CXCORE
{
    public partial class FBank 
    {
        ...
        private XTextBox txt_bank_name;
        private XLabel lbl_bank_name;
        private XTextBox txt_account_number;
        private XLabel lbl_account_number;
        private XTextBox txt_ifsc_code;
        private XLabel lbl_ifsc_code;
        ...
        private void Initialize()
        {
            ...
            txt_bank_name = new XTextBox();
            lbl_bank_name = new XLabel();
            txt_account_number = new XTextBox();
            lbl_account_number = new XLabel();
            txt_ifsc_code = new XTextBox();
            lbl_ifsc_code = new XLabel();
            ...
            finner_panel.Controls.Add(txt_bank_name);
            finner_panel.Controls.Add(lbl_bank_name);
            finner_panel.Controls.Add(txt_account_number);
            finner_panel.Controls.Add(lbl_account_number);
            finner_panel.Controls.Add(txt_ifsc_code);
            finner_panel.Controls.Add(lbl_ifsc_code);
            ...
            lbl_header.Text = "Bank";

            #endregion[Header]

            #region[Properties of control]

            lbl_bank_name.Font = XFont.Font_10B;
            lbl_bank_name.Name = "lbl_bank_name";
            lbl_bank_name.Text = "   Bank name";
            lbl_bank_name.Anchor = XAnchor.LT;
            lbl_bank_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_bank_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_bank_name.Size = XSize.OneLabel;
            lbl_bank_name.Location = XLayout.FirstLabel;

            txt_bank_name.Font = XFont.TxtFont;
            txt_bank_name.ForeColor = XFontColor.TxtFontColor;
            txt_bank_name.BackColor = XTheme.TxtBackcolor;
            txt_bank_name.Name = "txt_bank_name";
            txt_bank_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_bank_name.Size = XSize.OneText;
            txt_bank_name.Anchor = XAnchor.LTR;
            txt_bank_name.Location = XLayout.FirstText;
            txt_bank_name.TabIndex = XTab.Txt_TabIndex;
            txt_bank_name.Enter += new EventHandler(Txt_bank_name_Enter);


            lbl_account_number.Font = XFont.Font_10B;
            lbl_account_number.Name = "lbl_account_number";
            lbl_account_number.Text = "   Account number";
            lbl_account_number.Anchor = XAnchor.LT;
            lbl_account_number.TextAlign = ContentAlignment.MiddleLeft;
            lbl_account_number.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_account_number.Size = XSize.OneLabel;
            lbl_account_number.Location = XLayout.R1_Label(lbl_bank_name.Location);

            txt_account_number.Font = XFont.TxtFont;
            txt_account_number.ForeColor = XFontColor.TxtFontColor;
            txt_account_number.BackColor = XTheme.TxtBackcolor;
            txt_account_number.Name = "txt_account_number";
            txt_account_number.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_account_number.Size = XSize.OneText;
            txt_account_number.Anchor = XAnchor.LTR;
            txt_account_number.Location = XLayout.R1_Text(txt_bank_name.Location);
            txt_account_number.TabIndex = XTab.Index(txt_bank_name.TabIndex);
            txt_account_number.Enter += new EventHandler(Txt_account_number_Enter);


            lbl_ifsc_code.Font = XFont.Font_10B;
            lbl_ifsc_code.Name = "lbl_ifsc_code";
            lbl_ifsc_code.Text = "   Ifsc code";
            lbl_ifsc_code.Anchor = XAnchor.LT;
            lbl_ifsc_code.TextAlign = ContentAlignment.MiddleLeft;
            lbl_ifsc_code.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_ifsc_code.Size = XSize.OneLabel;
            lbl_ifsc_code.Location = XLayout.R1_Label(lbl_account_number.Location);

            txt_ifsc_code.Font = XFont.TxtFont;
            txt_ifsc_code.ForeColor = XFontColor.TxtFontColor;
            txt_ifsc_code.BackColor = XTheme.TxtBackcolor;
            txt_ifsc_code.Name = "txt_ifsc_code";
            txt_ifsc_code.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_ifsc_code.Size = XSize.OneText;
            txt_ifsc_code.Anchor = XAnchor.LTR;
            txt_ifsc_code.Location = XLayout.R1_Text(txt_account_number.Location);
            txt_ifsc_code.TabIndex = XTab.Index(txt_account_number.TabIndex);
            txt_ifsc_code.Enter += new EventHandler(Txt_ifsc_code_Enter);
            ...
            lbl_opening_balance.Location = XLayout.R1_Label(lbl_ifsc_code.Location);
            ...
            txt_opening_balance.Size = XSize.OneText;
            txt_opening_balance.Anchor = XAnchor.LTR;
            txt_opening_balance.Location = XLayout.R1_Text(txt_ifsc_code.Location);
            txt_opening_balance.TabIndex = XTab.Index(txt_ifsc_code.TabIndex);
            ...
            btn_save.TabIndex = XTab.Index(txt_opening_balance.TabIndex);
