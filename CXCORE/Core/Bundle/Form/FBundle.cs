...
namespace CXCORE
{
    public partial class FBundle : UserControl
    {
        ...
        private void Txt_bundle_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FBundle_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FBundle_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_bundle_name.Text;
        }
        public void setname(string pName)
        {
            txt_bundle_name.Text = pName;
        }
