...
namespace CXCORE
{
    public partial class FBundle : UserControl
    {
        public FBundle()
        {
            InitializeComponent();
        ...
        private XTextBox txt_bundle_name;
        private XLabel lbl_bundle_name;
        ...
        private void Initialize()
        {
            ...
            txt_bundle_name = new XTextBox();
            lbl_bundle_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_bundle_name);
            finner_panel.Controls.Add(lbl_bundle_name);
            ...
            lbl_header.Text = "Bundle";

            #endregion[Header]

            #region[Properties of control]

            lbl_bundle_name.Font = XFont.Font_10B;
            lbl_bundle_name.Name = "lbl_bundle_name";
            lbl_bundle_name.Text = "   Bundle name";
            lbl_bundle_name.Anchor = XAnchor.LT;
            lbl_bundle_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_bundle_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_bundle_name.Size = XSize.OneLabel;
            lbl_bundle_name.Location = XLayout.FirstLabel;

            txt_bundle_name.Font = XFont.TxtFont;
            txt_bundle_name.ForeColor = XFontColor.TxtFontColor;
            txt_bundle_name.BackColor = XTheme.TxtBackcolor;
            txt_bundle_name.Name = "txt_bundle_name";
            txt_bundle_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_bundle_name.Size = XSize.OneText;
            txt_bundle_name.Anchor = XAnchor.LTR;
            txt_bundle_name.Location = XLayout.FirstText;
            txt_bundle_name.TabIndex = XTab.Txt_TabIndex;
            txt_bundle_name.Enter += new EventHandler(Txt_bundle_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_bundle_name.TabIndex);
