    ...
    public partial class FBundle : UserControl
    {
        ...
        public void SetAction(BtnEvent pAction, string pPkValue)
        {
            ...
            switch (fAction)
            {
                case BtnEvent.Open:
                    btn_save.Text = "&CLOSE";
                    obj = CBundle_exten.PKId(pPkValue, new DAL());
        ...
        {
            vId = obj.Bundle_id;
            txt_bundle_name.Text = obj.Bundle_name;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_bundle_name.Enabled = !pReadOnly;
                ...
                switch (fAction)
                {
                    ...
                    case BtnEvent.New:
                        try
                        {
                            ...
                            CBundle.Insert(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Edit:
                        try
                        {
                            ...
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CBundle.Update(vData, dalsession);
                            dalsession.Commit();
        ...
        {
            Bundle fobj = new Bundle()
            {
                Bundle_id = vId,
                Bundle_name = txt_bundle_name.Text,
        ...
        {
            if (txt_bundle_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "Bundle name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txt_bundle_name.Focus();
                return false;
            }
