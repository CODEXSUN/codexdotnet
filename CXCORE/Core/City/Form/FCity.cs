...
{ 
    ...
    { 
        ...
        private void Txt_city_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FCity_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FCity_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        { 
            return txt_city_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_city_name.Text = pName ; 
        } 
