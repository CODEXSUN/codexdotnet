...
{ 
    ...
    { 
        ...
        private XTextBox txt_city_name;
        ...
        { 
            ...
            finner_panel.Controls.Add(txt_city_name);
            finner_panel.Controls.Add(lbl_city_name);
            ...
            lbl_city_name.Text = "   City name";
            lbl_city_name.Anchor = XAnchor.LT;
            lbl_city_name.TextAlign = ContentAlignment.MiddleLeft;
            ...
            txt_city_name.Size =  XSize.OneText;
            txt_city_name.Anchor = XAnchor.LTR;
            txt_city_name.Location =XLayout.FirstText;
            txt_city_name.TabIndex = XTab.Txt_TabIndex;
            txt_city_name.Enter += new EventHandler(Txt_city_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_city_name.TabIndex);
