...
namespace CXCORE
{
    public partial class FColours : UserControl
    {
        ...
        private void Txt_colours_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FColours_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FColours_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_colours_name.Text;
        }
        public void setname(string pName)
        {
            txt_colours_name.Text = pName;
        }
        public void SetFocus()
        {
            txt_colours_name.Focus();
        }
        #endregion[Set Focus]
