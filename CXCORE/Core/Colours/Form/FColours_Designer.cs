...
namespace CXCORE
{
    public partial class FColours : UserControl
    {
        public FColours()
        {
            InitializeComponent();
        ...
        private XTextBox txt_colours_name;
        private XLabel lbl_colours_name;
        ...
        private void Initialize()
        {
            ...
            finner_panel.Controls.Add(txt_colours_name);
            finner_panel.Controls.Add(lbl_colours_name);
            ...
            lbl_colours_name.Text = "   Colours name";
            lbl_colours_name.Anchor = XAnchor.LT;
            lbl_colours_name.TextAlign = ContentAlignment.MiddleLeft;
            ...
            txt_colours_name.Size = XSize.OneText;
            txt_colours_name.Anchor = XAnchor.LTR;
            txt_colours_name.Location = XLayout.FirstText;
            txt_colours_name.TabIndex = XTab.Txt_TabIndex;
            txt_colours_name.Enter += new EventHandler(Txt_colours_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_colours_name.TabIndex);
