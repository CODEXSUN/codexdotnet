    ...
    public partial class FColours : UserControl
    {
        ...
        public void SetAction(BtnEvent pAction, string pPkValue)
        {
            ...
            switch (fAction)
            {
                case BtnEvent.Open:
                    btn_save.Text = "&CLOSE";
                    obj = CColours_exten.PKId(pPkValue, new DAL());
        ...
        {
            vId = obj.Colours_id;
            txt_colours_name.Text = obj.Colours_name;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_colours_name.Enabled = !pReadOnly;
                ...
                switch (fAction)
                {
                    ...
                    case BtnEvent.New:
                        try
                        {
                            ...
                            CColours.Insert(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Edit:
                        try
                        {
                            ...
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CColours.Update(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Delete:
                        try
                        {
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CColours.Delete(vId, dalsession);
                            dalsession.Commit();
        ...
        private Colours CollectData()
        {
            Colours fobj = new Colours()
            {
                Colours_id = vId,
                Colours_name = txt_colours_name.Text,
        ...
        {
            if (txt_colours_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "Colours name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
