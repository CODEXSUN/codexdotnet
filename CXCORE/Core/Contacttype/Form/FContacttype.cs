...
{ 
    ...
    { 
        ...
        private void Txt_contacttype_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FContacttype_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FContacttype_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        { 
            return txt_contacttype_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_contacttype_name.Text = pName ; 
        } 
