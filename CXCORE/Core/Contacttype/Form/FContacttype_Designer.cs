...
namespace CXCORE
{ 
    public partial class FContacttype : UserControl 
    { 
        public FContacttype() 
        {
            InitializeComponent();
        ...
        private XTextBox txt_contacttype_name;
        private XLabel lbl_contacttype_name;
        ...
        { 
            ...
            txt_contacttype_name = new XTextBox();
            lbl_contacttype_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_contacttype_name);
            finner_panel.Controls.Add(lbl_contacttype_name);
            ...
            lbl_header.Text = "Contact type";

            #endregion[Header]

            #region[Properties of control]

            lbl_contacttype_name.Font = XFont.Font_10B;
            lbl_contacttype_name.Name = "lbl_contacttype_name";
            lbl_contacttype_name.Text = "   Contact type";
            lbl_contacttype_name.Anchor = XAnchor.LT;
            lbl_contacttype_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_contacttype_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_contacttype_name.Size =  XSize.OneLabel;
            lbl_contacttype_name.Location =XLayout.FirstLabel;

            txt_contacttype_name.Font = XFont.TxtFont;
            txt_contacttype_name.ForeColor = XFontColor.TxtFontColor;
            txt_contacttype_name.BackColor = XTheme.TxtBackcolor;
            txt_contacttype_name.Name = "txt_contacttype_name";
            txt_contacttype_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_contacttype_name.Size =  XSize.OneText;
            txt_contacttype_name.Anchor = XAnchor.LTR;
            txt_contacttype_name.Location =XLayout.FirstText;
            txt_contacttype_name.TabIndex = XTab.Txt_TabIndex;
            txt_contacttype_name.Enter += new EventHandler(Txt_contacttype_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_contacttype_name.TabIndex);
