...
namespace CXCORE
{
    public partial class FContacttype : UserControl
    {
        ...
        {
            vId = obj.Contacttype_id;
            txt_contacttype_name.Text = obj.Contacttype_name;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_contacttype_name.Enabled = !pReadOnly;
                ...
                switch (fAction)
                {
                    ...
                    case BtnEvent.New:
                        try
                        {
                            ...
                            CContacttype.Insert(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Edit:
                        try
                        {
                            ...
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CContacttype.Update(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Delete:
                        try
                        {
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CContacttype.Delete(vId, dalsession);
                            dalsession.Commit();
        ...
        {
            if (txt_contacttype_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "Contacttype name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txt_contacttype_name.Focus();
                return false;
            }
