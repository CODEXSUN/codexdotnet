...
namespace CXCORE
{
    public partial class FCountry : UserControl
    {
        ...
        private void Txt_country_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FCountry_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FCountry_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_country_name.Text;
        }
        public void setname(string pName)
        {
            txt_country_name.Text = pName;
        }
