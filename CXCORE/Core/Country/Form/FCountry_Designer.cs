...
namespace CXCORE
{
    public partial class FCountry : UserControl
    {
        public FCountry()
        {
            InitializeComponent();
        ...
        private XTextBox txt_country_name;
        private XLabel lbl_country_name;
        ...
        private void Initialize()
        {
            ...
            txt_country_name = new XTextBox();
            lbl_country_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_country_name);
            finner_panel.Controls.Add(lbl_country_name);
            ...
            lbl_header.Text = "Country";

            #endregion[Header]

            #region[Properties of control]

            lbl_country_name.Font = XFont.Font_10B;
            lbl_country_name.Name = "lbl_country_name";
            lbl_country_name.Text = "   Country name";
            lbl_country_name.Anchor = XAnchor.LT;
            lbl_country_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_country_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_country_name.Size = XSize.OneLabel;
            lbl_country_name.Location = XLayout.FirstLabel;

            txt_country_name.Font = XFont.TxtFont;
            txt_country_name.ForeColor = XFontColor.TxtFontColor;
            txt_country_name.BackColor = XTheme.TxtBackcolor;
            txt_country_name.Name = "txt_country_name";
            txt_country_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_country_name.Size = XSize.OneText;
            txt_country_name.Anchor = XAnchor.LTR;
            txt_country_name.Location = XLayout.FirstText;
            txt_country_name.TabIndex = XTab.Txt_TabIndex;
            txt_country_name.Enter += new EventHandler(Txt_country_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_country_name.TabIndex);
