...
namespace CXCORE
{
    public partial class LCountry: CxControl
    {

        private FCountry fcountry = null;
        ...
        private LookupBox txt_country_name;
        ...
        private void Initialize()
        {
            ...
            txt_country_name = new LookupBox();
            ...
            linner_panel.Controls.Add(txt_country_name);
            linner_panel.Controls.Add(lbl_country_name);
            ...
            btn_search.Location = new Point(txt_country_name.Right + 10, txt_country_name.Top);
