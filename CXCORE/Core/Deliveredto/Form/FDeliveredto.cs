...
namespace CXCORE
{
    public partial class FDeliveredto : UserControl
    {
        ...
        private void Txt_deliveredto_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FDeliveredto_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FDeliveredto_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_deliveredto_name.Text;
        }
        public void setname(string pName)
        {
            txt_deliveredto_name.Text = pName;
        }
        public void SetFocus()
        {
            txt_deliveredto_name.Focus();
        }
        #endregion[Set Focus]
