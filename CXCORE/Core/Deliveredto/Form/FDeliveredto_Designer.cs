...
namespace CXCORE
{
    public partial class FDeliveredto : UserControl
    {
        public FDeliveredto()
        {
            InitializeComponent();
        ...
        private XTextBox txt_deliveredto_name;
        private XLabel lbl_deliveredto_name;
        ...
        private void Initialize()
        {
            ...
            txt_deliveredto_name = new XTextBox();
            lbl_deliveredto_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_deliveredto_name);
            finner_panel.Controls.Add(lbl_deliveredto_name);
            ...
            lbl_header.Text = "Delivered to";

            #endregion[Header]

            #region[Properties of control]

            lbl_deliveredto_name.Font = XFont.Font_10B;
            lbl_deliveredto_name.Name = "lbl_deliveredto_name";
            lbl_deliveredto_name.Text = "   Delivered to";
            lbl_deliveredto_name.Anchor = XAnchor.LT;
            lbl_deliveredto_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_deliveredto_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_deliveredto_name.Size = XSize.OneLabel;
            lbl_deliveredto_name.Location = XLayout.FirstLabel;

            txt_deliveredto_name.Font = XFont.TxtFont;
            txt_deliveredto_name.ForeColor = XFontColor.TxtFontColor;
            txt_deliveredto_name.BackColor = XTheme.TxtBackcolor;
            txt_deliveredto_name.Name = "txt_deliveredto_name";
            txt_deliveredto_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_deliveredto_name.Size = XSize.OneText;
            txt_deliveredto_name.Anchor = XAnchor.LTR;
            txt_deliveredto_name.Location = XLayout.FirstText;
            txt_deliveredto_name.TabIndex = XTab.Txt_TabIndex;
            txt_deliveredto_name.Enter += new EventHandler(Txt_deliveredto_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_deliveredto_name.TabIndex);
