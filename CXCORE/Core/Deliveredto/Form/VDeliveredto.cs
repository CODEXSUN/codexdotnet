...
namespace CXCORE
{
    public partial class FDeliveredto : UserControl
    {
        ...
        {
            vId = obj.Deliveredto_id;
            txt_deliveredto_name.Text = obj.Deliveredto_name;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_deliveredto_name.Enabled = !pReadOnly;
                ...
                switch (fAction)
                {
                    ...
                    case BtnEvent.New:
                        try
                        {
                            ...
                            CDeliveredto.Insert(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Edit:
                        try
                        {
                            ...
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CDeliveredto.Update(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Delete:
                        try
                        {
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CDeliveredto.Delete(vId, dalsession);
                            dalsession.Commit();
        ...
        private Deliveredto CollectData()
        {
            ...
            {
                Deliveredto_id = vId,
                Deliveredto_name = txt_deliveredto_name.Text,
