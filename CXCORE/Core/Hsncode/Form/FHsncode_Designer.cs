...
{ 
    ...
    { 
        ...
        private XTextBox txt_hsncode_name;
        private XLabel lbl_hsncode_name;
        private XTextBox txt_description;
        private XLabel lbl_description;
        ...
        { 
            ...
            txt_hsncode_name = new XTextBox();
            lbl_hsncode_name = new XLabel();
            txt_description = new XTextBox();
            lbl_description = new XLabel();
            ...
            finner_panel.Controls.Add(txt_hsncode_name);
            finner_panel.Controls.Add(lbl_hsncode_name);
            finner_panel.Controls.Add(txt_description);
            finner_panel.Controls.Add(lbl_description);
            ...
            lbl_hsncode_name.Anchor = XAnchor.LT;
            lbl_hsncode_name.TextAlign = ContentAlignment.MiddleLeft;
            ...
            txt_hsncode_name.Size =  XSize.OneText;
            txt_hsncode_name.Anchor = XAnchor.LTR;
            txt_hsncode_name.Location =XLayout.FirstText;
            txt_hsncode_name.TabIndex = XTab.Txt_TabIndex;
            txt_hsncode_name.Enter += new EventHandler(Txt_hsncode_name_Enter);


            lbl_description.Font = XFont.Font_10B;
            lbl_description.Name = "lbl_description";
            lbl_description.Text = "   Description";
            lbl_description.Anchor = XAnchor.LT;
            lbl_description.TextAlign = ContentAlignment.MiddleLeft;
            lbl_description.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_description.Size =  XSize.OneLabel;
            lbl_description.Location =XLayout.R1_Label(lbl_hsncode_name.Location);

            txt_description.Font = XFont.TxtFont;
            txt_description.ForeColor = XFontColor.TxtFontColor;
            txt_description.BackColor = XTheme.TxtBackcolor;
            txt_description.Name = "txt_description";
            txt_description.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_description.Size =  XSize.OneText;
            txt_description.Anchor = XAnchor.LTR;
            txt_description.Location =XLayout.R1_Text(txt_hsncode_name.Location);
            txt_description.TabIndex = XTab.Index(txt_hsncode_name.TabIndex);
            txt_description.Enter += new EventHandler(Txt_description_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_description.TabIndex);
