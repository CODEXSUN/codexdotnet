...
namespace CXCORE
{
    public partial class LHsncode : CxControl
    {

        private FHsncode fhsncode = null;
        ...
        private LookupBox txt_hsncode_name;
        private XLabel lbl_hsncode_name;
        ...
        private void Initialize()
        {
            ...
            txt_hsncode_name = new LookupBox();
            lbl_hsncode_name = new XLabel();
            ...
            linner_panel.Controls.Add(txt_hsncode_name);
            linner_panel.Controls.Add(lbl_hsncode_name);
            ...
            txt_hsncode_name.Font = XFont.TxtFont;
            txt_hsncode_name.ForeColor = XFontColor.TxtFontColor;
            txt_hsncode_name.BackColor = XTheme.TxtBackcolor;
            txt_hsncode_name.Name = "txt_hsncode_name";
            txt_hsncode_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_hsncode_name.Size = XSize.TwoText;
            txt_hsncode_name.Anchor = XAnchor.LTR;
            txt_hsncode_name.Location = XLayout.FirstText;
            txt_hsncode_name.TabIndex = 5;

            lbl_hsncode_name.Font = XFont.Font_10B;
            lbl_hsncode_name.Name = "lbl_hsncode_name";
            lbl_hsncode_name.Text = "Hsn code";
            lbl_hsncode_name.TextAlign = ContentAlignment.MiddleCenter;
            lbl_hsncode_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_hsncode_name.Size = XSize.OneLabel;
            lbl_hsncode_name.Location = XLayout.FirstLabel;

            btn_search.Font = XFont.BtnFont;
            btn_search.Location = new Point(txt_hsncode_name.Right + 10, txt_hsncode_name.Top);
