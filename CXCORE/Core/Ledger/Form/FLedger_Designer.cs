...
{ 
    ...
    { 
        ...
        private XTextBox txt_ledger_name;
        private XLabel lbl_ledger_name;
        private LookupBox txt_ledgergroup_id;
        private XLabel lbl_ledgergroup_id;
        ...
        { 
            ...
            txt_ledger_name = new XTextBox();
            lbl_ledger_name = new XLabel();
            txt_ledgergroup_id = new LookupBox();
            lbl_ledgergroup_id = new XLabel();
            ...
            finner_panel.Controls.Add(txt_ledger_name);
            finner_panel.Controls.Add(lbl_ledger_name);
            finner_panel.Controls.Add(txt_ledgergroup_id);
            finner_panel.Controls.Add(lbl_ledgergroup_id);
            ...
            lbl_header.Text = "Ledger";

            #endregion[Header]

            #region[Properties of control]

            lbl_ledger_name.Font = XFont.Font_10B;
            lbl_ledger_name.Name = "lbl_ledger_name";
            lbl_ledger_name.Text = "   Ledger name";
            lbl_ledger_name.Anchor = XAnchor.LT;
            lbl_ledger_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_ledger_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_ledger_name.Size =  XSize.OneLabel;
            lbl_ledger_name.Location =XLayout.FirstLabel;

            txt_ledger_name.Font = XFont.TxtFont;
            txt_ledger_name.ForeColor = XFontColor.TxtFontColor;
            txt_ledger_name.BackColor = XTheme.TxtBackcolor;
            txt_ledger_name.Name = "txt_ledger_name";
            txt_ledger_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_ledger_name.Size =  XSize.OneText;
            txt_ledger_name.Anchor = XAnchor.LTR;
            txt_ledger_name.Location =XLayout.FirstText;
            txt_ledger_name.TabIndex = XTab.Txt_TabIndex;
            txt_ledger_name.Enter += new EventHandler(Txt_ledger_name_Enter);


            lbl_ledgergroup_id.Font = XFont.Font_10B;
            lbl_ledgergroup_id.Name = "lbl_ledgergroup_id";
            lbl_ledgergroup_id.Text = "   Ledger group";
            lbl_ledgergroup_id.Anchor = XAnchor.LT;
            lbl_ledgergroup_id.TextAlign = ContentAlignment.MiddleLeft;
            lbl_ledgergroup_id.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_ledgergroup_id.Size =  XSize.OneLabel;
            lbl_ledgergroup_id.Location =XLayout.R1_Label(lbl_ledger_name.Location);

            txt_ledgergroup_id.Font = XFont.TxtFont;
            txt_ledgergroup_id.ForeColor = XFontColor.TxtFontColor;
            txt_ledgergroup_id.BackColor = XTheme.TxtBackcolor;
            txt_ledgergroup_id.Name = "txt_ledgergroup_id";
            txt_ledgergroup_id.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_ledgergroup_id.Size =  XSize.OneText;
            txt_ledgergroup_id.Anchor = XAnchor.LTR;
            txt_ledgergroup_id.Location =XLayout.R1_Text(txt_ledger_name.Location);
            txt_ledgergroup_id.TabIndex = XTab.Index(txt_ledger_name.TabIndex);
            txt_ledgergroup_id.Enter += new EventHandler(Txt_ledgergroup_id_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_ledgergroup_id.TabIndex);
