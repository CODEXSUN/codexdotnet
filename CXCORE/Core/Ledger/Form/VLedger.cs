    ...
    { 
        ...
        public void SetAction(BtnEvent pAction, string pPkValue)
        {
            ...
            switch (fAction)
            {
                case BtnEvent.Open:
                    btn_save.Text = "&CLOSE";
                    obj = CLedger_exten.PKId(pPkValue, new DAL());
        ...
        {
            vId = obj.Ledger_id;
            txt_ledger_name.Text = obj.Ledger_name;
            txt_ledgergroup_id.Text = obj.Ledgergroup_id;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_ledger_name.Enabled = !pReadOnly;
            txt_ledgergroup_id.Enabled = !pReadOnly;
        ...
        {
            if (txt_ledger_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "Ledger name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
