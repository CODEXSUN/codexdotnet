...
namespace CXCORE
{
    public partial class FLedgergroup : UserControl
    {
        ...
        private void Txt_ledgergroup_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FLedgergroup_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FLedgergroup_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_ledgergroup_name.Text;
        }
        public void setname(string pName)
        {
            txt_ledgergroup_name.Text = pName;
        }
