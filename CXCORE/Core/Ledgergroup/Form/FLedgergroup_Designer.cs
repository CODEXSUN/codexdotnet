...
namespace CXCORE
{
    public partial class FLedgergroup : UserControl
    {
        ...
        private XTextBox txt_ledgergroup_name;
        private XLabel lbl_ledgergroup_name;
        ...
        private void Initialize()
        {
            ...
            txt_ledgergroup_name = new XTextBox();
            lbl_ledgergroup_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_ledgergroup_name);
            finner_panel.Controls.Add(lbl_ledgergroup_name);
            ...
            lbl_header.Text = "Ledger group";

            #endregion[Header]

            #region[Properties of control]

            lbl_ledgergroup_name.Font = XFont.Font_10B;
            lbl_ledgergroup_name.Name = "lbl_ledgergroup_name";
            lbl_ledgergroup_name.Text = "   Ledger group";
            lbl_ledgergroup_name.Anchor = XAnchor.LT;
            lbl_ledgergroup_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_ledgergroup_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_ledgergroup_name.Size = XSize.OneLabel;
            lbl_ledgergroup_name.Location = XLayout.FirstLabel;

            txt_ledgergroup_name.Font = XFont.TxtFont;
            txt_ledgergroup_name.ForeColor = XFontColor.TxtFontColor;
            txt_ledgergroup_name.BackColor = XTheme.TxtBackcolor;
            txt_ledgergroup_name.Name = "txt_ledgergroup_name";
            txt_ledgergroup_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_ledgergroup_name.Size = XSize.OneText;
            txt_ledgergroup_name.Anchor = XAnchor.LTR;
            txt_ledgergroup_name.Location = XLayout.FirstText;
            txt_ledgergroup_name.TabIndex = XTab.Txt_TabIndex;
            txt_ledgergroup_name.Enter += new EventHandler(Txt_ledgergroup_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_ledgergroup_name.TabIndex);
