...
namespace CXCORE
{
    public partial class LLedgergroup : CxControl
    {

        private FLedgergroup fledgergroup = null;
        ...
        private LookupBox txt_ledgergroup_name;
        ...
        private void Initialize()
        {
            ...
            txt_ledgergroup_name = new LookupBox();
            ...
            linner_panel.Controls.Add(txt_ledgergroup_name);
            linner_panel.Controls.Add(lbl_ledgergroup_name);
            ...
            lbl_ledgergroup_name.TextAlign = ContentAlignment.MiddleCenter;
            ...
            btn_search.Location = new Point(txt_ledgergroup_name.Right + 10, txt_ledgergroup_name.Top);
