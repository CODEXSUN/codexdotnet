...
{ 
    ...
    { 
        ...
        private void Txt_month_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        private void Txt_month_starts_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_month_starts.BackColor = Theme.lbl_EnterBackColor;
            lbl_month_starts.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_month_starts.ForeColor = Theme.lbl_EnterForeColor;
        }
        private void Txt_month_ends_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_month_ends.BackColor = Theme.lbl_EnterBackColor;
            lbl_month_ends.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_month_ends.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
            ...
            lbl_month_starts.BackColor = Theme.lbl_BackColor;
            lbl_month_starts.BorderColor = Theme.lbl_BorderColor;
            lbl_month_starts.ForeColor = Theme.lbl_ForeColor;
            
            lbl_month_ends.BackColor = Theme.lbl_BackColor;
            lbl_month_ends.BorderColor = Theme.lbl_BorderColor;
            lbl_month_ends.ForeColor = Theme.lbl_ForeColor;
        ...
        public event EventHandler FMonth_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FMonth_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        { 
            return txt_month_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_month_name.Text = pName ; 
        } 
        public void SetFocus()
        {
            txt_month_name.Focus();
        }
        #endregion[Set Focus]
