...
namespace CXCORE
{ 
    public partial class FMonth : UserControl 
    { 
        public FMonth() 
        {
            InitializeComponent();
        ...
        private XTextBox txt_month_name;
        private XLabel lbl_month_name;
        private xDatepicker txt_month_starts;
        private XLabel lbl_month_starts;
        private xDatepicker txt_month_ends;
        private XLabel lbl_month_ends;
        ...
        { 
            ...
            txt_month_name = new XTextBox();
            lbl_month_name = new XLabel();
            txt_month_starts = new xDatepicker();
            lbl_month_starts = new XLabel();
            txt_month_ends = new xDatepicker();
            lbl_month_ends = new XLabel();
            ...
            finner_panel.Controls.Add(txt_month_name);
            finner_panel.Controls.Add(lbl_month_name);
            finner_panel.Controls.Add(txt_month_starts);
            finner_panel.Controls.Add(lbl_month_starts);
            finner_panel.Controls.Add(txt_month_ends);
            finner_panel.Controls.Add(lbl_month_ends);
            ...
            lbl_header.Text = "Month";

            #endregion[Header]

            #region[Properties of control]

            lbl_month_name.Font = XFont.Font_10B;
            lbl_month_name.Name = "lbl_month_name";
            lbl_month_name.Text = "   Month name";
            lbl_month_name.Anchor = XAnchor.LT;
            lbl_month_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_month_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_month_name.Size =  XSize.OneLabel;
            lbl_month_name.Location =XLayout.FirstLabel;

            txt_month_name.Font = XFont.TxtFont;
            txt_month_name.ForeColor = XFontColor.TxtFontColor;
            txt_month_name.BackColor = XTheme.TxtBackcolor;
            txt_month_name.Name = "txt_month_name";
            txt_month_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_month_name.Size =  XSize.OneText;
            txt_month_name.Anchor = XAnchor.LTR;
            txt_month_name.Location =XLayout.FirstText;
            txt_month_name.TabIndex = XTab.Txt_TabIndex;
            txt_month_name.Enter += new EventHandler(Txt_month_name_Enter);


            lbl_month_starts.Font = XFont.Font_10B;
            lbl_month_starts.Name = "lbl_month_starts";
            lbl_month_starts.Text = "   Month starts";
            lbl_month_starts.Anchor = XAnchor.LT;
            lbl_month_starts.TextAlign = ContentAlignment.MiddleLeft;
            lbl_month_starts.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_month_starts.Size =  XSize.OneLabel;
            lbl_month_starts.Location =XLayout.R1_Label(lbl_month_name.Location);

            txt_month_starts.Font = XFont.TxtFont;
            txt_month_starts.ForeColor = XFontColor.TxtFontColor;
            txt_month_starts.BackColor = XTheme.TxtBackcolor;
            txt_month_starts.Name = "txt_month_starts";
            txt_month_starts.CustomFormat = "dd-MM-yyyy";
            txt_month_starts.Format = DateTimePickerFormat.Custom;
            txt_month_starts.Size =  XSize.OneText;
            txt_month_starts.Anchor = XAnchor.LTR;
            txt_month_starts.Location =XLayout.R1_Text(txt_month_name.Location);
            txt_month_starts.TabIndex = XTab.Index(txt_month_name.TabIndex);
            txt_month_starts.Enter += new EventHandler(Txt_month_starts_Enter);


            lbl_month_ends.Font = XFont.Font_10B;
            lbl_month_ends.Name = "lbl_month_ends";
            lbl_month_ends.Text = "   Month ends";
            lbl_month_ends.Anchor = XAnchor.LT;
            lbl_month_ends.TextAlign = ContentAlignment.MiddleLeft;
            lbl_month_ends.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_month_ends.Size =  XSize.OneLabel;
            lbl_month_ends.Location =XLayout.R1_Label(lbl_month_starts.Location);

            txt_month_ends.Font = XFont.TxtFont;
            txt_month_ends.ForeColor = XFontColor.TxtFontColor;
            txt_month_ends.BackColor = XTheme.TxtBackcolor;
            txt_month_ends.Name = "txt_month_ends";
            txt_month_ends.CustomFormat = "dd-MM-yyyy";
            txt_month_ends.Format = DateTimePickerFormat.Custom;
            txt_month_ends.Size =  XSize.OneText;
            txt_month_ends.Anchor = XAnchor.LTR;
            txt_month_ends.Location =XLayout.R1_Text(txt_month_starts.Location);
            txt_month_ends.TabIndex = XTab.Index(txt_month_starts.TabIndex);
            txt_month_ends.Enter += new EventHandler(Txt_month_ends_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_month_ends.TabIndex);
