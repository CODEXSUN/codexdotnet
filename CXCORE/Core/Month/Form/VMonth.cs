    ...
    { 
        ...
        public void SetAction(BtnEvent pAction, string pPkValue)
        {
            ...
            switch (fAction)
            {
                case BtnEvent.Open:
                    btn_save.Text = "&CLOSE";
                    obj = CMonth_exten.PKId(pPkValue, new DAL());
        ...
        {
            vId = obj.Month_id;
            txt_month_name.Text = obj.Month_name;
            txt_month_starts.Text = obj.Month_starts;
            txt_month_ends.Text = obj.Month_ends;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_month_name.Enabled = !pReadOnly;
            txt_month_starts.Enabled = !pReadOnly;
            txt_month_ends.Enabled = !pReadOnly;
                                        ...
                                        case BtnEvent.Open: 
                                         ...
                                         case BtnEvent.New: 
                                             ...
                                             { 
                                                 ...
                                                 CMonth.Insert(vData, dalsession); 
                                                 dalsession.Commit(); 
                                         ...
                                         case BtnEvent.Edit: 
                                             ...
                                             { 
                                                 ...
                                                 dalsession = new DAL(); 
                                                 dalsession.BeginTransaction(); 
                                                 CMonth.Update(vData, dalsession); 
                                                 dalsession.Commit(); 
        ...
        private Month CollectData()
        {
           ...
           {
                Month_id = vId,
                Month_name = (txt_month_name.Text).ToUpper(),
