...
namespace CXCORE 
{ 
    public partial class LMonth
    { 

          private FMonth fmonth = null;
        ...
        private LookupBox txt_month_name; 
        ...
        { 
            ...
            linner_panel.Controls.Add(txt_month_name); 
            linner_panel.Controls.Add(lbl_month_name); 
            ...
            btn_search.Location = new Point(txt_month_name.Right + 10 ,txt_month_name.Top);
