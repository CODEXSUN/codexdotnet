...
{ 
    ...
    { 
        ...
        private void Txt_ordertype_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FOrdertype_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FOrdertype_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        { 
            return txt_ordertype_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_ordertype_name.Text = pName ; 
        } 
