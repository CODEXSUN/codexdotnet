...
{ 
    ...
    { 
        ...
        private XTextBox txt_ordertype_name;
        private XLabel lbl_ordertype_name;
        ...
        { 
            ...
            txt_ordertype_name = new XTextBox();
            lbl_ordertype_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_ordertype_name);
            finner_panel.Controls.Add(lbl_ordertype_name);
            ...
            lbl_header.Text = "Order type";

            #endregion[Header]

            #region[Properties of control]

            lbl_ordertype_name.Font = XFont.Font_10B;
            lbl_ordertype_name.Name = "lbl_ordertype_name";
            lbl_ordertype_name.Text = "   Order type";
            lbl_ordertype_name.Anchor = XAnchor.LT;
            lbl_ordertype_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_ordertype_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_ordertype_name.Size =  XSize.OneLabel;
            lbl_ordertype_name.Location =XLayout.FirstLabel;

            txt_ordertype_name.Font = XFont.TxtFont;
            txt_ordertype_name.ForeColor = XFontColor.TxtFontColor;
            txt_ordertype_name.BackColor = XTheme.TxtBackcolor;
            txt_ordertype_name.Name = "txt_ordertype_name";
            txt_ordertype_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_ordertype_name.Size =  XSize.OneText;
            txt_ordertype_name.Anchor = XAnchor.LTR;
            txt_ordertype_name.Location =XLayout.FirstText;
            txt_ordertype_name.TabIndex = XTab.Txt_TabIndex;
            txt_ordertype_name.Enter += new EventHandler(Txt_ordertype_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_ordertype_name.TabIndex);
