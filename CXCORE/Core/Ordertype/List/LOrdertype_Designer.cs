...
namespace CXCORE
{
    public partial class LOrdertype
    { 

          private FOrdertype fordertype = null;
        ...
        private LookupBox txt_ordertype_name; 
        ...
        { 
            ...
            txt_ordertype_name = new LookupBox(); 
            ...
            linner_panel.Controls.Add(txt_ordertype_name); 
            linner_panel.Controls.Add(lbl_ordertype_name); 
            ...
            btn_search.Location = new Point(txt_ordertype_name.Right + 10 ,txt_ordertype_name.Top);
