...
namespace CXCORE
{
    public partial class FPincode : UserControl
    {
        ...
        private void Txt_pincode_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FPincode_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FPincode_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_pincode_name.Text;
        }
        public void setname(string pName)
        {
            txt_pincode_name.Text = pName;
        }
