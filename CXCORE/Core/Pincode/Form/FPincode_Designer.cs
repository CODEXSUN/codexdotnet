...
namespace CXCORE
{
    public partial class FPincode : UserControl
    {
        public FPincode()
        {
            InitializeComponent();
        ...
        private XTextBox txt_pincode_name;
        private XLabel lbl_pincode_name;
        ...
        private void Initialize()
        {
            ...
            txt_pincode_name = new XTextBox();
            lbl_pincode_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_pincode_name);
            finner_panel.Controls.Add(lbl_pincode_name);
            ...
            lbl_header.Text = "Pincode";

            #endregion[Header]

            #region[Properties of control]

            lbl_pincode_name.Font = XFont.Font_10B;
            lbl_pincode_name.Name = "lbl_pincode_name";
            lbl_pincode_name.Text = "   Pincode name";
            lbl_pincode_name.Anchor = XAnchor.LT;
            lbl_pincode_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_pincode_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_pincode_name.Size = XSize.OneLabel;
            lbl_pincode_name.Location = XLayout.FirstLabel;

            txt_pincode_name.Font = XFont.TxtFont;
            txt_pincode_name.ForeColor = XFontColor.TxtFontColor;
            txt_pincode_name.BackColor = XTheme.TxtBackcolor;
            txt_pincode_name.Name = "txt_pincode_name";
            txt_pincode_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_pincode_name.Size = XSize.OneText;
            txt_pincode_name.Anchor = XAnchor.LTR;
            txt_pincode_name.Location = XLayout.FirstText;
            txt_pincode_name.TabIndex = XTab.Txt_TabIndex;
            txt_pincode_name.Enter += new EventHandler(Txt_pincode_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_pincode_name.TabIndex);
