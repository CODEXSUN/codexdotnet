...
namespace CXCORE
{
    public partial class FPincode : UserControl
    {
        ...
        {
            vId = obj.Pincode_id;
            txt_pincode_name.Text = obj.Pincode_name;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_pincode_name.Enabled = !pReadOnly;
                ...
                switch (fAction)
                {
                    ...
                    case BtnEvent.New:
                        try
                        {
                            ...
                            CPincode.Insert(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Edit:
                        try
                        {
                            ...
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CPincode.Update(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Delete:
                        try
                        {
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CPincode.Delete(vId, dalsession);
                            dalsession.Commit();
        ...
        private Pincode CollectData()
        {
            ...
            {
                Pincode_id = vId,
                Pincode_name = txt_pincode_name.Text,
        ...
        {
            if (txt_pincode_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "Pincode name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txt_pincode_name.Focus();
                return false;
            }
