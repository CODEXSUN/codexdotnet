...
namespace CXCORE
{ 
    public partial class FProducttype : UserControl 
    { 
        ...
        private void Txt_producttype_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FProducttype_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FProducttype_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        { 
            return txt_producttype_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_producttype_name.Text = pName ; 
        } 
        public void SetFocus()
        {
            txt_producttype_name.Focus();
        }
        #endregion[Set Focus]
