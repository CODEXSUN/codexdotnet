...
namespace CXCORE
{
    public partial class LProducttype : CxControl
    {

        private FProducttype fproducttype = null;
        ...
        private LookupBox txt_producttype_name;
        private XLabel lbl_producttype_name;
        ...
        private void Initialize()
        {
            ...
            txt_producttype_name = new LookupBox();
            ...
            linner_panel.Controls.Add(txt_producttype_name);
            linner_panel.Controls.Add(lbl_producttype_name);
            ...
            lbl_producttype_name.TextAlign = ContentAlignment.MiddleCenter;
            ...
            btn_search.Location = new Point(txt_producttype_name.Right + 10, txt_producttype_name.Top);
