...
namespace CXCORE
{
    public partial class FReceipttype : UserControl
    {
        ...
        private void Txt_receipttype_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FReceipttype_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FReceipttype_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_receipttype_name.Text;
        }
        public void setname(string pName)
        {
            txt_receipttype_name.Text = pName;
        }
