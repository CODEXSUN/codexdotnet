...
namespace CXCORE
{
    public partial class FReceipttype : UserControl
    {
        ...
        private XTextBox txt_receipttype_name;
        private XLabel lbl_receipttype_name;
        ...
        private void Initialize()
        {
            ...
            txt_receipttype_name = new XTextBox();
            lbl_receipttype_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_receipttype_name);
            finner_panel.Controls.Add(lbl_receipttype_name);
            ...
            lbl_header.Text = "Receipt type";

            #endregion[Header]

            #region[Properties of control]

            lbl_receipttype_name.Font = XFont.Font_10B;
            lbl_receipttype_name.Name = "lbl_receipttype_name";
            lbl_receipttype_name.Text = "   Receipttype name";
            lbl_receipttype_name.Anchor = XAnchor.LT;
            lbl_receipttype_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_receipttype_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_receipttype_name.Size = XSize.OneLabel;
            lbl_receipttype_name.Location = XLayout.FirstLabel;

            txt_receipttype_name.Font = XFont.TxtFont;
            txt_receipttype_name.ForeColor = XFontColor.TxtFontColor;
            txt_receipttype_name.BackColor = XTheme.TxtBackcolor;
            txt_receipttype_name.Name = "txt_receipttype_name";
            txt_receipttype_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_receipttype_name.Size = XSize.OneText;
            txt_receipttype_name.Anchor = XAnchor.LTR;
            txt_receipttype_name.Location = XLayout.FirstText;
            txt_receipttype_name.TabIndex = XTab.Txt_TabIndex;
            txt_receipttype_name.Enter += new EventHandler(Txt_receipttype_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_receipttype_name.TabIndex);
