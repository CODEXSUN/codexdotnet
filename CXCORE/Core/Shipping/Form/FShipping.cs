...
{ 
    ...
    { 
        ...
        private void Txt_shipping_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FShipping_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FShipping_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        { 
            return txt_shipping_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_shipping_name.Text = pName ; 
        } 
