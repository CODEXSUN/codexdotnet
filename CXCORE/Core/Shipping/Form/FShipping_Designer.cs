...
namespace CXCORE
{ 
    public partial class FShipping : UserControl 
    { 
        public FShipping() 
        {
            InitializeComponent();
        ...
        private XTextBox txt_shipping_name;
        private XLabel lbl_shipping_name;
        ...
        { 
            ...
            txt_shipping_name = new XTextBox();
            lbl_shipping_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_shipping_name);
            finner_panel.Controls.Add(lbl_shipping_name);
            ...
            lbl_header.Text = "Shipping";

            #endregion[Header]

            #region[Properties of control]

            lbl_shipping_name.Font = XFont.Font_10B;
            lbl_shipping_name.Name = "lbl_shipping_name";
            lbl_shipping_name.Text = "   Shipping name";
            lbl_shipping_name.Anchor = XAnchor.LT;
            lbl_shipping_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_shipping_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_shipping_name.Size =  XSize.OneLabel;
            lbl_shipping_name.Location =XLayout.FirstLabel;

            txt_shipping_name.Font = XFont.TxtFont;
            txt_shipping_name.ForeColor = XFontColor.TxtFontColor;
            txt_shipping_name.BackColor = XTheme.TxtBackcolor;
            txt_shipping_name.Name = "txt_shipping_name";
            txt_shipping_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_shipping_name.Size =  XSize.OneText;
            txt_shipping_name.Anchor = XAnchor.LTR;
            txt_shipping_name.Location =XLayout.FirstText;
            txt_shipping_name.TabIndex = XTab.Txt_TabIndex;
            txt_shipping_name.Enter += new EventHandler(Txt_shipping_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_shipping_name.TabIndex);
