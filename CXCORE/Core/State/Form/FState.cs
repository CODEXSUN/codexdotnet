...
namespace CXCORE
{
    public partial class FState : UserControl
    {
        ...
        private void Txt_state_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        private void Txt_state_code_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_state_code.BackColor = Theme.lbl_EnterBackColor;
            lbl_state_code.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_state_code.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
            ...
            lbl_state_code.BackColor = Theme.lbl_BackColor;
            lbl_state_code.BorderColor = Theme.lbl_BorderColor;
            lbl_state_code.ForeColor = Theme.lbl_ForeColor;
        ...
        public event EventHandler FState_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FState_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_state_name.Text;
        }
        public void setname(string pName)
        {
            txt_state_name.Text = pName;
        }
