    ...
    public partial class FState : UserControl
    {
        ...
        public void SetAction(BtnEvent pAction, string pPkValue)
        {
            ...
            switch (fAction)
            {
                case BtnEvent.Open:
                    btn_save.Text = "&CLOSE";
                    obj = CState_exten.PKId(pPkValue, new DAL());
        ...
        {
            vId = obj.State_id;
            txt_state_name.Text = obj.State_name;
            txt_state_code.Text = obj.State_code;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_state_name.Enabled = !pReadOnly;
            txt_state_code.Enabled = !pReadOnly;
                ...
                switch (fAction)
                {
                    ...
                    case BtnEvent.New:
                        try
                        {
                            ...
                            CState.Insert(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Edit:
                        try
                        {
                            ...
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CState.Update(vData, dalsession);
                            dalsession.Commit();
        ...
        private State CollectData()
        {
            ...
            {
                State_id = vId,
                State_name = txt_state_name.Text,
        ...
        {
            if (txt_state_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "State name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
