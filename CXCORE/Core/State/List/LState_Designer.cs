...
namespace CXCORE
{
    public partial class LState : CxControl
    {

        private FState fstate = null;
        ...
        private LookupBox txt_state_name;
        ...
        private void Initialize()
        {
            ...
            linner_panel.Controls.Add(txt_state_name);
            linner_panel.Controls.Add(lbl_state_name);
            ...
            btn_search.Location = new Point(txt_state_name.Right + 10, txt_state_name.Top);
