...
namespace CXCORE
{
    public partial class FUnit : UserControl
    {
        ...
        private void Txt_unit_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        private void Txt_unit_desc_Enter(object sender, EventArgs e)
        {
            Change_infocus();
            lbl_unit_desc.BackColor = Theme.lbl_EnterBackColor;
            lbl_unit_desc.BorderColor = Theme.lbl_EnterBorderColor;
            lbl_unit_desc.ForeColor = Theme.lbl_EnterForeColor;
        }
        ...
        private void Change_infocus()
        {
            ...
            lbl_unit_desc.BackColor = Theme.lbl_BackColor;
            lbl_unit_desc.BorderColor = Theme.lbl_BorderColor;
            lbl_unit_desc.ForeColor = Theme.lbl_ForeColor;
        ...
        public event EventHandler FUnit_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FUnit_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_unit_name.Text;
        }
        public void Setname(string pName)
        {
            txt_unit_name.Text = pName;
        }
