...
namespace CXCORE
{
    public partial class FUnit : UserControl
    {
        public FUnit()
        {
            InitializeComponent();
        ...
        private XTextBox txt_unit_name;
        private XLabel lbl_unit_name;
        private XTextBox txt_unit_desc;
        private XLabel lbl_unit_desc;
        ...
        private void Initialize()
        {
            ...
            txt_unit_name = new XTextBox();
            lbl_unit_name = new XLabel();
            txt_unit_desc = new XTextBox();
            lbl_unit_desc = new XLabel();
            ...
            finner_panel.Controls.Add(txt_unit_name);
            finner_panel.Controls.Add(lbl_unit_name);
            finner_panel.Controls.Add(txt_unit_desc);
            finner_panel.Controls.Add(lbl_unit_desc);
            ...
            lbl_header.Text = "Unit";

            #endregion[Header]

            #region[Properties of control]

            lbl_unit_name.Font = XFont.Font_10B;
            lbl_unit_name.Name = "lbl_unit_name";
            lbl_unit_name.Text = "   Units";
            lbl_unit_name.Anchor = XAnchor.LT;
            lbl_unit_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_unit_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_unit_name.Size = XSize.OneLabel;
            lbl_unit_name.Location = XLayout.FirstLabel;

            txt_unit_name.Font = XFont.TxtFont;
            txt_unit_name.ForeColor = XFontColor.TxtFontColor;
            txt_unit_name.BackColor = XTheme.TxtBackcolor;
            txt_unit_name.Name = "txt_unit_name";
            txt_unit_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_unit_name.Size = XSize.OneText;
            txt_unit_name.Anchor = XAnchor.LTR;
            txt_unit_name.Location = XLayout.FirstText;
            txt_unit_name.TabIndex = XTab.Txt_TabIndex;
            txt_unit_name.Enter += new EventHandler(Txt_unit_name_Enter);


            lbl_unit_desc.Font = XFont.Font_10B;
            lbl_unit_desc.Name = "lbl_unit_desc";
            lbl_unit_desc.Text = "   Unit desc";
            lbl_unit_desc.Anchor = XAnchor.LT;
            lbl_unit_desc.TextAlign = ContentAlignment.MiddleLeft;
            lbl_unit_desc.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_unit_desc.Size = XSize.OneLabel;
            lbl_unit_desc.Location = XLayout.R1_Label(lbl_unit_name.Location);

            txt_unit_desc.Font = XFont.TxtFont;
            txt_unit_desc.ForeColor = XFontColor.TxtFontColor;
            txt_unit_desc.BackColor = XTheme.TxtBackcolor;
            txt_unit_desc.Name = "txt_unit_desc";
            txt_unit_desc.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_unit_desc.Size = XSize.OneText;
            txt_unit_desc.Anchor = XAnchor.LTR;
            txt_unit_desc.Location = XLayout.R1_Text(txt_unit_name.Location);
            txt_unit_desc.TabIndex = XTab.Index(txt_unit_name.TabIndex);
            txt_unit_desc.Enter += new EventHandler(Txt_unit_desc_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_unit_desc.TabIndex);
