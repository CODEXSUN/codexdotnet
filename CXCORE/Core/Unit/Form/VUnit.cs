...
namespace CXCORE
{
    public partial class FUnit : UserControl
    {
        ...
        {
            vId = obj.Unit_id;
            txt_unit_name.Text = obj.Unit_name;
            txt_unit_desc.Text = obj.Unit_desc;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_unit_name.Enabled = !pReadOnly;
            txt_unit_desc.Enabled = !pReadOnly;
        ...
        {
            if (txt_unit_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "Unit name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txt_unit_name.Focus();
                return false;
            }
