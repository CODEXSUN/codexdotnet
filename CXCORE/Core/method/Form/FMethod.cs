...
{ 
    ...
    { 
        ...
        private void Txt_method_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FMethod_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            if (FMethod_NeedToRefresh != null)
            {
                FMethod_NeedToRefresh(this, new EventArgs());
            }
        }
        ...
        { 
            return txt_method_name.Text; 
        } 
        public void setname(string pName) 
        { 
            txt_method_name.Text = pName ; 
        } 
        public void SetFocus()
        {
            txt_method_name.Focus();
        }
        #endregion[Set Focus]
