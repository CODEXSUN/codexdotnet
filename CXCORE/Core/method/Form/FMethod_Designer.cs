...
namespace CXCORE
{ 
    public partial class FMethod : UserControl 
    { 
        public FMethod() 
        {
            InitializeComponent();
        ...
        private XTextBox txt_method_name;
        private XLabel lbl_method_name;
        ...
        { 
            ...
            txt_method_name = new XTextBox();
            lbl_method_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_method_name);
            finner_panel.Controls.Add(lbl_method_name);
            ...
            lbl_header.Text = "Method";

            #endregion[Header]

            #region[Properties of control]

            lbl_method_name.Font = XFont.Font_10B;
            lbl_method_name.Name = "lbl_method_name";
            lbl_method_name.Text = "   Method name";
            lbl_method_name.Anchor = XAnchor.LT;
            lbl_method_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_method_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_method_name.Size =  XSize.OneLabel;
            lbl_method_name.Location =XLayout.FirstLabel;

            txt_method_name.Font = XFont.TxtFont;
            txt_method_name.ForeColor = XFontColor.TxtFontColor;
            txt_method_name.BackColor = XTheme.TxtBackcolor;
            txt_method_name.Name = "txt_method_name";
            txt_method_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_method_name.Size =  XSize.OneText;
            txt_method_name.Anchor = XAnchor.LTR;
            txt_method_name.Location =XLayout.FirstText;
            txt_method_name.TabIndex = XTab.Txt_TabIndex;
            txt_method_name.Enter += new EventHandler(Txt_method_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_method_name.TabIndex);
