...
{ 
    ...
    { 
        ...
        {
            vId = obj.Method_id;
            txt_method_name.Text = obj.Method_name;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_method_name.Enabled = !pReadOnly;
                                        ...
                                        case BtnEvent.Open: 
                                         ...
                                         case BtnEvent.New: 
                                             ...
                                             { 
                                                 ...
                                                 CMethod.Insert(vData, dalsession); 
                                                 dalsession.Commit(); 
                                         ...
                                         case BtnEvent.Edit: 
                                             ...
                                             { 
                                                 ...
                                                 dalsession = new DAL(); 
                                                 dalsession.BeginTransaction(); 
                                                 CMethod.Update(vData, dalsession); 
                                                 dalsession.Commit(); 
        ...
        {
            Method fobj = new Method()
           {
                Method_id = vId,
                Method_name = txt_method_name.Text,
        ...
        {
            if (txt_method_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "Method name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
