...
namespace CXCORE
{
    public partial class LMethod
    { 

          private FMethod fmethod = null;
        ...
        private LookupBox txt_method_name; 
        ...
        { 
            ...
            linner_panel.Controls.Add(txt_method_name); 
            linner_panel.Controls.Add(lbl_method_name); 
            ...
            txt_method_name.Size = XSize.TwoText; 
            txt_method_name.Anchor = XAnchor.LT; 
            txt_method_name.Location = XLayout.FirstText; 
            txt_method_name.TabIndex = 5; 

            lbl_method_name.Font = XFont.Font_10B; 
            lbl_method_name.Name = "lbl_method_name"; 
            lbl_method_name.Text = "Method"; 
            lbl_method_name.TextAlign = ContentAlignment.MiddleCenter; 
            ...
            btn_search.Location = new Point(txt_method_name.Right + 1 ,txt_method_name.Top);
