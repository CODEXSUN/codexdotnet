...
namespace CXCORE
{
    public partial class FSalestype 
    {
        ...
        private void Txt_salestype_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FSalestype_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FSalestype_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_salestype_name.Text;
        }
        public void setname(string pName)
        {
            txt_salestype_name.Text = pName;
        }
