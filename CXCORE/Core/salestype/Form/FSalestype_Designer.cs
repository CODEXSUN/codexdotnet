...
namespace CXCORE
{
    public partial class FSalestype 
    {
        public FSalestype()
        {
            InitializeComponent();
        ...
        private XTextBox txt_salestype_name;
        private XLabel lbl_salestype_name;
        ...
        private void Initialize()
        {
            ...
            txt_salestype_name = new XTextBox();
            lbl_salestype_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_salestype_name);
            finner_panel.Controls.Add(lbl_salestype_name);
            ...
            lbl_header.Text = "Sales type";

            #endregion[Header]

            #region[Properties of control]

            lbl_salestype_name.Font = XFont.Font_10B;
            lbl_salestype_name.Name = "lbl_salestype_name";
            lbl_salestype_name.Text = "   Sales type";
            lbl_salestype_name.Anchor = XAnchor.LT;
            lbl_salestype_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_salestype_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_salestype_name.Size = XSize.OneLabel;
            lbl_salestype_name.Location = XLayout.FirstLabel;

            txt_salestype_name.Font = XFont.TxtFont;
            txt_salestype_name.ForeColor = XFontColor.TxtFontColor;
            txt_salestype_name.BackColor = XTheme.TxtBackcolor;
            txt_salestype_name.Name = "txt_salestype_name";
            txt_salestype_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_salestype_name.Size = XSize.OneText;
            txt_salestype_name.Anchor = XAnchor.LTR;
            txt_salestype_name.Location = XLayout.FirstText;
            txt_salestype_name.TabIndex = XTab.Txt_TabIndex;
            txt_salestype_name.Enter += new EventHandler(Txt_salestype_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_salestype_name.TabIndex);
