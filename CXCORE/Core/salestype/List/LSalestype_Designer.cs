...
namespace CXCORE
{
    public partial class LSalestype : CxControl
    {

        private FSalestype fsalestype = null;
        ...
        private LookupBox txt_salestype_name;
        ...
        private void Initialize()
        {
            ...
            txt_salestype_name = new LookupBox();
            ...
            linner_panel.Controls.Add(txt_salestype_name);
            linner_panel.Controls.Add(lbl_salestype_name);
            ...
            btn_search.Location = new Point(txt_salestype_name.Right + 10, txt_salestype_name.Top);
