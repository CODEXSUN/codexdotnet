...
namespace CXCORE
{
    public partial class FSizes : UserControl
    {
        ...
        private void Txt_sizes_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FSizes_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FSizes_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_sizes_name.Text;
        }
        public void setname(string pName)
        {
            txt_sizes_name.Text = pName;
        }
