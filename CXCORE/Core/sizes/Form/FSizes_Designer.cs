...
namespace CXCORE
{
    public partial class FSizes : UserControl
    {
        public FSizes()
        {
            InitializeComponent();
        ...
        private XTextBox txt_sizes_name;
        private XLabel lbl_sizes_name;
        ...
        private void Initialize()
        {
            ...
            txt_sizes_name = new XTextBox();
            lbl_sizes_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_sizes_name);
            finner_panel.Controls.Add(lbl_sizes_name);
            ...
            lbl_header.Text = "Sizes";

            #endregion[Header]

            #region[Properties of control]

            lbl_sizes_name.Font = XFont.Font_10B;
            lbl_sizes_name.Name = "lbl_sizes_name";
            lbl_sizes_name.Text = "   Sizes";
            lbl_sizes_name.Anchor = XAnchor.LT;
            lbl_sizes_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_sizes_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_sizes_name.Size = XSize.OneLabel;
            lbl_sizes_name.Location = XLayout.FirstLabel;

            txt_sizes_name.Font = XFont.TxtFont;
            txt_sizes_name.ForeColor = XFontColor.TxtFontColor;
            txt_sizes_name.BackColor = XTheme.TxtBackcolor;
            txt_sizes_name.Name = "txt_sizes_name";
            txt_sizes_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_sizes_name.Size = XSize.OneText;
            txt_sizes_name.Anchor = XAnchor.LTR;
            txt_sizes_name.Location = XLayout.FirstText;
            txt_sizes_name.TabIndex = XTab.Txt_TabIndex;
            txt_sizes_name.Enter += new EventHandler(Txt_sizes_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_sizes_name.TabIndex);
