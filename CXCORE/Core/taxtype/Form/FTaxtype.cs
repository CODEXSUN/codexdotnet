...
namespace CXCORE
{
    public partial class FTaxtype : UserControl
    {
        ...
        private void Txt_taxtype_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FTaxtype_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FTaxtype_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_taxtype_name.Text;
        }
        public void setname(string pName)
        {
            txt_taxtype_name.Text = pName;
        }
