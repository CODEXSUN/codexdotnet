...
namespace CXCORE
{
    public partial class FTaxtype : UserControl
    {
        ...
        private XTextBox txt_taxtype_name;
        private XLabel lbl_taxtype_name;
        ...
        private void Initialize()
        {
            ...
            txt_taxtype_name = new XTextBox();
            lbl_taxtype_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_taxtype_name);
            finner_panel.Controls.Add(lbl_taxtype_name);
            ...
            lbl_header.Text = "Tax type";

            #endregion[Header]

            #region[Properties of control]

            lbl_taxtype_name.Font = XFont.Font_10B;
            lbl_taxtype_name.Name = "lbl_taxtype_name";
            lbl_taxtype_name.Text = "   Tax type";
            lbl_taxtype_name.Anchor = XAnchor.LT;
            lbl_taxtype_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_taxtype_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_taxtype_name.Size = XSize.OneLabel;
            lbl_taxtype_name.Location = XLayout.FirstLabel;

            txt_taxtype_name.Font = XFont.TxtFont;
            txt_taxtype_name.ForeColor = XFontColor.TxtFontColor;
            txt_taxtype_name.BackColor = XTheme.TxtBackcolor;
            txt_taxtype_name.Name = "txt_taxtype_name";
            txt_taxtype_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_taxtype_name.Size = XSize.OneText;
            txt_taxtype_name.Anchor = XAnchor.LTR;
            txt_taxtype_name.Location = XLayout.FirstText;
            txt_taxtype_name.TabIndex = XTab.Txt_TabIndex;
            txt_taxtype_name.Enter += new EventHandler(Txt_taxtype_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_taxtype_name.TabIndex);
