...
namespace CXCORE
{
    public partial class LTaxtype : CxControl
    {

        private FTaxtype ftaxtype = null;
        ...
        private LookupBox txt_taxtype_name;
        ...
        private void Initialize()
        {
            ...
            txt_taxtype_name = new LookupBox();
            ...
            linner_panel.Controls.Add(txt_taxtype_name);
            linner_panel.Controls.Add(lbl_taxtype_name);
            ...
            btn_search.Location = new Point(txt_taxtype_name.Right + 10, txt_taxtype_name.Top);
