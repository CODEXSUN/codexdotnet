...
namespace CXCORE
{
    public partial class FTransport : UserControl
    {
        ...
        private void Txt_transport_name_Enter(object sender, EventArgs e)
        {
            Change_infocus();
        ...
        public event EventHandler FTransport_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            FTransport_NeedToRefresh?.Invoke(this, new EventArgs());
        }
        ...
        {
            return txt_transport_name.Text;
        }
        public void setname(string pName)
        {
            txt_transport_name.Text = pName;
        }
        public void SetFocus()
        {
            txt_transport_name.Focus();
        }
        #endregion[Set Focus]
