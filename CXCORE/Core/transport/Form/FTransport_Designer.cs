...
namespace CXCORE
{
    public partial class FTransport : UserControl
    {
        public FTransport()
        {
            InitializeComponent();
        ...
        private XTextBox txt_transport_name;
        private XLabel lbl_transport_name;
        ...
        private void Initialize()
        {
            ...
            txt_transport_name = new XTextBox();
            lbl_transport_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_transport_name);
            finner_panel.Controls.Add(lbl_transport_name);
            ...
            lbl_header.Text = "Transport";

            #endregion[Header]

            #region[Properties of control]

            lbl_transport_name.Font = XFont.Font_10B;
            lbl_transport_name.Name = "lbl_transport_name";
            lbl_transport_name.Text = "   Transport name";
            lbl_transport_name.Anchor = XAnchor.LT;
            lbl_transport_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_transport_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_transport_name.Size = XSize.OneLabel;
            lbl_transport_name.Location = XLayout.FirstLabel;

            txt_transport_name.Font = XFont.TxtFont;
            txt_transport_name.ForeColor = XFontColor.TxtFontColor;
            txt_transport_name.BackColor = XTheme.TxtBackcolor;
            txt_transport_name.Name = "txt_transport_name";
            txt_transport_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_transport_name.Size = XSize.OneText;
            txt_transport_name.Anchor = XAnchor.LTR;
            txt_transport_name.Location = XLayout.FirstText;
            txt_transport_name.TabIndex = XTab.Txt_TabIndex;
            txt_transport_name.Enter += new EventHandler(Txt_transport_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_transport_name.TabIndex);
