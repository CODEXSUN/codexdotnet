    ...
    public partial class FTransport : UserControl
    {
        ...
        public void SetAction(BtnEvent pAction, string pPkValue)
        {
            ...
            switch (fAction)
            {
                case BtnEvent.Open:
                    btn_save.Text = "&CLOSE";
                    obj = CTransport_exten.PKId(pPkValue, new DAL());
                    this.EnableControls(false);
                    break;
                case BtnEvent.New:
                    btn_save.Text = "&SAVE";
                    obj = CTransport.GetNew;
        ...
        {
            vId = obj.Transport_id;
            txt_transport_name.Text = obj.Transport_name;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_transport_name.Enabled = !pReadOnly;
                ...
                switch (fAction)
                {
                    ...
                    case BtnEvent.New:
                        try
                        {
                            ...
                            CTransport.Insert(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Edit:
                        try
                        {
                            ...
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CTransport.Update(vData, dalsession);
                            dalsession.Commit();
                    ...
                    case BtnEvent.Delete:
                        try
                        {
                            dalsession = new DAL();
                            dalsession.BeginTransaction();
                            CTransport.Delete(vId, dalsession);
                            dalsession.Commit();
        ...
        {
            if (txt_transport_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "Transport name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
