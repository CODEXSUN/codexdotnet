...
namespace CXCORE
{
    public partial class LTransport
    {

        private FTransport ftransport = null;
        ...
        private LookupBox txt_transport_name;
        ...
        private void Initialize()
        {
            ...
            txt_transport_name = new LookupBox();
            ...
            linner_panel.Controls.Add(txt_transport_name);
            linner_panel.Controls.Add(lbl_transport_name);
            ...
            btn_search.Location = new Point(txt_transport_name.Right + 10, txt_transport_name.Top);
