...
// Auto Generated
// last update : 25-12-2017 07:46:43 PM
...
{ 
    ...
    { 
        ...
        private XTextBox txt_vouchertype_name;
        private XLabel lbl_vouchertype_name;
        private LookupBox txt_method_id;
        private XLabel lbl_method_id;
        ...
        { 
            ...
            txt_vouchertype_name = new XTextBox();
            lbl_vouchertype_name = new XLabel();
            txt_method_id = new LookupBox();
            lbl_method_id = new XLabel();
            ...
            finner_panel.Controls.Add(txt_vouchertype_name);
            finner_panel.Controls.Add(lbl_vouchertype_name);
            finner_panel.Controls.Add(txt_method_id);
            finner_panel.Controls.Add(lbl_method_id);
            ...
            lbl_header.Text = "Vouchertype";

            #endregion[Header]

            #region[Properties of control]

            lbl_vouchertype_name.Font = XFont.Font_10B;
            lbl_vouchertype_name.Name = "lbl_vouchertype_name";
            lbl_vouchertype_name.Text = "   Vouchertype name";
            lbl_vouchertype_name.Anchor = XAnchor.LT;
            lbl_vouchertype_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_vouchertype_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_vouchertype_name.Size =  XSize.OneLabel;
            lbl_vouchertype_name.Location =XLayout.FirstLabel;

            txt_vouchertype_name.Font = XFont.TxtFont;
            txt_vouchertype_name.ForeColor = XFontColor.TxtFontColor;
            txt_vouchertype_name.BackColor = XTheme.TxtBackcolor;
            txt_vouchertype_name.Name = "txt_vouchertype_name";
            txt_vouchertype_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_vouchertype_name.Size =  XSize.OneText;
            txt_vouchertype_name.Anchor = XAnchor.LTR;
            txt_vouchertype_name.Location =XLayout.FirstText;
            txt_vouchertype_name.TabIndex = XTab.Txt_TabIndex;
            txt_vouchertype_name.Enter += new EventHandler(Txt_vouchertype_name_Enter);


            lbl_method_id.Font = XFont.Font_10B;
            lbl_method_id.Name = "lbl_method_id";
            lbl_method_id.Text = "   Method";
            lbl_method_id.Anchor = XAnchor.LT;
            lbl_method_id.TextAlign = ContentAlignment.MiddleLeft;
            lbl_method_id.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_method_id.Size =  XSize.OneLabel;
            lbl_method_id.Location =XLayout.R1_Label(lbl_vouchertype_name.Location);

            txt_method_id.Font = XFont.TxtFont;
            txt_method_id.ForeColor = XFontColor.TxtFontColor;
            txt_method_id.BackColor = XTheme.TxtBackcolor;
            txt_method_id.Name = "txt_method_id";
            txt_method_id.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_method_id.Size =  XSize.OneText;
            txt_method_id.Anchor = XAnchor.LTR;
            txt_method_id.Location =XLayout.R1_Text(txt_vouchertype_name.Location);
            txt_method_id.TabIndex = XTab.Index(txt_vouchertype_name.TabIndex);
            txt_method_id.Enter += new EventHandler(Txt_method_id_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_method_id.TabIndex);
