...
// Auto Generated
// last update : 25-12-2017 07:46:55 PM
...
{ 
    ...
    { 
        ...
        {
            vId = obj.Vouchertype_id;
            txt_vouchertype_name.Text = obj.Vouchertype_name;
            txt_method_id.Text = obj.Method_id;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_vouchertype_name.Enabled = !pReadOnly;
            txt_method_id.Enabled = !pReadOnly;
                                        ...
                                        case BtnEvent.Open: 
                                         ...
                                         case BtnEvent.New: 
                                             ...
                                             { 
                                                 ...
                                                 CVouchertype.Insert(vData, dalsession); 
                                                 dalsession.Commit(); 
                                         ...
                                         case BtnEvent.Edit: 
                                             ...
                                             { 
                                                 ...
                                                 dalsession = new DAL(); 
                                                 dalsession.BeginTransaction(); 
                                                 CVouchertype.Update(vData, dalsession); 
                                                 dalsession.Commit(); 
                                         ...
                                         case BtnEvent.Delete: 
                                             ...
                                             { 
                                                 dalsession = new DAL(); 
                                                 dalsession.BeginTransaction(); 
                                                 CVouchertype.Delete(vId, dalsession); 
                                                 dalsession.Commit(); 
        ...
        private Vouchertype CollectData()
        {
            Vouchertype fobj = new Vouchertype()
           {
                Vouchertype_id = vId,
                Vouchertype_name = txt_vouchertype_name.Text,
                Method_id = CMethod_exten.GetId_Name(txt_method_id.Text),
        ...
        {
            if (txt_vouchertype_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "Vouchertype name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
