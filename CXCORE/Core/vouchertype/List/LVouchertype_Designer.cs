...
// Auto Generated
// last update : 25-12-2017 07:47:35 PM
...
namespace CXCORE
{
    public partial class LVouchertype
    { 

          private FVouchertype fvouchertype = null;
        ...
        private LookupBox txt_vouchertype_name; 
        ...
        { 
            ...
            txt_vouchertype_name = new LookupBox(); 
            ...
            linner_panel.Controls.Add(txt_vouchertype_name); 
            linner_panel.Controls.Add(lbl_vouchertype_name); 
            ...
            txt_vouchertype_name.Size = XSize.TwoText; 
            txt_vouchertype_name.Anchor = XAnchor.LT; 
            txt_vouchertype_name.Location = XLayout.FirstText; 
            txt_vouchertype_name.TabIndex = 5; 

            lbl_vouchertype_name.Font = XFont.Font_10B; 
            lbl_vouchertype_name.Name = "lbl_vouchertype_name"; 
            lbl_vouchertype_name.Text = "Vouchertype"; 
            lbl_vouchertype_name.TextAlign = ContentAlignment.MiddleCenter; 
            ...
            btn_search.Location = new Point(txt_vouchertype_name.Right + 1 ,txt_vouchertype_name.Top);
