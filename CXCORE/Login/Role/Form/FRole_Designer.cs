...
namespace CXCORE
{
    public partial class FRole : UserControl
    {
        public FRole()
        {
            InitializeComponent();
        ...
        private XTextBox txt_role_name;
        private XLabel lbl_role_name;
        ...
        private void Initialize()
        {
            ...
            txt_role_name = new XTextBox();
            lbl_role_name = new XLabel();
            ...
            finner_panel.Controls.Add(txt_role_name);
            finner_panel.Controls.Add(lbl_role_name);
            ...
            lbl_header.Text = "Role";

            #endregion[Header]

            #region[Properties of control]

            lbl_role_name.Font = XFont.Font_10B;
            lbl_role_name.Name = "lbl_role_name";
            lbl_role_name.Text = "   Role name";
            lbl_role_name.Anchor = XAnchor.LT;
            lbl_role_name.TextAlign = ContentAlignment.MiddleLeft;
            lbl_role_name.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_role_name.Size = XSize.OneLabel;
            lbl_role_name.Location = XLayout.FirstLabel;

            txt_role_name.Font = XFont.TxtFont;
            txt_role_name.ForeColor = XFontColor.TxtFontColor;
            txt_role_name.BackColor = XTheme.TxtBackcolor;
            txt_role_name.Name = "txt_role_name";
            txt_role_name.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_role_name.Size = XSize.OneText;
            txt_role_name.Anchor = XAnchor.LTR;
            txt_role_name.Location = XLayout.FirstText;
            txt_role_name.TabIndex = XTab.Txt_TabIndex;
            txt_role_name.Enter += new EventHandler(Txt_role_name_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_role_name.TabIndex);
