    ...
    public partial class FRole : UserControl
    {
        ...
        public void SetAction(BtnEvent pAction, string pPkValue)
        {
            ...
            switch (fAction)
            {
                case BtnEvent.Open:
                    btn_save.Text = "&CLOSE";
                    obj = CRole_exten.PKId(pPkValue, new DAL());
        ...
        {
            vId = obj.Role_id;
            txt_role_name.Text = obj.Role_name;
        ...
        private void EnableControls(bool pEnabled)
        {
            ...
            txt_role_name.Enabled = !pReadOnly;
        ...
        private Role CollectData()
        {
            Role fobj = new Role()
            {
                Role_id = vId,
                Role_name = txt_role_name.Text,
        ...
        {
            if (txt_role_name.Text.Trim().Length == 0)
            {
                MessageBox.Show(this.FindForm(), "Role name should not Empty ! ", "Warning...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txt_role_name.Focus();
                return false;
            }
