...
namespace CXCORE
{
    public partial class LParty : CxControl
    {

        private FParty fparty = null;
        ...
        private LookupBox txt_party_name;
        ...
        private void Initialize()
        {
            ...
            linner_panel.Controls.Add(txt_party_name);
            linner_panel.Controls.Add(lbl_party_name);
            ...
            txt_party_name.Size = XSize.TwoText;
            txt_party_name.Anchor = XAnchor.LT;
            txt_party_name.Location = XLayout.FirstText;
            txt_party_name.TabIndex = 5;

            lbl_party_name.Font = XFont.Font_10B;
            lbl_party_name.Name = "lbl_party_name";
            lbl_party_name.Text = "Party";
            lbl_party_name.TextAlign = ContentAlignment.MiddleCenter;
            ...
            btn_search.Location = new Point(txt_party_name.Right + 1, txt_party_name.Top);
