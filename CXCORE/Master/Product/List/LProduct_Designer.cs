...
namespace CXCORE
{
    public partial class LProduct : CxControl
    {

        private FProduct fproduct = null;
        ...
        private LookupBox txt_product_name;
        ...
        private void Initialize()
        {
            ...
            txt_product_name = new LookupBox();
            ...
            linner_panel.Controls.Add(txt_product_name);
            linner_panel.Controls.Add(lbl_product_name);
            ...
            txt_product_name.Size = XSize.TwoText;
            txt_product_name.Anchor = XAnchor.LT;
            txt_product_name.Location = XLayout.FirstText;
            txt_product_name.TabIndex = 5;

            lbl_product_name.Font = XFont.Font_10B;
            lbl_product_name.Name = "lbl_product_name";
            lbl_product_name.Text = "Product";
            lbl_product_name.TextAlign = ContentAlignment.MiddleCenter;
            ...
            btn_search.Location = new Point(txt_product_name.Right + 10, txt_product_name.Top);
