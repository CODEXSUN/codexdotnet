...
{ 
    ...
    { 
        ...
        private LookupBox txt_article_no; 
        private XLabel lbl_article_name; 
        ...
        { 
            ...
            txt_article_no = new LookupBox(); 
            lbl_article_name = new XLabel(); 
            ...
            linner_panel.Controls.Add(txt_article_no); 
            linner_panel.Controls.Add(lbl_article_name); 
            ...
            txt_article_no.Name = "txt_article_name"; 
            ...
            txt_article_no.TabIndex = 5; 

            lbl_article_name.Font = XFont.Font_10B; 
            lbl_article_name.Name = "lbl_article_name"; 
            lbl_article_name.Text = "Article";
            lbl_article_name.TextAlign = ContentAlignment.MiddleCenter; 
            lbl_article_name.ForeColor = XFontColor.Lbl_ForeColor; 
            lbl_article_name.Size = XSize.OneLabel; 
            lbl_article_name.Location = XLayout.FirstLabel; 

            btn_search.Font = XFont.BtnFont;
            btn_search.Location = new Point(txt_article_no.Right + 10 ,txt_article_no.Top);
