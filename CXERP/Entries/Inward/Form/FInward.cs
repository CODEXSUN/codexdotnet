...
namespace CXERP
{
    public partial class FInward 
    {
        ...
        {
           // txt_balance.Text = CInward_exten.GetBalance(CParty_exten.GetId_Name(txt_party_id.Text)).ToString();
        }
        ...
        public event EventHandler FInward_NeedToRefresh;

        public void Form_NeedToRefresh()
        {
            if (FInward_NeedToRefresh != null)
            {
                FInward_NeedToRefresh(this, new EventArgs());
            }
        }
...
//            D_Inward.Build();
            ...
            //P_Inward.Print(frpt.reportViewer1, (vId), printdata);
            ////P_InwardItem.Print(frpt.reportViewer1, (vId));
            //frpt.Show();
            //print_panel.Hide();
            //this.Hide();
