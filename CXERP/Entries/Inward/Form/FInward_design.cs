...
namespace CXERP
{
    public partial class FInward : CxControl
    {
        public FInward()
        {
            InitializeComponent();
        ...
        private XTextBox txt_inward_no;
        private XLabel lbl_inward_no;
        private xDatepicker txt_inward_date;
        private XLabel lbl_inward_date;
        ...
        private XLabel lbl_receivedby_id;
        private XTextBox txt_receivedby_id;
        ...
        private XLabel lbl_total_bundel;
        private XTextBox txt_total_bundel;
        ...
        private void Initialize()
        {
            ...
            txt_inward_no = new XTextBox();
            lbl_inward_no = new XLabel();
            txt_inward_date = new xDatepicker();
            lbl_inward_date = new XLabel();
            ...
            lbl_receivedby_id = new XLabel();
            txt_receivedby_id = new XTextBox();
            ...
            finner_panel.Controls.Add(txt_inward_no);
            finner_panel.Controls.Add(lbl_inward_no);
            finner_panel.Controls.Add(txt_inward_date);
            finner_panel.Controls.Add(lbl_inward_date);
            ...
            finner_panel.Controls.Add(lbl_receivedby_id);
            finner_panel.Controls.Add(txt_receivedby_id);
            ...
            lbl_inward_no.Font = XFont.Font_10B;
            lbl_inward_no.Name = "lbl_invoice_no";
            lbl_inward_no.Text = "   Inward no";
            lbl_inward_no.Anchor = XAnchor.LT;
            lbl_inward_no.TextAlign = ContentAlignment.MiddleLeft;
            lbl_inward_no.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_inward_no.Size = XSize.OneLabel;
            lbl_inward_no.Location = XLayout.R1_Label(txt_order_id.Location);

            txt_inward_no.Font = XFont.TxtFont;
            txt_inward_no.ForeColor = XFontColor.TxtFontColor;
            txt_inward_no.BackColor = XTheme.TxtBackcolor;
            txt_inward_no.Name = "txt_invoice_no";
            txt_inward_no.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_inward_no.TextAlign = HorizontalAlignment.Left;
            txt_inward_no.Size = new Size(XSize.TwoTxtColumn - 20, XSize.TwoTxtHeight);
            txt_inward_no.Anchor = XAnchor.LT;
            txt_inward_no.Location = XLayout.R1_Text(txt_order_id.Location);
            txt_inward_no.TabIndex = XTab.Txt_TabIndex;
            txt_inward_no.Enter += new EventHandler(Txt_invoice_no_Enter);


            lbl_inward_date.Font = XFont.Font_10B;
            lbl_inward_date.Name = "lbl_invoice_date";
            lbl_inward_date.Text = "   Inward date";
            lbl_inward_date.Anchor = XAnchor.LT;
            lbl_inward_date.TextAlign = ContentAlignment.MiddleLeft;
            lbl_inward_date.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_inward_date.Size = XSize.OneLabel;
            lbl_inward_date.Location = XLayout.R1_Label(lbl_inward_no.Location);

            txt_inward_date.Font = XFont.TxtFont;
            txt_inward_date.ForeColor = XFontColor.TxtFontColor;
            txt_inward_date.BackColor = XTheme.TxtBackcolor;
            txt_inward_date.Name = "txt_invoice_date";
            txt_inward_date.CustomFormat = "  dd-MM-yyyy";
            txt_inward_date.Format = DateTimePickerFormat.Custom;
            txt_inward_date.Size = XSize.TwoText;
            txt_inward_date.Anchor = XAnchor.LTR;
            txt_inward_date.Location = XLayout.R1_Text(txt_inward_no.Location);
            txt_inward_date.TabIndex = XTab.Index(txt_inward_no.TabIndex);
            txt_inward_date.Enter += new EventHandler(Txt_invoice_date_Enter);
            ...
            lbl_party_id.Location = XLayout.R1_Label(lbl_inward_date.Location);
            ...
            txt_party_id.Location = XLayout.R1_Text(txt_inward_date.Location);
            txt_party_id.TabIndex = XTab.Index(txt_inward_date.TabIndex);
            ...
            //lbl_taxtype_id.Size = XSize.TwoLabel;
            //lbl_taxtype_id.Location = XLayout.R1_2Label_2(lbl_order_id.Location);
            ...
            //txt_taxtype_id.Size = new Size(XSize.TwoTxtColumn - 20, XSize.TwoTxtHeight);
            //txt_taxtype_id.Anchor = XAnchor.LT;
            //txt_taxtype_id.Location = XLayout.R1_2Text_2(lbl_order_id.Location);
            //txt_taxtype_id.TabIndex = XTab.Index(btn_saveprint.TabIndex);
            ...
            //lbl_salestype_id.Size = XSize.TwoLabel;
            //lbl_salestype_id.Location = XLayout.R2_2Label_2(lbl_taxtype_id.Location);
            ...
            //txt_salestype_id.Size = txt_taxtype_id.Size;
            //txt_salestype_id.Anchor = XAnchor.LT;
            //txt_salestype_id.Location = XLayout.R2_2Text_2(txt_taxtype_id.Location);
            ...
            //lbl_transport_id.Name = "lbl_transport_id";
            //lbl_transport_id.Text = "   Transport";
            ...
            //lbl_transport_id.Size = XSize.TwoLabel;
            //lbl_transport_id.Location = XLayout.R2_2Label_2(lbl_salestype_id.Location);
            ...
            //txt_transport_id.Size = txt_taxtype_id.Size;
            //txt_transport_id.Anchor = XAnchor.LT;
            //txt_transport_id.Location = XLayout.R2_2Text_2(txt_salestype_id.Location);
            //txt_transport_id.TabIndex = XTab.Index(txt_party_id.TabIndex);
            //txt_transport_id.Enter += new EventHandler(Txt_transport_id_Enter);
            ...
            lbl_receivedby_id.Font = XFont.Font_10B;
            lbl_receivedby_id.Name = "lbl_deliveryto_id";
            lbl_receivedby_id.Text = "   Deliver to";
            lbl_receivedby_id.Anchor = XAnchor.LT;
            lbl_receivedby_id.TextAlign = ContentAlignment.MiddleLeft;
            lbl_receivedby_id.ForeColor = XFontColor.Lbl_ForeColor;
            lbl_receivedby_id.Size = XSize.TwoLabel;
            lbl_receivedby_id.Location = XLayout.R2_2Label_2(lbl_total_bundel.Location);

            txt_receivedby_id.Font = XFont.TxtFont;
            txt_receivedby_id.ForeColor = XFontColor.TxtFontColor;
            txt_receivedby_id.BackColor = XTheme.TxtBackcolor;
            txt_receivedby_id.Name = "txt_deliveryto_id";
            txt_receivedby_id.ReadOnlyBackColor = XTheme.TxtReadonlyBackcolor;
            txt_receivedby_id.TextAlign = HorizontalAlignment.Left;
            txt_receivedby_id.Size = txt_total_bundel.Size;
            txt_receivedby_id.Anchor = XAnchor.LT;
            txt_receivedby_id.Location = XLayout.R2_2Text_2(txt_total_bundel.Location);
            txt_receivedby_id.TabIndex = XTab.Index(txt_total_bundel.TabIndex);
            txt_receivedby_id.Enter += new EventHandler(Txt_deliverto_id_Enter);
            ...
            btn_save.TabIndex = XTab.Index(txt_receivedby_id.TabIndex);
        ...
        private void InitGrid()
        {
            ...
            DataGridViewTextBoxColumn col_Inwarditems_Id = new DataGridViewTextBoxColumn();
            col_Inwarditems_Id.Name = INWARDITEMS.INWARDITEMS_ID;
            col_Inwarditems_Id.HeaderText = "INWARDITEMS_ID ";
            col_Inwarditems_Id.Visible = false;
            col_Inwarditems_Id.Width = 100;
            col_Inwarditems_Id.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Inwarditems_Id.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            editgrid.Columns.Add(col_Inwarditems_Id);

            DataGridViewTextBoxColumn col_Inward_Id = new DataGridViewTextBoxColumn();
            col_Inward_Id.Name = INWARDITEMS.INWARD_ID;
            col_Inward_Id.HeaderText = "INWARD_ID ";
            col_Inward_Id.Visible = false;
            col_Inward_Id.Width = 100;
            col_Inward_Id.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Inward_Id.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            editgrid.Columns.Add(col_Inward_Id);
            ...
            //col_Po_id.Name = INWARDITEMS.PO_ID;
            //col_Po_id.HeaderText = "PO";

            //if (Customise.Inward_Without_podc == true)
            //{
            ...
            //col_Poitems_id.Name = INWARDITEMS.POITEMS_ID;
            ...
            //col_Dc_id.Name = INWARDITEMS.DC_ID;
            ...
            //col_Dcitems_id.Name = INWARDITEMS.DCITEMS_ID;
            ...
            col_Product_id.Name = INWARDITEMS.PRODUCT_ID;
            ...
            col_Sizes_id.Name = INWARDITEMS.SIZES_ID;
            ...
            col_Colour_id.Name = INWARDITEMS.COLOURS_ID;
            col_Colour_id.HeaderText = "COLOUR";
            //col_Colour_id.Visible = false; 
            col_Colour_id.Width = 100;
            col_Colour_id.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            col_Colour_id.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            editgrid.Columns.Add(col_Colour_id);

            DataGridViewTextBoxColumn col_Qty = new DataGridViewTextBoxColumn();
            col_Qty.Name = INWARDITEMS.QTY;
            ...
            DataGridViewTextBoxColumn col_bundle = new DataGridViewTextBoxColumn();
            col_bundle.Name = INWARDITEMS.BUNDLE;
            col_bundle.HeaderText = "BUNDLE";
            //col_Price.Visible = false; 
            col_bundle.Width = 100;
            col_bundle.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            col_bundle.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            editgrid.Columns.Add(col_bundle);
