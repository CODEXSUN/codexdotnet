...
namespace CXERP
{
    public partial class LInward : CxControl
    {

        private FInward finvoice = null;
        ...
        private void InitGrid()
        {
            ...
            col_Inward_Id.Name = INWARD.INWARD_ID;
            ...
            listgrid.Columns.Add(col_Inward_Id);

            DataGridViewTextBoxColumn col_Inward_no = new DataGridViewTextBoxColumn();
            col_Inward_no.Name = INWARD.INWARD_NO;
            col_Inward_no.HeaderText = "NO";
            //col_Inward_no.Visible = false;
            col_Inward_no.Width = 100;
            col_Inward_no.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Inward_no.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Inward_no);

            DataGridViewTextBoxColumn col_Inward_date = new DataGridViewTextBoxColumn();
            col_Inward_date.Name = INWARD.INWARD_DATE;
            col_Inward_date.HeaderText = "DATE";
            //col_Inward_date.Visible = false;
            col_Inward_date.Width = 100;
            col_Inward_date.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Inward_date.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Inward_date);

            DataGridViewTextBoxColumn col_Party_id = new DataGridViewTextBoxColumn();
            col_Party_id.Name = INWARD.PARTY_ID;
            ...
            col_Total_qty.Name = INWARD.TOTAL_QTY;
            ...
            listgrid.Columns.Add(col_Total_bundles);
            ...
            col_User_Id.Name = INWARD.USER_ID;
