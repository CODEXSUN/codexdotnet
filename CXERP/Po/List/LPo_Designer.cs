...
namespace CXERP 
{ 
    public partial class LPo: CxControl
    { 

          private FPo fpo = null;
        ...
        private LookupBox txt_po_no; 
        private XLabel lbl_po_name; 
        ...
        { 
            ...
            txt_po_no = new LookupBox(); 
            lbl_po_name = new XLabel(); 
            ...
            linner_panel.Controls.Add(txt_po_no); 
            linner_panel.Controls.Add(lbl_po_name); 
            ...
            txt_po_no.TabIndex = 5; 

            lbl_po_name.Font = XFont.Font_10B; 
            lbl_po_name.Name = "lbl_po_name"; 
            lbl_po_name.Text = "Po";
            lbl_po_name.TextAlign = ContentAlignment.MiddleCenter; 
            lbl_po_name.ForeColor = XFontColor.Lbl_ForeColor; 
            lbl_po_name.Size = XSize.OneLabel; 
            lbl_po_name.Location = XLayout.FirstLabel; 

            btn_search.Font = XFont.BtnFont;
            btn_search.Location = new Point(txt_po_no.Right + 10 ,txt_po_no.Top);
