    ...
    { 
        ...
        public void SetAction(BtnEvent action, string pk)
        {
            ...
            switch (fAction)
            {
                case BtnEvent.Open:
                    btn_save.Text = "&CLOSE";
                    obj = CStyle_exten.PKId(pk);
                    list = CStyleitems_exten.FKId(pk);
                    this.EnableControls(false);
                    break;
                case BtnEvent.New:
                    btn_save.Text = "&SAVE";
                    obj = CStyle.GetNew;
                    list = new List<Styleitems>();
        ...
        private Style CollectData()
        {
           ...
           {
                Style_id = vId,
                Uniqueno = Current.Acy_id + "~" + Current.Company_id + "~" + txt_style_no.Text,
