    ...
    public partial class FStyle : UserControl
    {
        ...
        public void Loaditems(List<Styleitems> list)
        {
            ...
            if (list != null)
            {
                ...
                for (int r = 0; r < list.Count; r++)
                {
                    ...
                    row.Cells[STYLEITEMS.STYLE_ID].Value = (list[r].Product_id) + "";
        ...
        private List<Styleitems> Collectitems(string vId)
        {
            ...
            for (int r = 0; r < editgrid.RowCount; r++)
            {
                ...
                if (
               (editgrid[STYLEITEMS.STYLE_ID, r].Value + "") == "" ||
                ...
                else
                {
                    ...
                    obj.Product_id = CProduct_exten.GetId_Name(editgrid[STYLEITEMS.STYLE_ID, r].Value + "");
