...
namespace CXERP
{
    public partial class LOrder : CxControl
    {
        #region[Grid Action]
        ...
        void Listgrid_RowAction(object sender, EventArgs e)
        {
            ...
            if (fgarment_order == null)
            {
                fgarment_order = new FOrder();
            }
            BuildForm();
            string pkValue = GetSelectedPkValue();
            if (pkValue != null)
            {
                fgarment_order.SetAction(BtnEvent.Open, pkValue);
            }
        }
        ...
        private void BuildForm()
        {
            ...
            fgarment_order.FOrder_NeedToRefresh += VOrder_NeedToRefresh;
            Parent.Controls.Add(fgarment_order);
            fgarment_order.Dock = DockStyle.Fill;
            fgarment_order.Show();
            fgarment_order.BringToFront();
        ...
        {
            BuildForm();
            fgarment_order.SetAction(BtnEvent.New, null);
            fgarment_order.SetFocus();
        }
        ...
        private void Btn_edit_Click(object sender, EventArgs e)
        {
            ...
            if (pkValue != null)
            {
                fgarment_order.SetAction(BtnEvent.Edit, pkValue);
                fgarment_order.SetFocus();
            }
        }
        ...
        private void Btn_delete_Click(object sender, EventArgs e)
        {
            ...
            if (pkValue != null)
            {
                fgarment_order.SetAction(BtnEvent.Delete, pkValue);
                fgarment_order.SetFocus();
            }
        }
        ...
        private void Btn_print_Click(object sender, EventArgs e)
        {
            ...
            if (pkValue != null)
            {
                fgarment_order.SetAction(BtnEvent.Print, pkValue);
                fgarment_order.SetFocus();
            }
        }
        ...
        private string GetSelectedPkValue()
        {
            ...
            if (vSelRow != null)
            {
                selPkValue = vSelRow.Cells[ORDER.ORDER_ID].Value.ToString();
            }
            return selPkValue;
        }
        ...
        void VOrder_NeedToRefresh(object sender, EventArgs e)
        {
            List_Option(ListOption.active);
        }
