...
namespace CXERP
{
    public partial class LOrder
    {
        ...
        private FOrder fgarment_order = null;
        ...
        private void InitGrid()
        {
            ...
            col_Order_Id.Name = ORDER.ORDER_ID;
            col_Order_Id.HeaderText = "ORDER_ID ";
            ...
            col_Order_no.Name = ORDER.ORDER_NO;
            col_Order_no.HeaderText = "ORDER NO";
            //col_Order_no.Visible = false;
            col_Order_no.Width = 130;
            col_Order_no.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Order_no.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Order_no);

            DataGridViewTextBoxColumn col_Order_date = new DataGridViewTextBoxColumn();
            col_Order_date.Name = ORDER.ORDER_DATE;
            col_Order_date.HeaderText = "ORDER DATE";
            //col_Order_date.Visible = false;
            col_Order_date.Width = 162;
            col_Order_date.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Order_date.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Order_date);

            DataGridViewTextBoxColumn col_Ordertype_id = new DataGridViewTextBoxColumn();
            col_Ordertype_id.Name = ORDER.ORDERTYPE_ID;
            col_Ordertype_id.HeaderText = "ORDER TYPE";
            //col_Ordertype_id.Visible = false;
            col_Ordertype_id.Width = 162;
            ...
            col_Party_id.Name = ORDER.PARTY_ID;
            ...
            DataGridViewTextBoxColumn col_Party_ref = new DataGridViewTextBoxColumn();
            col_Party_ref.Name = ORDER.PARTY_REF;
            col_Party_ref.HeaderText = "PARTY REF";
            //col_Party_ref.Visible = false;
            col_Party_ref.Width = 150;
            col_Party_ref.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            //col_Refered_no.Visible = false;
            col_Refered_no.Width = 162;
            col_Refered_no.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Refered_no.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Refered_no);

            DataGridViewTextBoxColumn col_Locked = new DataGridViewTextBoxColumn();
            col_Locked.Name = ORDER.LOCKED;
            col_Locked.HeaderText = "LOCKED";
            //col_Locked.Visible = false;
            col_Locked.Width = 100;
            col_Locked.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            col_Locked.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            listgrid.Columns.Add(col_Locked);
            ...
            col_User_Id.Name = ORDER.USER_ID;
