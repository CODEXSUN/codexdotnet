...
namespace CXLIB
{
    ...
    public partial class OfficeButton : Button
    {
        ...
        ///
        #region Fields
        Themescheme thm = Themescheme.BLUE;
        enum MouseState { None = 1, Down = 2, Up = 3, Enter = 4, Leave = 5, Move = 6 }
        MouseState MState = MouseState.None;
        #endregion
        ///
        #region Constructor
        public OfficeButton()
        ...
        ///
        #region Mouse Events
        void _MouseDown(object sender, MouseEventArgs mevent)
        {
            MState = MouseState.Down;
            Invalidate();
        }
        ///
        void _MouseUp(object sender, MouseEventArgs mevent)
        {
        ...
        ///
        void _MouseMove(object sender, MouseEventArgs mevent)
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            #region Theme 2010
            ///
            if (thm == Themescheme.BLUE || thm == Themescheme.Green || thm == Themescheme.Yellow || thm == Themescheme.Steelblue ||
                thm == Themescheme.RED || thm == Themescheme.WHITE || thm == Themescheme.Pink)
            {
            ...
            //        var rippleBrush = new SolidBrush(Color.FromArgb((int)(51 - (animationValue * 50)), Color.IndianRed));
        ...
        public CXLIB.Themescheme Themes

        {
...

            {
...

                {
                    ...
                    return Themescheme.Steelblue;

                }



                return Themescheme.BLUE;
...

            {
                ...
                else if (thm == Themescheme.Yellow)
                ...
                else if (thm == Themescheme.Steelblue)
