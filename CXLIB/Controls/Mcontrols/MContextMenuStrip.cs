...
namespace CXLIB
{
    public class MContextMenuStrip : ContextMenuStrip, IControl
    {
    ...
    public class MaterialToolStripMenuItem : ToolStripMenuItem
    {
        ...
        protected override ToolStripDropDown CreateDefaultDropDown()
        {
            ...
            var defaultDropDown = new MContextMenuStrip();
    ...
    internal class MaterialToolStripRender : ToolStripProfessionalRenderer, IControl
    {
        //Properties for managing the material design properties
        public int Depth { get; set; }
        public SkinManager SkinManager { get { return SkinManager.Instance; } }
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            //Ripple animation
            var toolStrip = e.ToolStrip as MContextMenuStrip;
            if (toolStrip != null)
            {
