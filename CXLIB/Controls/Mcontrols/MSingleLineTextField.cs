...
namespace CXLIB
{
    public class MSingleLineTextField : Control, IControl
    {
      ...
      //  public new int MaxLength { get { return baseTextBox.MaxLength; } set { baseTextBox.MaxLength = value; } }
       ...
       // public void Focus() { baseTextBox.Focus(); }
        ...
        private class BaseTextBox : XTextBox
        {
            ...
            public BaseTextBox()
            {
                MContextMenuStrip cms = new TextBoxContextMenuStrip();
        ...
        private class TextBoxContextMenuStrip : MContextMenuStrip
        {
