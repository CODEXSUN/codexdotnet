...
namespace CXLIB
{
    public class SkinManager
    {
        ...
        //Forms to control
        private readonly List<MForm> formsToManage = new List<MForm>();
        ...
        private SkinManager()
        {
            ...
            ROBOTO_MEDIUM_12 = new Font("Microsoft Sans Serif", 11.25F);
            ROBOTO_MEDIUM_10 = new Font("Microsoft Sans Serif", 10f);
            ROBOTO_REGULAR_11 = new Font("Microsoft Sans Serif", 11f);
            ROBOTO_MEDIUM_11 = new Font("Microsoft Sans Serif", 11f);
        ...
        {
            get { return instance ?? (instance = new SkinManager()); }
        }

        public void AddFormToManage(MForm materialForm)
        {
            formsToManage.Add(materialForm);
            UpdateBackgrounds();
        }

        public void RemoveFormToManage(MForm materialForm)
        {
        ...
        private void UpdateControl(Control controlToUpdate, Color newBackColor)
        {
            ...
            var tabControl = controlToUpdate as MTabControl;
            if (tabControl != null)
            {
            ...
            if (controlToUpdate is MDivider)
            {
                controlToUpdate.BackColor = GetDividersColor();
            }

	        if (controlToUpdate is MListView)
	        {
