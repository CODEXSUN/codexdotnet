...
namespace CXLIB
{
    public class ShadowBox : Panel
    {
        ...
        static Image shadowDownRight = new Bitmap(typeof(ShadowBox), "Images.tshadowdownright.png");
        static Image shadowDownLeft = new Bitmap(typeof(ShadowBox), "Images.tshadowdownleft.png");
        static Image shadowDown = new Bitmap(typeof(ShadowBox), "Images.tshadowdown.png");
        static Image shadowRight = new Bitmap(typeof(ShadowBox), "Images.tshadowright.png");
        static Image shadowTopRight = new Bitmap(typeof(ShadowBox), "Images.tshadowtopright.png");
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(pen, 5, 5, 5, Height-5);
