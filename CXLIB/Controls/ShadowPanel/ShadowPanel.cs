...
namespace CXLIB
{
    public class XShadowPanel : Panel
    {
        ...
        static Image shadowDownRight = new Bitmap(typeof(XShadowPanel), "Images.tshadowdownright.png");
        static Image shadowDownLeft = new Bitmap(typeof(XShadowPanel), "Images.tshadowdownleft.png");
        static Image shadowDown = new Bitmap(typeof(XShadowPanel), "Images.tshadowdown.png");
        static Image shadowRight = new Bitmap(typeof(XShadowPanel), "Images.tshadowright.png");
        static Image shadowTopRight = new Bitmap(typeof(XShadowPanel), "Images.tshadowtopright.png");
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Pen pen = new Pen(Color.FromArgb(20, 0, 0, 0));
            e.Graphics.DrawLine(pen, 5, 0, 5, Height-5);
           // e.Graphics.DrawLine(pen, 5, 5, Width-5, 5);
