...
namespace CXLIB_PLUS
{
    class AnimationManager
    {
        ...
        readonly List<double> animationProgresses;
        readonly List<Point> animationSources;
        readonly List<AnimationDirection> animationDirections;
        readonly List<object[]> animationDatas;

        const double MIN_VALUE = 0.00;
        const double MAX_VALUE = 1.00;

        readonly Timer animationTimer = new Timer { Interval = 5, Enabled = false };
        ...
        void AnimationTimerOnTick(object sender, EventArgs eventArgs)
        {
